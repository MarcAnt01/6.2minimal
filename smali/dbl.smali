...
.method public constructor <init>(Lczy;Llsl;Ldbo;Ldbi;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ldbl;->c:Lczy;

    iput-object p2, p0, Ldbl;->a:Llsl;

    iput-object p3, p0, Ldbl;->d:Ldbo;

    iput-object p4, p0, Ldbl;->e:Ldbi;
...
.method public final a(Landroid/net/Uri;)Landroid/content/ContentProvider$PipeDataWriter;
    ...
    :goto_0
    iget-object p1, p0, Ldbl;->c:Lczy;

    invoke-interface {p1, v1, v2}, Lczy;->a(J)Lnre;
    ...
    invoke-interface {p1}, Lczt;->d()Lakk;

    move-result-object p1

    if-eqz p1, :cond_4

    iget-object v1, p0, Ldbl;->a:Llsl;
    ...
    invoke-static {p1}, Lkae;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, v1}, Lkae;->a(Landroid/graphics/Bitmap;Landroid/util/Size;)Landroid/graphics/Bitmap;
    ...
    :goto_2
    invoke-interface {v1, p1}, Ldbh;->a(Landroid/graphics/Bitmap;)Ljava/io/ByteArrayOutputStream;
    ...
    invoke-direct {v1, p0, v0, p1}, Ldbm;-><init>(Ldbl;Ljava/lang/String;Ljava/io/ByteArrayOutputStream;)V
    ...
    invoke-direct {v0, p1}, Ldbq;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-direct {p1, v1}, Ldbq;-><init>(Ljava/lang/String;)V
