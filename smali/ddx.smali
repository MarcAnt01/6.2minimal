...
.method public constructor <init>(Lcom/google/googlex/gcam/Gcam;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iput-object v0, p0, Lddx;->a:Ljava/lang/Object;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lddx;->b:Ljava/util/List;

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, Lddx;->g:F

    iput-object p1, p0, Lddx;->e:Lcom/google/googlex/gcam/Gcam;

    iput-object p2, p0, Lddx;->f:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final a(I)Llrr;
    ...
    invoke-direct {v0, p1}, Ldec;-><init>(I)V

    iget-object p1, p0, Lddx;->a:Ljava/lang/Object;

    monitor-enter p1

    :try_start_0
    iget-object v1, p0, Lddx;->b:Ljava/util/List;
    ...
    invoke-direct {p1, p0, v0}, Lddy;-><init>(Lddx;Ldec;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Lddx;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lddx;->c:Ljava/util/concurrent/Future;
    ...
    iget-object v0, p0, Lddx;->f:Ljava/util/concurrent/ScheduledExecutorService;
...
.method final a(F)V
    ...
    sget-object v3, Lddx;->d:Ljava/lang/String;
    ...
    iget-object v3, p0, Lddx;->e:Lcom/google/googlex/gcam/Gcam;
...
.method public final b()V
    ...
    :try_start_0
    iget-object v1, p0, Lddx;->f:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v2, Ldeb;

    invoke-direct {v2, p0}, Ldeb;-><init>(Lddx;)V
    ...
    iput-object v1, p0, Lddx;->c:Ljava/util/concurrent/Future;
