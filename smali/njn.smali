...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lnjn;->b:Ljava/util/concurrent/LinkedBlockingDeque;
...
.method private static a(Ljava/lang/String;Lnre;)Lnmf;
    .locals 2
    ...
    invoke-interface {p1, p0, v0}, Lnmg;->a(Ljava/lang/String;F)Lnre;
...
.method public final declared-synchronized a()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, p0, Lnjn;->b:Ljava/util/concurrent/LinkedBlockingDeque;
    ...
    iget-object v1, p0, Lnjn;->b:Ljava/util/concurrent/LinkedBlockingDeque;
...
.method public final declared-synchronized a([Lcom/google/android/libraries/barhopper/Barcode;IILnre;Lnre;Lnre;)Ljava/util/List;
    .locals 24
    ...
    :goto_3
    iget-object v2, v1, Lnjn;->b:Ljava/util/concurrent/LinkedBlockingDeque;
    ...
    sget-object v12, Lncp;->d:Lncp;

    goto/16 :goto_b

    :pswitch_0
    sget-object v12, Lncp;->g:Lncp;
    ...
    invoke-virtual {v11, v13}, Lnmf;->b(Ljava/lang/String;)Lnmf;
    ...
    invoke-virtual {v11, v0}, Lnmf;->b(Ljava/lang/String;)Lnmf;
    ...
    invoke-static {v0, v5}, Loag;->b(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v5, v0, v6}, Lnmg;->a(Ljava/lang/String;F)Lnre;
    ...
    invoke-virtual {v5}, Lnmc;->b()Lncp;

    move-result-object v6

    sget-object v8, Lncp;->k:Lncp;

    if-ne v6, v8, :cond_6

    invoke-virtual {v5}, Lnmc;->a()Lnmf;
    ...
    sget-object v6, Lncp;->j:Lncp;

    if-eq v5, v6, :cond_8

    sget-object v6, Lncp;->f:Lncp;

    if-eq v5, v6, :cond_8

    sget-object v6, Lncp;->k:Lncp;

    if-eq v5, v6, :cond_8

    sget-object v6, Lncp;->i:Lncp;
    ...
    invoke-static {v0, v4}, Lnjn;->a(Ljava/lang/String;Lnre;)Lnmf;
    ...
    invoke-virtual {v5, v6}, Lnhp;->a(Ljava/lang/String;)Lnhp;
    ...
    invoke-static {v15, v4}, Lnjn;->a(Ljava/lang/String;Lnre;)Lnmf;

    move-result-object v15

    invoke-virtual {v15}, Lnmf;->a()Ljava/lang/String;

    move-result-object v15

    invoke-virtual {v13, v15}, Lnwi;->c(Ljava/lang/Object;)Lnwi;
    ...
    invoke-virtual {v15, v14}, Lnwi;->c(Ljava/lang/Object;)Lnwi;
    ...
    invoke-virtual {v5, v6}, Lnhp;->c(Ljava/lang/String;)Lnhp;
    ...
    invoke-virtual {v0, v1, v5, v8}, Lnoz;->d(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v5, v6}, Lnpb;-><init>([F)V
    ...
    invoke-virtual {v5, v8}, Lnpb;->a(I)Landroid/graphics/PointF;
    ...
    invoke-virtual {v5, v2}, Lnpb;->a([F)V
    ...
    invoke-virtual {v3, v11}, Lnmd;->a(Lnmf;)Lnmd;

    move-result-object v3

    invoke-virtual {v3, v12}, Lnmd;->a(Lncp;)Lnmd;

    move-result-object v3

    const/4 v5, 0x1

    iput-boolean v5, v3, Lnmd;->a:Z

    sget-object v6, Lnme;->b:Lnme;

    invoke-virtual {v3, v6}, Lnmd;->a(Lnme;)Lnmd;
    ...
    invoke-virtual {v3, v6}, Lnmd;->a(Ljava/lang/Float;)Lnmd;

    move-result-object v3

    invoke-virtual {v3, v2}, Lnmd;->a(Ljava/util/List;)Lnmd;

    move-result-object v2

    sget-object v3, Lncp;->n:Lncp;

    if-eq v12, v3, :cond_1d

    invoke-static {v10}, Lnre;->b(Ljava/lang/Object;)Lnre;

    move-result-object v3

    iput-object v3, v2, Lnmd;->e:Lnre;

    :cond_1d
    if-eqz v0, :cond_1e

    invoke-virtual {v2, v0}, Lnmd;->a(Lnho;)Lnmd;

    :cond_1e
    if-eqz v18, :cond_1f

    invoke-static/range {v18 .. v18}, Lnre;->b(Ljava/lang/Object;)Lnre;

    move-result-object v0

    iput-object v0, v2, Lnmd;->g:Lnre;

    :cond_1f
    if-eqz v15, :cond_20

    invoke-static {v15}, Lnre;->b(Ljava/lang/Object;)Lnre;

    move-result-object v0

    iput-object v0, v2, Lnmd;->k:Lnre;

    :cond_20
    if-eqz v13, :cond_21

    invoke-static {v13}, Lnre;->b(Ljava/lang/Object;)Lnre;

    move-result-object v0

    iput-object v0, v2, Lnmd;->m:Lnre;

    :cond_21
    if-eqz v14, :cond_22

    invoke-static {v14}, Lnre;->b(Ljava/lang/Object;)Lnre;

    move-result-object v0

    iput-object v0, v2, Lnmd;->l:Lnre;
