...
.method constructor <init>(Livl;)V
    ...
    iput-object p1, p0, Liwi;->b:Ljava/util/Set;
...
.method private final declared-synchronized a(Landroid/net/Uri;Lipt;)V
    ...
    :cond_0
    :try_start_1
    iget-object p2, p0, Liwi;->b:Ljava/util/Set;
    ...
    iget-object p1, p0, Liwi;->a:Livl;

    iget-object p1, p1, Livl;->b:Llji;

    new-instance p2, Liwj;

    invoke-direct {p2, p0}, Liwj;-><init>(Liwi;)V

    invoke-virtual {p1, p2}, Llji;->a(Ljava/lang/Runnable;)V
    :try_end_1
...
.method private final declared-synchronized d(Landroid/net/Uri;)V
    ...
    :try_start_0
    iget-object v0, p0, Liwi;->b:Ljava/util/Set;
    ...
    iget-object p1, p1, Livl;->h:Lbkh;

    new-instance v0, Liwk;

    invoke-direct {v0, p0}, Liwk;-><init>(Liwi;)V
...
.method public final a(Landroid/net/Uri;Lipt;Lfth;)V
    ...
    invoke-direct {p0, p1, p2}, Liwi;->a(Landroid/net/Uri;Lipt;)V
...
.method public final a(Landroid/net/Uri;Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, Liwi;->d(Landroid/net/Uri;)V
