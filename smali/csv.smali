...
.method public constructor <init>(ILandroid/view/View;Lbhz;Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;)V
    ...
    iput-object p4, p0, Lcsv;->a:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;

    iput-object p2, p0, Lcsv;->b:Landroid/view/View;

    new-instance p2, Landroid/graphics/RectF;

    invoke-direct {p2}, Landroid/graphics/RectF;-><init>()V

    iput-object p2, p0, Lcsv;->c:Landroid/graphics/RectF;
    ...
    iput-object p1, p0, Lcsv;->g:Lbhz;

    invoke-interface {p3}, Lbhz;->c()Lbhx;

    move-result-object p1

    iput-object p1, p0, Lcsv;->h:Lbhx;

    iget-object p1, p0, Lcsv;->h:Lbhx;

    invoke-interface {p1}, Lbhx;->f()Llrt;

    move-result-object p1

    iget p1, p1, Llrt;->a:I

    iget-object p2, p0, Lcsv;->h:Lbhx;

    invoke-interface {p2}, Lbhx;->f()Llrt;

    move-result-object p2

    iget p2, p2, Llrt;->b:I

    iget-object p3, p0, Lcsv;->h:Lbhx;
    ...
    invoke-static {p1, p2, p3, v0, p4}, Lkbo;->a(IIIII)Landroid/graphics/Point;

    move-result-object p1

    iput-object p1, p0, Lcsv;->d:Landroid/graphics/Point;
    ...
    iput-boolean p1, p0, Lcsv;->j:Z

    iget-object p1, p0, Lcsv;->b:Landroid/view/View;
...
.method public final a()F
    ...
    iget-object v0, p0, Lcsv;->b:Landroid/view/View;

    invoke-virtual {v0}, Landroid/view/View;->getTranslationY()F

    move-result v0

    iget-object v1, p0, Lcsv;->a:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
...
.method final a(FFFFII)V
    ...
    iget-object v1, p0, Lcsv;->b:Landroid/view/View;
    ...
    iget-object v2, p0, Lcsv;->b:Landroid/view/View;
    ...
    invoke-static {v0, p5, p6}, Ljwy;->a(Landroid/graphics/RectF;II)Landroid/graphics/RectF;

    move-result-object p1

    iget-object p2, p0, Lcsv;->b:Landroid/view/View;
    ...
    iget-object p3, p0, Lcsv;->b:Landroid/view/View;
    ...
    iget-object p4, p0, Lcsv;->b:Landroid/view/View;

    invoke-virtual {p4}, Landroid/view/View;->getTop()I

    move-result p4

    iget-object p5, p0, Lcsv;->b:Landroid/view/View;
...
.method final a(FFFII)V
    ...
    iget-object v3, p0, Lcsv;->b:Landroid/view/View;
    ...
    invoke-virtual/range {v3 .. v9}, Lcsv;->a(FFFFII)V
...
.method public final a(FLandroid/animation/TimeInterpolator;)V
    ...
    iget-object v0, p0, Lcsv;->l:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, Lcsv;->l:Landroid/animation/ValueAnimator;

    iget-object v0, p0, Lcsv;->l:Landroid/animation/ValueAnimator;

    new-instance v1, Lcsx;

    invoke-direct {v1, p0}, Lcsx;-><init>(Lcsv;)V
    ...
    invoke-virtual {p0}, Lcsv;->a()F

    move-result v1

    invoke-static {v0, v1, p1, p2}, Lcsv;->a(Landroid/animation/ValueAnimator;FFLandroid/animation/TimeInterpolator;)V
...
.method public final a(Landroid/graphics/Rect;IF)V
    ...
    iget-object v0, p0, Lcsv;->i:Landroid/animation/ValueAnimator;
    ...
    iget-object v0, p0, Lcsv;->c:Landroid/graphics/RectF;
...
.method public final b(FLandroid/animation/TimeInterpolator;)V
    ...
    iget-object v0, p0, Lcsv;->m:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, Lcsv;->m:Landroid/animation/ValueAnimator;

    iget-object v0, p0, Lcsv;->m:Landroid/animation/ValueAnimator;

    new-instance v1, Lcsy;

    invoke-direct {v1, p0}, Lcsy;-><init>(Lcsv;)V
...
.method public final c()I
    ...
    iget-object v1, p0, Lcsv;->d:Landroid/graphics/Point;
...
.method public final d()V
    ...
    iget-object v0, p0, Lcsv;->a:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcsv;->c:Landroid/graphics/RectF;

    invoke-static {v2}, Ljava/lang/String;->valueOf(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lcsv;->c()I

    move-result v3

    iget-object v4, p0, Lcsv;->b:Landroid/view/View;

    invoke-virtual {v4}, Landroid/view/View;->getMeasuredWidth()I

    move-result v4

    iget-object v5, p0, Lcsv;->b:Landroid/view/View;

    invoke-virtual {v5}, Landroid/view/View;->getMeasuredHeight()I

    move-result v5

    iget-object v6, p0, Lcsv;->b:Landroid/view/View;

    invoke-virtual {v6}, Landroid/view/View;->getWidth()I

    move-result v6

    iget-object v7, p0, Lcsv;->b:Landroid/view/View;

    invoke-virtual {v7}, Landroid/view/View;->getHeight()I

    move-result v7

    iget-object v8, p0, Lcsv;->b:Landroid/view/View;
