...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfls;->f:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lfls;->g:Landroid/graphics/Point;

    const/16 v0, 0x10

    new-array v1, v0, [F

    iput-object v1, p0, Lfls;->j:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lfls;->n:[F

    const/4 v0, 0x0

    iput-boolean v0, p0, Lfls;->l:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lfls;->p:Ljava/util/ArrayList;
...
.method private final a(Landroid/content/Context;I)Z
    ...
    iget-object v1, p0, Lfls;->d:Ljava/util/Vector;

    const/4 v2, 0x0

    invoke-virtual {v1, v2, v0}, Ljava/util/Vector;->add(ILjava/lang/Object;)V

    iget-object v1, p0, Lfls;->p:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, Lfls;->g:Landroid/graphics/Point;
    ...
    :try_start_0
    iget-object v0, p0, Lfls;->d:Ljava/util/Vector;
    ...
    invoke-static {v0}, Lflo;->a(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lfls;->a:Ljava/nio/FloatBuffer;
    ...
    iput-object v0, p0, Lfls;->b:Ljava/nio/FloatBuffer;
    ...
    iput-object v0, p0, Lfls;->c:Ljava/nio/ShortBuffer;

    iget-object v0, p0, Lfls;->a:Ljava/nio/FloatBuffer;

    invoke-virtual {v0}, Ljava/nio/FloatBuffer;->clear()Ljava/nio/Buffer;

    iget-object v0, p0, Lfls;->b:Ljava/nio/FloatBuffer;

    invoke-virtual {v0}, Ljava/nio/FloatBuffer;->clear()Ljava/nio/Buffer;

    iget-object v0, p0, Lfls;->c:Ljava/nio/ShortBuffer;

    invoke-virtual {v0}, Ljava/nio/ShortBuffer;->clear()Ljava/nio/Buffer;

    iget-object v0, p0, Lfls;->g:Landroid/graphics/Point;
    ...
    iget-object v4, p0, Lfls;->b:Ljava/nio/FloatBuffer;
    ...
    iget-object v3, p0, Lfls;->c:Ljava/nio/ShortBuffer;
...
.method public final a()V
    ...
    iget-object v0, p0, Lfls;->p:Ljava/util/ArrayList;
...
.method public final a([FFFF)V
    ...
    iget-object v2, v0, Lfls;->a:Ljava/nio/FloatBuffer;

    const/4 v3, 0x0

    invoke-virtual {v2, v3}, Ljava/nio/FloatBuffer;->position(I)Ljava/nio/Buffer;

    iget-object v2, v0, Lfls;->b:Ljava/nio/FloatBuffer;

    invoke-virtual {v2, v3}, Ljava/nio/FloatBuffer;->position(I)Ljava/nio/Buffer;

    iget-object v2, v0, Lfls;->e:Lflp;

    iget-object v4, v0, Lfls;->a:Ljava/nio/FloatBuffer;

    invoke-virtual {v2, v4}, Lflp;->a(Ljava/nio/FloatBuffer;)V

    iget-object v2, v0, Lfls;->e:Lflp;

    iget-object v4, v0, Lfls;->b:Ljava/nio/FloatBuffer;

    invoke-virtual {v2, v4}, Lflp;->b(Ljava/nio/FloatBuffer;)V

    iget-object v5, v0, Lfls;->j:[F
    ...
    iget-object v2, v0, Lfls;->j:[F

    invoke-static {v2, v3, v1, v1, v1}, Landroid/opengl/Matrix;->scaleM([FIFFF)V

    :cond_1
    iget-object v1, v0, Lfls;->e:Lflp;

    iget-object v2, v0, Lfls;->j:[F

    invoke-virtual {v1, v2}, Lflp;->a([F)V

    iget-object v1, v0, Lfls;->d:Ljava/util/Vector;
    ...
    iget-object v1, v0, Lfls;->c:Ljava/nio/ShortBuffer;
    ...
    iget-object v4, v0, Lfls;->c:Ljava/nio/ShortBuffer;
...
.method public final a(Landroid/content/Context;IF)Z
    ...
    invoke-direct {p0, p1, p2}, Lfls;->a(Landroid/content/Context;I)Z
    ...
    iget-object p1, p0, Lfls;->a:Ljava/nio/FloatBuffer;
