...
# direct methods
.method public constructor <init>(Lmtx;Lmrh;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lmsi;->a:Lmtx;

    iput-object p2, p0, Lmsi;->b:Lmrh;
...
.method public final synthetic call()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lmsi;->a:Lmtx;

    iget-object v1, p0, Lmsi;->b:Lmrh;

    const/4 v2, 0x1

    invoke-static {v2, v2}, Lmnx;->a(II)Lmny;
    ...
    :goto_0
    invoke-direct {v0, v1}, Lmrk;-><init>(Ljava/lang/String;)V

    throw v0

    :cond_1
    sget-object v5, Lmtg;->a:[I

    monitor-enter v5

    :try_start_0
    sget-object v6, Lmtg;->a:[I
    ...
    invoke-interface {v1, v12}, Lmrh;->a(Landroid/opengl/EGLDisplay;)Landroid/opengl/EGLConfig;
    ...
    invoke-static {}, Lmtg;->a()Lmtx;

    move-result-object v6

    invoke-interface {v1, v3}, Lmrh;->a(Lmny;)Lmqe;
    ...
    invoke-direct/range {v5 .. v12}, Lmth;-><init>(Lmtx;Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;Landroid/opengl/EGLContext;Landroid/opengl/EGLConfig;Lmrc;Landroid/opengl/EGLDisplay;)V

    iget-object v1, v2, Lmsx;->a:Lmtx;

    invoke-virtual {v1, v0}, Lmtx;->b(Lmtx;)I
    ...
    invoke-virtual {v2}, Lmsx;->close()V

    invoke-static {v0}, Lmrk;->a(Lmtx;)Lmrk;
