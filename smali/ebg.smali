...
# direct methods
.method public constructor <init>(Lebk;Landroid/widget/FrameLayout;Lebe;)V
    .locals 0

    invoke-direct {p0, p2}, Lebf;-><init>(Landroid/widget/FrameLayout;)V

    iget-object p1, p1, Lebk;->c:Lebo;

    iput-object p1, p0, Lebg;->p:Lebo;

    iput-object p2, p0, Lebg;->u:Landroid/widget/FrameLayout;
    ...
    iput-object p1, p0, Lebg;->r:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;
    ...
    iput-object p1, p0, Lebg;->v:Landroid/widget/FrameLayout;

    iget-object p1, p0, Lebg;->r:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;

    new-instance p2, Lebh;

    invoke-direct {p2, p0, p3}, Lebh;-><init>(Lebg;Lebe;)V
    ...
    invoke-direct {p2, p0, p3}, Lebi;-><init>(Lebg;Lebe;)V
    ...
    iput-object p1, p0, Lebg;->w:Landroid/animation/ValueAnimator;

    iget-object p1, p0, Lebg;->w:Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p2, p0}, Lebj;-><init>(Lebg;)V
...
.method final a(F)V
    ...
    iget-object v1, p0, Lebg;->v:Landroid/widget/FrameLayout;
    ...
    iget-object p1, p0, Lebg;->v:Landroid/widget/FrameLayout;
...
.method public final a(Lagg;Lccj;)V
    ...
    iget-object p2, p2, Lcdm;->e:Lfuw;

    iget-object v3, p2, Lfuw;->d:Ljava/lang/String;

    iget-object p2, p2, Lfuw;->f:Ljava/util/Date;
    ...
    invoke-static {v2, v0}, Lmmw;->a(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {p2, v0}, Lmmw;->a(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object p2, p0, Lebg;->q:Landroid/net/Uri;

    invoke-virtual {p1, p2}, Lage;->a(Ljava/lang/Object;)Lage;

    move-result-object p1

    iput-object p1, p0, Lebg;->s:Lage;

    iget-object p1, p0, Lebg;->s:Lage;

    iget-object p2, p0, Lebg;->r:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;
...
.method public final b(Z)V
    ...
    iget-object v0, p0, Lebg;->p:Lebo;

    invoke-virtual {v0}, Lebo;->a()Z

    move-result v0

    iget-object v1, p0, Lebg;->p:Lebo;

    iget-object v2, p0, Lebg;->q:Landroid/net/Uri;

    invoke-virtual {v1, v2}, Lebo;->a(Landroid/net/Uri;)Z

    move-result v1

    iget-object v2, p0, Lebg;->u:Landroid/widget/FrameLayout;
    ...
    invoke-virtual {p0, v4}, Lebg;->a(F)V
    ...
    invoke-virtual {p0, p1}, Lebg;->a(F)V
...
.method public final c(Z)V
    ...
    iget-object v0, p0, Lebg;->r:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;
