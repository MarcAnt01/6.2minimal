...
.method public final a()V
    ...
    iget-object v2, v1, Lhzx;->j:Lczp;

    invoke-virtual {v2}, Lczp;->a()Z
    ...
    iget-boolean v4, v1, Lhzx;->s:Z

    iget-object v5, v1, Lhzx;->u:Landroid/app/Activity;

    invoke-virtual {v5}, Landroid/app/Activity;->isVoiceInteractionRoot()Z

    move-result v5

    iget-object v6, v1, Lhzx;->o:Lbig;

    invoke-interface {v6}, Lbig;->a()I

    move-result v6

    sget-object v7, Lhzx;->a:Ljava/lang/String;
    ...
    invoke-virtual {v10, v3}, Lnwh;->a(I)Loby;
    ...
    :cond_4
    invoke-static {v7}, Lopy;->a(Ljava/util/Collection;)[J
    ...
    invoke-static {v4, v5, v3}, Lmnw;->a(ZZ[J)Landroid/content/Intent;

    move-result-object v3

    iget-object v4, v1, Lhzx;->l:Lfro;

    invoke-interface {v4}, Lfro;->i()J
    ...
    invoke-static {v6, v8, v7}, Loag;->a(ZLjava/lang/String;I)V
    ...
    sget-object v5, Lipt;->c:Lipt;

    invoke-interface {v2}, Lbhx;->h()Lfuw;

    move-result-object v6

    iget-object v6, v6, Lfuw;->h:Landroid/net/Uri;
    ...
    iget-object v7, v1, Lhzx;->h:Lirr;

    invoke-virtual {v7, v6}, Lirr;->d(Landroid/net/Uri;)Lfth;

    move-result-object v6

    if-eqz v6, :cond_8

    invoke-interface {v6}, Lfth;->d()Lipt;
    ...
    invoke-interface {v6}, Lfth;->b()Landroid/net/Uri;
    ...
    invoke-virtual {v6}, Lfuw;->a()Landroid/net/Uri;
    ...
    iget-object v7, v7, Lmjg;->i:Ljava/lang/String;
    ...
    invoke-static {v7, v6}, Lpjn;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v6, v1, Lhzx;->b:Landroid/content/Context;
    ...
    iget-object v6, v1, Lhzx;->l:Lfro;

    invoke-interface {v2}, Lbhx;->h()Lfuw;

    move-result-object v2

    iget-boolean v2, v2, Lfuw;->i:Z

    invoke-interface {v6, v4, v2, v5}, Lfro;->a(Ljava/lang/String;ZLipt;)V

    iget-object v1, v1, Lhzx;->d:Lbdd;
