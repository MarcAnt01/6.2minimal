...
.method public constructor <init>(Llii;Ljava/util/Map;Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;)V
    .locals 2
    ...
    iput-object v0, p0, Ljov;->c:Ljava/util/EnumMap;
    ...
    iput-object v0, p0, Ljov;->b:Ljava/util/EnumMap;

    sget-object v0, Lnqh;->a:Lnqh;

    iput-object v0, p0, Ljov;->h:Lnre;
    ...
    iput-object v0, p0, Ljov;->j:Ljoy;

    sget-object v0, Ljov;->a:Ljava/lang/String;

    const-string v1, "ModeSwitcherControllerImpl"

    invoke-static {v0, v1}, Lpjn;->a(Ljava/lang/String;Ljava/lang/String;)V

    iput-object p1, p0, Ljov;->d:Llii;

    iput-object p3, p0, Ljov;->e:Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;

    iput-object p4, p0, Ljov;->f:Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;

    iput-object p5, p0, Ljov;->g:Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;

    iget-object p1, p0, Ljov;->j:Ljoy;

    iput-object p1, p3, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->j:Ljoy;

    nop

    iput-object p1, p4, Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;->n:Ljoy;

    invoke-static {p0}, Lnre;->b(Ljava/lang/Object;)Lnre;

    move-result-object p1

    iput-object p1, p3, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->b:Lnre;

    iget-object p1, p0, Ljov;->c:Ljava/util/EnumMap;
    ...
    sget-object p3, Ljov;->a:Ljava/lang/String;
    ...
    invoke-direct {p0, p2}, Ljov;->i(Lkac;)V
...
.method private final f(Lkac;)Z
    .locals 1

    iget-object v0, p0, Ljov;->b:Ljava/util/EnumMap;

    invoke-virtual {v0, p1}, Ljava/util/EnumMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    iget-object v0, p0, Ljov;->e:Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;
...
.method private final g(Lkac;)Z
    ...
    iget-object v0, p0, Ljov;->f:Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;
...
.method private final h(Lkac;)V
    .locals 5

    iget-object v0, p0, Ljov;->c:Ljava/util/EnumMap;
    ...
    iget-object v1, p0, Ljov;->b:Ljava/util/EnumMap;
    ...
    :goto_0
    invoke-interface {v1, p1, v2}, Ljph;->a(Lkac;Z)V

    :cond_2
    return-void
.end method

.method private final i(Lkac;)V
    .locals 3
    ...
    iget-object v1, p0, Ljov;->d:Llii;

    new-instance v2, Ljow;

    invoke-direct {v2, p0, p1}, Ljow;-><init>(Ljov;Lkac;)V

    sget-object p1, Lorj;->a:Lorj;

    invoke-interface {v0, v2, p1}, Llkx;->a(Llry;Ljava/util/concurrent/Executor;)Llrr;

    move-result-object p1

    invoke-interface {v1, p1}, Llii;->a(Llrr;)Llrr;
...
.method public final a()V
    ...
    iget-object v1, v0, Ljov;->f:Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;
    ...
    iget-object v13, v12, Ljpd;->a:Lkac;
    ...
    invoke-static {v15}, Ljpw;->c(Landroid/content/Context;)Lnre;
    ...
    :cond_2
    invoke-static {v13}, Ljzz;->b(Lkac;)Ljzz;
    ...
    invoke-virtual {v15, v5}, Ljzz;->a(Landroid/content/res/Resources;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v2}, Ljpw;->b(Landroid/content/Context;)Lnre;
    ...
    invoke-static {v2}, Ljpw;->d(Landroid/content/Context;)Lnre;
    ...
    invoke-virtual {v2, v5}, Ljzz;->b(Landroid/content/res/Resources;)Ljava/lang/String;
    ...
    invoke-direct {v2, v1, v13}, Ljoz;-><init>(Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;Lkac;)V
    ...
    invoke-direct {v2, v1}, Ljpa;-><init>(Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;)V
    ...
    iput-object v14, v12, Ljpd;->b:Landroid/view/View;
    ...
    iget-object v2, v0, Ljov;->c:Ljava/util/EnumMap;
    ...
    invoke-direct {v0, v3}, Ljov;->g(Lkac;)Z

    move-result v4

    if-eqz v4, :cond_c

    sget-object v4, Ljov;->a:Ljava/lang/String;
    ...
    iget-object v4, v0, Ljov;->c:Ljava/util/EnumMap;
    ...
    invoke-static {v4, v3}, Lpjn;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1}, Llky;->a(Ljava/util/Collection;)Llkx;
    ...
    invoke-direct {v0, v1}, Ljov;->i(Lkac;)V

    sget-object v1, Lkac;->q:Lkac;

    invoke-direct {v0, v1}, Ljov;->h(Lkac;)V
...
.method public final a(FI)V
    ...
    :try_start_0
    iget-object v1, v0, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->c:Ljoe;
    ...
    iget-object v2, v1, Ljoe;->e:Landroid/widget/TextView;
    ...
    invoke-virtual {v1, v2}, Ljoe;->indexOfChild(Landroid/view/View;)I

    move-result v5

    if-gez v5, :cond_1

    sget-object p1, Ljoe;->a:Ljava/lang/String;
    ...
    invoke-virtual {v1, v5}, Ljoe;->getChildAt(I)Landroid/view/View;
...
.method public final a(Lfro;)V
    ...
    iput-object p1, v0, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->h:Lfro;

    iget-object v0, p0, Ljov;->f:Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;

    iput-object p1, v0, Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;->f:Lfro;
...
.method public final a(Ljpk;)V
    ...
    iput-object p1, p0, Ljov;->h:Lnre;

    iget-object p1, p0, Ljov;->e:Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;

    invoke-static {p0}, Lnre;->b(Ljava/lang/Object;)Lnre;

    move-result-object v0

    iput-object v0, p1, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->i:Lnre;

    iget-object p1, p0, Ljov;->f:Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;

    invoke-static {p0}, Lnre;->b(Ljava/lang/Object;)Lnre;

    move-result-object v0

    iput-object v0, p1, Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;->m:Lnre;
...
.method public final a(Lkac;Z)V
    ...
    invoke-direct {p0, p1}, Ljov;->f(Lkac;)Z
    ...
    invoke-virtual {v0, p1, p2}, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->b(Lkac;Z)V

    return-void

    :cond_0
    invoke-direct {p0, p1}, Ljov;->g(Lkac;)Z
...
.method public final a(Z)V
    ...
    iget-object v0, v0, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->k:Lkac;
    ...
    :cond_0
    iget-object v0, p0, Ljov;->g:Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;
...
.method public final b(Lkac;)V
    ...
    invoke-interface {v0, p1}, Ljpk;->b(Lkac;)V
...
.method public final b(Z)V
    ...
    invoke-direct {p1, v0}, Ljpc;-><init>(Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;)V
    ...
    iget-object p1, v0, Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;->e:Lkau;
...
.method public final c()V
    ...
    invoke-static {v2, v0}, Lkde;->a(ILandroid/view/View;)V
...
.method public final c(Lkac;)V
    ...
    iget-object v1, p0, Ljov;->e:Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;

    invoke-virtual {v0, p1, v1}, Ljava/util/EnumMap;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Ljov;->e:Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;

    invoke-virtual {v0, p1}, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->a(Lkac;)V

    invoke-direct {p0, p1}, Ljov;->h(Lkac;)V
...
.method public final d()V
    ...
    invoke-static {v1, v0}, Lkde;->a(ILandroid/view/View;)V

    :cond_0
    return-void
.end method

.method public final d(Lkac;)V
    .locals 6
    ...
    invoke-static {v0, v2, p1}, Loag;->a(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    iget-object v2, p0, Ljov;->f:Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;
    ...
    invoke-direct {v3, p1}, Ljpd;-><init>(Lkac;)V
...
.method public final e()Lkah;
    ...
    invoke-direct {v1, v0}, Ljoq;-><init>(Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;)V
...
.method public final e(Lkac;)V
    ...
    invoke-direct {p0, v0}, Ljov;->f(Lkac;)Z
    ...
    invoke-virtual {v0, v2}, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->a(Lkac;)V

    iget-object v0, p0, Ljov;->b:Ljava/util/EnumMap;

    sget-object v2, Lkac;->q:Lkac;

    iget-object v3, p0, Ljov;->e:Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;
    ...
    iput-object p1, v0, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->k:Lkac;
    ...
    iget-object v3, v0, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->k:Lkac;
    ...
    invoke-static {p1, v2}, Lpjn;->a(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p1, v0, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->c:Ljoe;

    iget-object v2, v0, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->k:Lkac;

    iput-object v2, p1, Ljoe;->i:Lkac;
...
.method public final f()Lkah;
    .locals 2

    iget-object v0, p0, Ljov;->e:Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;

    iget-object v0, v0, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->c:Ljoe;

    new-instance v1, Ljoj;

    invoke-direct {v1, v0}, Ljoj;-><init>(Ljoe;)V
...
.method public final g()Lkah;
    ...
    invoke-direct {v1, v0}, Ljok;-><init>(Ljoe;)V

    return-object v1
.end method

.method public final h()Lkah;
    .locals 2
    ...
    invoke-direct {v1, v0}, Ljol;-><init>(Ljoe;)V
