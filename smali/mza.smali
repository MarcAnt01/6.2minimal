...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmza;->a:[Ljava/lang/String;
    ...
    sput-object v0, Lmza;->b:[Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {p0, p1, p2, v0}, Lmza;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Lmzd;)Landroid/os/ParcelFileDescriptor;
...
.method private static a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Lmzd;)Landroid/os/ParcelFileDescriptor;
    .locals 8
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
    ...
    invoke-static {p2}, Lmza;->a(Ljava/io/FileDescriptor;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p3, Lmzd;->c:Ljava/lang/String;
    ...
    invoke-static {v0}, Lmza;->a(Ljava/util/concurrent/Callable;)[Ljava/io/File;
    ...
    invoke-direct {v0, p0}, Lmzc;-><init>(Landroid/content/Context;)V
    ...
    invoke-static {p1, p2}, Lmza;->a(Landroid/os/ParcelFileDescriptor;Ljava/io/FileNotFoundException;)V
    ...
    invoke-static {p1, p0}, Lmza;->a(Landroid/os/ParcelFileDescriptor;Ljava/io/FileNotFoundException;)V
    ...
    :cond_1a
    iget-boolean v4, p3, Lmzd;->b:Z

    if-nez v4, :cond_1f

    iget-object p3, p3, Lmzd;->c:Ljava/lang/String;
    ...
    sget-object p0, Lmza;->b:[Ljava/lang/String;
    ...
    sget-object p0, Lmza;->a:[Ljava/lang/String;
...
.method private static a(Ljava/io/FileDescriptor;)Ljava/lang/String;
    ...
    invoke-static {v0, p0}, Lota;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method private static a(Landroid/os/ParcelFileDescriptor;Ljava/io/FileNotFoundException;)V
    ...
    invoke-static {p1, p0}, Lota;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
