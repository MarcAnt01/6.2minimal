...
# direct methods
.method public constructor <init>(Landroid/hardware/camera2/CameraManager;Llta;Ljava/util/concurrent/Executor;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lchf;->c:Landroid/hardware/camera2/CameraManager;

    iput-object p2, p0, Lchf;->d:Llta;

    iput-object p3, p0, Lchf;->e:Ljava/util/concurrent/Executor;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lchf;->a:Ljava/lang/Object;

    return-void
.end method

.method private final c()Lose;
    .locals 3

    iget-object v0, p0, Lchf;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lchf;->b:Loss;
    ...
    iget-object v0, p0, Lchf;->e:Ljava/util/concurrent/Executor;
...
.method public final a()Lose;
    ...
    :try_start_0
    iget-object v0, p0, Lchf;->c:Landroid/hardware/camera2/CameraManager;
...
.method final b()Z
    ...
    invoke-direct {v6, v2}, Lchh;-><init>(Ljava/util/concurrent/atomic/AtomicBoolean;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_2

    :try_start_2
    iget-object v4, p0, Lchf;->c:Landroid/hardware/camera2/CameraManager;

    const-string v7, "PollUntilReconnect"

    invoke-static {v5, v7}, Llsi;->a(Lljf;Ljava/lang/String;)Landroid/os/Handler;
    ...
    iget-object v2, p0, Lchf;->d:Llta;

    const/4 v4, 0x2

    invoke-interface {v2, v4}, Llta;->c(I)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1

    :try_start_3
    invoke-virtual {v5}, Lljf;->close()V
    :try_end_3
    ...
    :cond_0
    :try_start_4
    iget-object v7, p0, Lchf;->c:Landroid/hardware/camera2/CameraManager;
    ...
    iget-object v4, p0, Lchf;->d:Llta;

    invoke-interface {v4, v2}, Llta;->c(I)V
    :try_end_4
    ...
    :try_start_9
    invoke-static {v2, v5}, Lota;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lchf;->d:Llta;

    const/4 v1, 0x3

    invoke-interface {v0, v1}, Llta;->c(I)V
    :try_end_a
    ...
    iget-object v1, p0, Lchf;->c:Landroid/hardware/camera2/CameraManager;
