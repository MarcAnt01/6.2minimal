...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpfh;->a:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/ContentProviderClient;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lpfh;->b:Landroid/content/ContentProviderClient;

    const-string p1, "device_params"

    invoke-static {p2, p1}, Lpgn;->a(Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object p1

    iput-object p1, p0, Lpfh;->c:Landroid/net/Uri;
    ...
    iput-object p1, p0, Lpfh;->d:Landroid/net/Uri;
    ...
    iput-object p1, p0, Lpfh;->e:Landroid/net/Uri;
    ...
    iput-object p1, p0, Lpfh;->f:Landroid/net/Uri;
...
.method private final a(Loyo;Landroid/net/Uri;Ljava/lang/String;)Loyn;
    .locals 1

    invoke-direct {p0, p2, p3}, Lpfh;->a(Landroid/net/Uri;Ljava/lang/String;)[B
    ...
    :try_start_0
    invoke-interface {p1, p2}, Loyo;->a([B)Loyo;
    ...
    sget-object p2, Lpfh;->a:Ljava/lang/String;
...
.method private final a(Lpay;Landroid/net/Uri;)Lpay;
    .locals 2

    const/4 v0, 0x0

    invoke-direct {p0, p2, v0}, Lpfh;->a(Landroid/net/Uri;Ljava/lang/String;)[B
    ...
    :try_start_0
    invoke-static {p1, p2}, Lpay;->mergeFrom(Lpay;[B)Lpay;
...
.method private final a(Landroid/net/Uri;Ljava/lang/String;)[B
    ...
    :try_start_0
    iget-object v1, p0, Lpfh;->b:Landroid/content/ContentProviderClient;
    ...
    :cond_3
    :try_start_2
    sget-object v1, Lpfh;->a:Ljava/lang/String;
...
.method private final b(Lpay;Landroid/net/Uri;)Z
    .locals 4
    ...
    :try_start_0
    iget-object p1, p0, Lpfh;->b:Landroid/content/ContentProviderClient;
...
.method public final a(Lphk;)Lofc;
    ...
    iget-object v0, p0, Lpfh;->f:Landroid/net/Uri;

    invoke-direct {p0, v1, v0, p1}, Lpfh;->a(Loyo;Landroid/net/Uri;Ljava/lang/String;)Loyn;
...
.method public final a()Lphl;
    ...
    iget-object v1, p0, Lpfh;->c:Landroid/net/Uri;

    invoke-direct {p0, v0, v1}, Lpfh;->a(Lpay;Landroid/net/Uri;)Lpay;
...
.method public final a(Lphl;)Z
    ...
    iget-object v0, p0, Lpfh;->c:Landroid/net/Uri;

    invoke-direct {p0, p1, v0}, Lpfh;->b(Lpay;Landroid/net/Uri;)Z
...
.method public final b()Lpgy;
    ...
    iget-object v1, p0, Lpfh;->e:Landroid/net/Uri;

    const/4 v2, 0x0

    invoke-direct {p0, v0, v1, v2}, Lpfh;->a(Loyo;Landroid/net/Uri;Ljava/lang/String;)Loyn;
...
.method public final c()Lphi;
    ...
    sget-object v0, Lphi;->e:Lphi;

    invoke-virtual {v0}, Lphi;->g()Loxa;

    move-result-object v0

    iget-object v1, p0, Lpfh;->d:Landroid/net/Uri;
...
.method public final d()V
    ...
    iget-object v0, p0, Lpfh;->b:Landroid/content/ContentProviderClient;
