...
.method public constructor <init>(Landroid/content/Context;Lbdf;Lcej;Lcet;Ljdr;Lcdw;Llsl;Ljava/util/concurrent/ExecutorService;Llji;Lcvm;Lcdz;)V
    .locals 2
    ...
    iput-object p10, p0, Lcco;->s:Lcvm;
...
.method private final a(Landroid/net/Uri;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;)V
    ...
    invoke-static {p2, v1}, Lmqc;->a(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)Lmoz;
    ...
    invoke-interface {p2, p3, v0}, Lmoz;->a(Ljava/util/concurrent/Executor;Lmnk;)Lmoz;
...
.method public final a(Landroid/view/View;Lbhz;Lbhy;)Landroid/view/View;
    ...
    invoke-interface {p2, p1, p0, v0, p3}, Lbhx;->a(Lnre;Lbig;ZLbhy;)Landroid/view/View;
...
.method public final a(Lbhz;Lbhx;)V
    ...
    invoke-interface {p2}, Lbhx;->h()Lfuw;
...
.method public final a(Llra;)V
    ...
    iget-object v3, v2, Lcdz;->i:Lljc;

    new-instance v4, Lcea;

    invoke-direct {v4, v2, v1}, Lcea;-><init>(Lcdz;Loss;)V

    invoke-virtual {v3, v4}, Lljc;->execute(Ljava/lang/Runnable;)V

    new-instance v2, Lccs;

    invoke-direct {v2, p0, v0, p1}, Lccs;-><init>(Lcco;Lcdn;Llra;)V
...
.method public final a(Lbhx;Z)Z
    ...
    invoke-static {p2, v0}, Lpjn;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, p2}, Lpjn;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final b()Lose;
    ...
    invoke-direct {v1, p0, v2, v3, v0}, Lccv;-><init>(Lcco;JLoss;)V
...
.method public final b(Lbhz;)V
    ...
    invoke-interface {v0}, Lbhx;->i()Lfut;

    move-result-object v2

    invoke-virtual {v2}, Lfut;->e()Z
