...
.method public final run()V
    ...
    iget-object v3, v0, Lmwn;->g:Ljava/lang/Object;

    monitor-enter v3

    :try_start_1
    iget-object v4, v0, Lmwn;->f:Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    :cond_0
    invoke-virtual {v4}, Lmwf;->a()Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-virtual {v0}, Lmwn;->a()V

    goto :goto_0

    :cond_1
    iget-object v5, v0, Lmwn;->d:Loss;
    ...
    iget-object v5, v4, Lmwf;->b:Landroid/media/MediaCodec$BufferInfo;

    iget-wide v5, v5, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    iget-wide v7, v0, Lmwn;->h:J

    iget-object v9, v0, Lmwn;->c:Lmwl;

    iget-object v9, v9, Lmwl;->b:Landroid/media/MediaFormat;

    const-string v10, "oo.muxer.force_sequential"

    invoke-static {v9, v10}, Lmwn;->a(Landroid/media/MediaFormat;Ljava/lang/String;)Z
    ...
    iput-wide v5, v0, Lmwn;->h:J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    :cond_3
    :try_start_2
    iget-object v5, v4, Lmwf;->a:Ljava/nio/ByteBuffer;

    iget-object v4, v4, Lmwf;->b:Landroid/media/MediaCodec$BufferInfo;
