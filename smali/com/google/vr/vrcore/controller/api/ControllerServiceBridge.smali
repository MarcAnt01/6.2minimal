...
.method public constructor <init>(Landroid/content/Context;Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;I)V
    ...
    invoke-direct {v0, p3}, Lpih;-><init>(I)V

    invoke-direct {p0, p1, p2, v0}, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;-><init>(Landroid/content/Context;Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;Lpih;)V

    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;Lpih;)V
    .locals 2
    ...
    invoke-direct {v0, p2, p3, v1}, Lpit;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;Lpih;I)V

    iput-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lpit;

    iget-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->c:Landroid/util/SparseArray;

    iget-object p3, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lpit;
    ...
    invoke-direct {p2, p0}, Lpjd;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;)V

    iput-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->j:Lpjd;
...
.method private static a(Landroid/content/Context;)I
    ...
    move-result p0
    :try_end_0
    .catch Lphn; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Lpid;)V
    .locals 5

    iget-wide v0, p0, Lpid;->o:J
    ...
    invoke-static {}, Lpid;->f()J

    move-result-wide v0

    iget-wide v2, p0, Lpid;->o:J
...
.method private final a(ILpit;)Z
    .locals 3

    :try_start_0
    iget-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->d:Lpja;

    iget-object v1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->i:Ljava/lang/String;

    new-instance v2, Lpiz;

    invoke-direct {v2, p2}, Lpiz;-><init>(Lpit;)V

    invoke-interface {v0, p1, v1, v2}, Lpja;->a(ILjava/lang/String;Lpiy;)Z
...
.method public final a()V
    ...
    invoke-interface {v0, v2}, Lpja;->a(Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->j:Lpjd;

    invoke-interface {v0, v2}, Lpja;->b(Lpjc;)Z
    ...
    iput-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->d:Lpja;
...
.method public final b()V
    ...
    iget-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lpit;

    iget-object v0, v0, Lpit;->a:Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;
    ...
    invoke-direct {p0, v1, v0}, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->a(ILpit;)Z
    ...
    iget-object v2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lpit;
...
.method public createAndConnectController(ILcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;I)Z
    ...
    iget-object p3, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->d:Lpja;

    const/4 v1, 0x0

    if-eqz p3, :cond_3

    new-instance p3, Lpit;

    invoke-direct {p3, p2, v0, p1}, Lpit;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;Lpih;I)V

    iget p2, p3, Lpit;->c:I

    invoke-direct {p0, p2, p3}, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->a(ILpit;)Z
    ...
    iput-object p3, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lpit;
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-direct {p1, p2}, Lpjb;-><init>(Landroid/os/IBinder;)V
    ...
    :goto_0
    iput-object p1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->d:Lpja;

    :try_start_0
    iget-object p1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->d:Lpja;

    invoke-interface {p1}, Lpja;->a()I
    ...
    :try_start_1
    iget-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->d:Lpja;

    iget-object v1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->j:Lpjd;

    invoke-interface {p2, v1}, Lpja;->a(Lpjc;)Z
    ...
    iget-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lpit;
    ...
    iget-object p1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lpit;

    iget-object p1, p1, Lpit;->a:Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;
...
.method public requestBind()V
    ...
    invoke-direct {v1, p0}, Lpip;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;)V
...
.method public requestUnbind()V
    ...
    invoke-direct {v1, p0}, Lpiq;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;)V
...
.method public vibrateController(IIII)V
    ...
    invoke-virtual {v0}, Lpjf;->g()Loxa;

    move-result-object v0

    sget-object v1, Lpjg;->e:Lpjg;

    invoke-virtual {v1}, Lpjg;->g()Loxa;
    ...
    iget-object p3, v0, Loxa;->b:Lowz;

    check-cast p3, Lpjf;

    if-eqz p2, :cond_2

    iput-object p2, p3, Lpjf;->b:Lpjg;
    ...
    new-instance p3, Lpin;

    invoke-direct {p3}, Lpin;-><init>()V
    ...
    :cond_0
    invoke-interface {p2}, Loyn;->i()I

    move-result p4

    if-eqz p4, :cond_1

    invoke-interface {p2}, Loyn;->d()[B

    move-result-object p2

    iput-object p2, p3, Lpje;->a:[B
    ...
    new-instance p4, Lpir;

    invoke-direct {p4, p0, p1, p3}, Lpir;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;ILpin;)V
