...
.method private static readDeviceParams(Landroid/content/Context;)[B
    ...
    invoke-interface {p0}, Lpgb;->a()Lphl;
...
.method private static readDisplayParams(Landroid/content/Context;J)V
    ...
    invoke-interface {v1}, Lpgb;->b()Lpgy;

    move-result-object v2

    invoke-interface {v1}, Lpgb;->d()V
    ...
    invoke-static {v1}, Lpfi;->a(Landroid/view/Display;)Landroid/util/DisplayMetrics;
    ...
    :cond_1
    invoke-static {v2}, Lpfi;->a(Lpgy;)F

    move-result v2

    invoke-static {v1}, Lpgc;->a(Landroid/view/Display;)Lpff;
    ...
    invoke-virtual {v1, p0}, Lpff;->a(Ljava/lang/String;)I

    move-result p0

    const-string v0, "getSafeInsetBottom"

    invoke-virtual {v1, v0}, Lpff;->a(Ljava/lang/String;)I
    ...
    invoke-static {v1}, Lpfi;->a(Lpgy;)F
...
.method private static readSdkConfigurationParams(Landroid/content/Context;)[B
    ...
    invoke-static {p0}, Lpgo;->a(Landroid/content/Context;)Lofc;

    move-result-object p0

    invoke-virtual {p0}, Lofc;->d()[B
...
.method private static readUserPrefs(Landroid/content/Context;)[B
    ...
    invoke-interface {p0}, Lpgb;->c()Lphi;
...
.method private static writeDeviceParams(Landroid/content/Context;[B)Z
    ...
    invoke-static {v0, p1}, Lpay;->mergeFrom(Lpay;[B)Lpay;
    ...
    :goto_0
    invoke-interface {p0, p1}, Lpgb;->a(Lphl;)Z
