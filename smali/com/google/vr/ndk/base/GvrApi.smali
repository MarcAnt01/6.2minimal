...
.method private static requestFeatures(Landroid/content/Context;J[I[ILandroid/app/PendingIntent;)V
    ...
    invoke-static {p3}, Lpgq;->a([I)[Lpgq;

    move-result-object p3

    invoke-static {p4}, Lpgq;->a([I)[Lpgq;
    ...
    invoke-direct {v0, v1, v2}, Lpgp;-><init>(J)V
    ...
    sget-object v2, Lpge;->a:Landroid/content/ComponentName;
    ...
    :cond_1
    invoke-virtual {v0, v6}, Lpgp;->a(Lpgq;)Z

    move-result v7

    if-nez v7, :cond_0

    iget-object v6, v6, Lpgq;->b:Ljava/lang/String;
    ...
    :cond_6
    invoke-virtual {v0, v4}, Lpgp;->a(Lpgq;)Z

    move-result v5

    if-nez v5, :cond_5

    iget-object v4, v4, Lpgq;->b:Ljava/lang/String;
