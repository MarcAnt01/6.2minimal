...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1}, Lmjt;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/lens/sdk/LensApi;->c:Lmjt;

    new-instance v0, Lmjw;

    iget-object v1, p0, Lcom/google/lens/sdk/LensApi;->c:Lmjt;

    invoke-direct {v0, p1, v1}, Lmjw;-><init>(Landroid/content/Context;Lmjt;)V

    iput-object v0, p0, Lcom/google/lens/sdk/LensApi;->a:Lmjw;
...
.method private final a(Landroid/app/Activity;Lcom/google/lens/sdk/LensApi$LensLaunchStatusCallback;Ljava/lang/Runnable;)V
    ...
    invoke-direct {v0, p3, p2}, Lots;-><init>(Ljava/lang/Runnable;Lcom/google/lens/sdk/LensApi$LensLaunchStatusCallback;)V
...
.method private final a(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Lcom/google/lens/sdk/LensApi;->c:Lmjt;

    iget-object v0, v0, Lmjt;->e:Lmkg;

    iget-object v0, v0, Lmkg;->c:Ljava/lang/String;
...
.method public final a(Landroid/app/Activity;)V
    ...
    iget-object v0, p0, Lcom/google/lens/sdk/LensApi;->a:Lmjw;

    invoke-virtual {v0}, Lmjw;->d()Z
...
.method public final a(Lotu;)V
    ...
    iget-object v3, p1, Lotu;->a:Landroid/graphics/Bitmap;
    ...
    :goto_2
    iget-object v1, p1, Lotu;->c:Ljava/lang/Integer;
    ...
    iget-object v1, p1, Lotu;->d:Landroid/graphics/PointF;
    ...
    :cond_4
    invoke-virtual {v0, v2}, Lmjw;->a(Landroid/os/Bundle;)Z
    ...
    iget-object p1, p1, Lotu;->b:Ljava/lang/Long;
    ...
    :cond_6
    invoke-virtual {v0, v2}, Lmjw;->b(Landroid/os/Bundle;)Z
...
.method public final a(Landroid/graphics/Bitmap;Lotu;)Z
    .locals 3
    ...
    invoke-virtual {p2}, Lotu;->b()Lotv;

    move-result-object p2

    iget-object p2, p2, Lotv;->a:Lotu;

    iput-object p1, p2, Lotu;->a:Landroid/graphics/Bitmap;

    invoke-virtual {p0, p2}, Lcom/google/lens/sdk/LensApi;->a(Lotu;)V
...
.method public checkArStickersAvailability(Lcom/google/lens/sdk/LensApi$LensAvailabilityCallback;)V
    ...
    invoke-direct {v1, p1, v2}, Lott;-><init>(Lcom/google/lens/sdk/LensApi$LensAvailabilityCallback;I)V

    invoke-virtual {v0, v1}, Lmjt;->a(Lmju;)V
...
.method public checkPostCaptureAvailability(Lcom/google/lens/sdk/LensApi$LensAvailabilityCallback;)V
    ...
    invoke-direct {v1, p1}, Lotr;-><init>(Lcom/google/lens/sdk/LensApi$LensAvailabilityCallback;)V

    invoke-static {}, Lmkf;->a()V

    new-instance p1, Lmjx;

    invoke-direct {p1, v0, v1}, Lmjx;-><init>(Lmjw;Lmjz;)V

    invoke-virtual {v0, p1}, Lmjw;->a(Lmjz;)V
...
.method public launchLensActivity(Landroid/app/Activity;)V
    ...
    invoke-direct {v0, p0, p1}, Lotn;-><init>(Lcom/google/lens/sdk/LensApi;Landroid/app/Activity;)V
...
.method public launchLensActivity(Landroid/app/Activity;I)V
    ...
    :cond_0
    iget-object p2, p0, Lcom/google/lens/sdk/LensApi;->c:Lmjt;

    iget-object p2, p2, Lmjt;->e:Lmkg;

    iget p2, p2, Lmkg;->e:I

    invoke-static {p2}, Lmlj;->b(I)I
    ...
    :cond_2
    new-instance p2, Lotp;

    invoke-direct {p2, p0, p1}, Lotp;-><init>(Lcom/google/lens/sdk/LensApi;Landroid/app/Activity;)V
...
.method public launchLensActivity(Landroid/app/Activity;Lcom/google/lens/sdk/LensApi$LensLaunchStatusCallback;)V
    ...
    iget-object v0, v0, Lotv;->a:Lotu;

    invoke-virtual {p0, p1, p2, v0}, Lcom/google/lens/sdk/LensApi;->launchLensActivity(Landroid/app/Activity;Lcom/google/lens/sdk/LensApi$LensLaunchStatusCallback;Lotu;)V

    return-void
.end method

.method public launchLensActivity(Landroid/app/Activity;Lcom/google/lens/sdk/LensApi$LensLaunchStatusCallback;Lotu;)V
    .locals 1
    .annotation build Landroid/support/annotation/Keep;
    .end annotation
    ...
    invoke-direct {v0, p0, p1, p3}, Loto;-><init>(Lcom/google/lens/sdk/LensApi;Landroid/app/Activity;Lotu;)V
...
.method public launchLensActivityWithBitmap(Landroid/graphics/Bitmap;)Z
    ...
    invoke-virtual {v2, v0}, Lotv;->a(Ljava/lang/Long;)Lotv;

    move-result-object v0

    iget-object v0, v0, Lotv;->a:Lotu;

    invoke-virtual {p0, p1, v0}, Lcom/google/lens/sdk/LensApi;->a(Landroid/graphics/Bitmap;Lotu;)Z
...
.method public onPause()V
    ...
    iget-object v0, v0, Lmjw;->a:Lmka;

    invoke-interface {v0}, Lmka;->c()V
