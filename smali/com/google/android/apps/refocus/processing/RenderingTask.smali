...
.method public constructor <init>(Landroid/net/Uri;Lcom/google/android/apps/refocus/processing/FocusSettings;Lcom/google/android/apps/refocus/image/RGBZ;Ljava/lang/String;Landroid/location/Location;Lcom/google/android/apps/refocus/processing/FaceDetector;Landroid/content/ContentResolver;Lisu;Lisc;)V
    .locals 0
    ...
    invoke-direct {p7, p8, p2, p1}, Lisx;-><init>(Lisu;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface/range {p2 .. p7}, Lisc;->a(Ljava/lang/String;Lljt;JLisx;)Lirx;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/refocus/processing/RenderingTask;->session:Lirx;
...
.method private processInternal(Landroid/content/Context;Lirx;)V
    .locals 5
    ...
    sget-object v2, Lipt;->i:Lipt;

    invoke-virtual {p2, v0, v1, v2}, Lirx;->a(Landroid/net/Uri;Ljtk;Lipt;)V

    new-instance v0, Lcom/google/android/apps/refocus/processing/ProgressCallbackImpl;

    invoke-direct {v0, p2}, Lcom/google/android/apps/refocus/processing/ProgressCallbackImpl;-><init>(Liom;)V
    ...
    invoke-direct {v1, v2, v3}, Ljdk;-><init>(Llrt;Lmjg;)V
    ...
    invoke-virtual {v1, p1}, Ljdk;->a(Lcom/google/android/libraries/camera/exif/ExifInterface;)Ljdk;

    move-result-object p1

    sget-object v1, Llrp;->a:Llrp;

    invoke-virtual {p1, v1}, Ljdk;->a(Llrp;)Ljdk;

    move-result-object p1

    invoke-virtual {p2, v0, p1}, Lirx;->a(Ljava/io/InputStream;Ljdk;)Lose;
...
.method public getSession()Lifq;
    ...
    iget-object v0, p0, Lcom/google/android/apps/refocus/processing/RenderingTask;->session:Lirx;
...
.method public process(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/android/apps/refocus/processing/RenderingTask;->processInternal(Landroid/content/Context;Lirx;)V
