...
.field public final dataset:Lkne;
...
.field public final location:Lljt;

.field public final maxNativeMemory:Lfty;

.field public final memoryManager:Lfua;

.field public final orientation:I

.field public final reference:Lcom/google/android/apps/refocus/image/ColorImage;

.field public final session:Liom;

.field public final sessionManager:Lipi;

.field public final startTimeMillis:J

.field public final usageStatistics:Lfro;
...
.method public constructor <init>(Lfua;Lkne;IIZLjava/lang/String;Lljt;Liom;Lfty;Lcbc;Lfro;Lipi;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->memoryManager:Lfua;

    iput-object p2, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkne;
    ...
    iput-object p7, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->location:Lljt;
    ...
    iput-object p8, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Liom;
    ...
    iput-object p9, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->maxNativeMemory:Lfty;

    iput-object p10, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->gservicesHelper:Lcbc;

    iput-object p11, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->usageStatistics:Lfro;
    ...
    iput-object p12, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->sessionManager:Lipi;

    return-void
.end method

.method public constructor <init>(Lfua;Lkne;Ljava/util/List;Lcom/google/android/apps/refocus/image/ColorImage;IIZLjava/lang/String;Lljt;Lipi;Lfty;Lcbc;Lfro;Lisu;Lisc;)V
    .locals 0
    ...
    iput-object p9, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->location:Lljt;
    ...
    invoke-direct {p8, p14, p2, p1}, Lisx;-><init>(Lisu;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface/range {p3 .. p8}, Lisc;->a(Ljava/lang/String;Lljt;JLisx;)Lirx;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Liom;

    iput-object p10, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->sessionManager:Lipi;

    iput-object p11, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->maxNativeMemory:Lfty;

    iput-object p12, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->gservicesHelper:Lcbc;

    iput-object p13, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->usageStatistics:Lfro;
...
.method static synthetic access$100(Lcom/google/android/apps/refocus/processing/DepthmapTask;)Lkne;
    .locals 0

    iget-object p0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkne;
...
.method private computeRGBZ(Landroid/content/Context;Lcom/google/android/apps/refocus/processing/ProgressCallback;Z)Lcom/google/android/apps/refocus/image/RGBZ;
    ...
    invoke-static {v2, v3}, Lpjn;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v3, v2}, Lpjn;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v2, v1, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Liom;

    const v3, 0x7f130292

    new-array v4, v12, [Ljava/lang/Object;

    invoke-static {v3, v4}, Ljtl;->a(I[Ljava/lang/Object;)Ljtk;

    move-result-object v3

    invoke-interface {v2, v3}, Liom;->a(Ljtk;)V
...
.method private failAndFinish()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Liom;
    ...
    invoke-static {v3, v2}, Ljtl;->a(I[Ljava/lang/Object;)Ljtk;

    move-result-object v2

    const-string v3, "Processing failed."

    invoke-interface {v0, v2, v1, v3}, Liom;->a(Ljtk;ZLjava/lang/String;)V
...
.method private getFrame(I)Lcom/google/android/apps/refocus/image/ColorImage;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkne;

    invoke-virtual {v0, p1}, Lkne;->a(I)Ljava/lang/String;
...
.method private getNumFrames()I
    ...
    iget-object v2, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkne;

    invoke-virtual {v2, v0}, Lkne;->a(I)Ljava/lang/String;
...
.method private getReferenceBitmap(ZZ)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v2}, Lkne;->a()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lkne;->a()Ljava/lang/String;
...
.method private isHighResSupported(Lfua;)Z
    .locals 4

    iget-object p1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->maxNativeMemory:Lfty;
...
.method private isValid()Z
    ...
    iget-object v3, v0, Lkne;->a:Ljava/lang/String;

    if-eqz v3, :cond_2

    iget-object v3, v0, Lkne;->b:Ljava/lang/String;

    if-eqz v3, :cond_2

    new-instance v3, Ljava/io/File;

    invoke-virtual {v0}, Lkne;->b()Ljava/lang/String;
...
.method private processInternal(Landroid/content/Context;Lfua;Liom;)V
    .locals 1

    new-instance v0, Lcom/google/android/apps/refocus/processing/ProgressCallbackImpl;

    invoke-direct {v0, p3}, Lcom/google/android/apps/refocus/processing/ProgressCallbackImpl;-><init>(Liom;)V

    invoke-direct {p0, p2}, Lcom/google/android/apps/refocus/processing/DepthmapTask;->isHighResSupported(Lfua;)Z
...
.method private removeTemporaryFiles()V
    ...
    iget-object v4, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkne;

    invoke-virtual {v4, v1}, Lkne;->a(I)Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkne;

    invoke-virtual {v5, v1}, Lkne;->a(I)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkne;

    invoke-virtual {v1}, Lkne;->a()Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkne;

    invoke-virtual {v3}, Lkne;->a()Ljava/lang/String;
...
.method private saveAndFinish(Lcom/google/android/apps/refocus/image/RGBZ;)V
    ...
    iget-object v5, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->usageStatistics:Lfro;
    ...
    invoke-interface/range {v5 .. v10}, Lfro;->a(Ljava/lang/String;Lcom/google/android/libraries/camera/exif/ExifInterface;ZFZ)V

    iget-object v1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Liom;
    ...
    invoke-direct {v4, v5, p1}, Llrt;-><init>(II)V

    sget-object p1, Lmjg;->c:Lmjg;

    invoke-direct {v3, v4, p1}, Ljdk;-><init>(Llrt;Lmjg;)V
    ...
    invoke-virtual {v3, p1}, Ljdk;->a(Lcom/google/android/libraries/camera/exif/ExifInterface;)Ljdk;

    move-result-object p1

    sget-object v0, Llrp;->a:Llrp;

    invoke-virtual {p1, v0}, Ljdk;->a(Llrp;)Ljdk;

    move-result-object p1

    invoke-interface {v1, v2, p1}, Liom;->a(Ljava/io/InputStream;Ljdk;)Lose;
...
.method private setExifTags(IILcom/google/android/libraries/camera/exif/ExifInterface;)V
    ...
    iget-object v0, p3, Lcom/google/android/libraries/camera/exif/ExifInterface;->S:Llui;

    const/4 v1, 0x0

    iput-object v1, v0, Llui;->b:[B
    ...
    invoke-virtual {p3, v0, v1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llus;

    move-result-object v0

    invoke-virtual {p3, v0}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Llus;)Llus;
    ...
    invoke-virtual {p3, v0, p1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llus;
    ...
    invoke-virtual {p3, p1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Llus;)Llus;
    ...
    invoke-virtual {p3, p1, p2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llus;
    ...
    sget-object p2, Llul;->a:Llul;

    iget-short p2, p2, Llul;->b:S
...
# virtual methods
.method public addFinishedCallback(Llra;)V
    .locals 1
...
.method public process(Landroid/content/Context;)V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->memoryManager:Lfua;

    iget-object v2, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Liom;

    invoke-direct {p0, p1, v1, v2}, Lcom/google/android/apps/refocus/processing/DepthmapTask;->processInternal(Landroid/content/Context;Lfua;Liom;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public removeFinishedCallback(Llra;)V
    .locals 1
...
.method public save()Lcom/google/android/apps/refocus/processing/DepthmapTask;
    ...
    invoke-static {v1, v0}, Lljq;->b(Ljava/lang/String;I)Ljava/util/concurrent/ExecutorService;
    ...
    invoke-virtual {v5, v2}, Lkne;->a(I)Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->memoryManager:Lfua;
    ...
    iget-object v8, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->location:Lljt;

    iget-object v9, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Liom;

    iget-object v10, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->maxNativeMemory:Lfty;

    iget-object v11, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->gservicesHelper:Lcbc;

    iget-object v12, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->usageStatistics:Lfro;

    iget-object v13, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->sessionManager:Lipi;

    move-object v1, v0

    invoke-direct/range {v1 .. v13}, Lcom/google/android/apps/refocus/processing/DepthmapTask;-><init>(Lfua;Lkne;IIZLjava/lang/String;Lljt;Liom;Lfty;Lcbc;Lfro;Lipi;)V
...
.method public startSession(Z)V
    ...
    :cond_1
    iget-object v2, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->sessionManager:Lipi;

    iget-object v3, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Liom;

    invoke-interface {v2, v3}, Lipi;->a(Liom;)V

    const/16 v2, 0x5f

    if-eqz p1, :cond_2

    iget-object p1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Liom;
    ...
    invoke-static {v2, v0}, Ljtl;->a(I[Ljava/lang/Object;)Ljtk;

    move-result-object v0

    sget-object v2, Lipt;->h:Lipt;

    invoke-interface {p1, v1, v0, v2}, Liom;->a([BLjtk;Lipt;)V
    ...
    invoke-static {p1, v3}, Lpjn;->a(Ljava/lang/String;Ljava/lang/String;)V
