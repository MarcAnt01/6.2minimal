...
.field public depthmapData:Lknk;
...
.method private finishParsingXMPMeta()V
    ...
    :goto_0
    invoke-static {v0}, Lknm;->a(Lzt;)Lknm;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/apps/refocus/image/RGBZ;->imageData:Lknm;

    iget-object v2, p0, Lcom/google/android/apps/refocus/image/RGBZ;->imageData:Lknm;
    ...
    :goto_2
    invoke-static {v0}, Lknk;->a(Lzt;)Lknk;

    move-result-object v1

    iput-object v1, p0, Lcom/google/android/apps/refocus/image/RGBZ;->depthmapData:Lknk;

    iget-object v1, p0, Lcom/google/android/apps/refocus/image/RGBZ;->depthmapData:Lknk;
    ...
    :cond_2
    iget-object v2, v1, Lknk;->c:Lcom/google/android/apps/camera/metadata/refocus/DepthTransform;
    ...
    iget-object v4, v1, Lknk;->b:[B

    if-eqz v4, :cond_6

    if-eqz v2, :cond_6

    iget-object v4, v1, Lknk;->a:Ljava/lang/String;
    ...
    :cond_6
    :goto_5
    invoke-static {v0}, Lknl;->a(Lzt;)Lknl;

    move-result-object v0

    if-eqz v0, :cond_7

    iget-object v0, v0, Lknl;->a:Lcom/google/android/apps/refocus/processing/FocusSettings;
...
.method private writeXMPMeta(ILcom/google/android/libraries/camera/exif/ExifInterface;Ljava/io/OutputStream;)V
    ...
    invoke-static {v3}, Lknl;->a(Lcom/google/android/apps/refocus/processing/FocusSettings;)Lknl;

    move-result-object v3

    invoke-static {}, Lknl;->a()V

    :try_start_0
    const-string v4, "BlurAtInfinity"

    iget-object v5, v3, Lknl;->a:Lcom/google/android/apps/refocus/processing/FocusSettings;
    ...
    iget-object v3, v3, Lknl;->a:Lcom/google/android/apps/refocus/processing/FocusSettings;
    ...
    iget-object v3, p0, Lcom/google/android/apps/refocus/image/RGBZ;->imageData:Lknm;
    ...
    invoke-direct {v5}, Lknm;-><init>()V

    iput-object v4, v5, Lknm;->a:Ljava/lang/String;
    ...
    iput-object v3, v5, Lknm;->b:[B

    iput-object v5, p0, Lcom/google/android/apps/refocus/image/RGBZ;->imageData:Lknm;
    ...
    iget-object v0, p0, Lcom/google/android/apps/refocus/image/RGBZ;->depthmapData:Lknk;
    ...
    invoke-static {p0}, Lknk;->a(Lcom/google/android/apps/refocus/image/RGBZ;)Lknk;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/refocus/image/RGBZ;->depthmapData:Lknk;
    ...
    iget-object v4, v0, Lknk;->c:Lcom/google/android/apps/camera/metadata/refocus/DepthTransform;
    ...
    invoke-virtual {v0}, Ldat;->f()Ljava/lang/String;

    move-result-object v0

    invoke-static {p2, v0}, Lfuo;->a(Lzt;Ljava/lang/String;)Z
