...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lfcc;-><init>(Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;)V
...
.method public final a(Ljava/lang/Class;)Ldpx;
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;->y:Lfch;
...
.method public final dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-super {p0, p1}, Ldti;->dispatchTouchEvent(Landroid/view/MotionEvent;)Z
...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;->f()Ldtj;

    move-result-object v1

    invoke-virtual {p0}, Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;->g()Ldol;

    move-result-object v2

    invoke-interface {v0, v1, v2}, Ldvx;->a(Ldtj;Ldol;)Lfch;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;->y:Lfch;

    iget-object v0, p0, Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;->y:Lfch;

    invoke-interface {v0, p0}, Lfch;->a(Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;)V
    ...
    iput-object v2, v0, Lcom/google/android/apps/refocus/viewer/RGBZView;->a:Lkog;

    iget-object v2, v0, Lcom/google/android/apps/refocus/viewer/RGBZView;->a:Lkog;

    if-eqz v2, :cond_2

    iget-object v3, v0, Lcom/google/android/apps/refocus/viewer/RGBZView;->b:Landroid/graphics/RectF;

    invoke-interface {v2, v3}, Lkog;->a(Landroid/graphics/RectF;)V
    ...
    invoke-direct {v3, p0}, Lfce;-><init>(Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;)V

    iput-boolean p1, v0, Lcom/google/android/apps/refocus/viewer/RGBZViewer;->k:Z

    const/4 p1, 0x0

    iput-object p1, v0, Lcom/google/android/apps/refocus/viewer/RGBZViewer;->h:Lknz;
    ...
    invoke-direct {p1, v0, v2, v3}, Lkoh;-><init>(Lcom/google/android/apps/refocus/viewer/RGBZViewer;Lcom/google/android/apps/refocus/image/RGBZ;Ljava/lang/Runnable;)V

    invoke-virtual {p1}, Lkoh;->start()V
    ...
    iput-object p1, p0, Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;->s:Liiw;

    iget-object p1, p0, Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;->s:Liiw;
    ...
    invoke-interface {p1, v0}, Liiw;->a(Lcom/google/android/apps/camera/progressoverlay/ProgressOverlay;)V
...
.method protected final onDestroy()V
    ...
    invoke-super {p0}, Ldti;->onDestroy()V
...
.method protected final onPause()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;->s:Liiw;

    invoke-interface {v0}, Liiw;->c()V

    invoke-super {p0}, Ldti;->onPause()V
