...
.method private final declared-synchronized b()Lfeu;
    .locals 2

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b:Lfeu;
    ...
    invoke-interface {v0}, Lfew;->a()Lfeu;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b:Lfeu;
    ...
    invoke-virtual {v0, v1}, Lfeu;->a(Landroid/content/Context;)V
...
.method public final queryNonIndexableKeys([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-direct {p0}, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b()Lfeu;

    move-result-object v0

    invoke-virtual {v0}, Lfeu;->a()Ljava/util/List;
...
.method public final queryRawData([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-interface {p1}, Lnza;->n()Ljava/util/Collection;
