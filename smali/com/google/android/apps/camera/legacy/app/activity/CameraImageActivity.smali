...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/google/android/apps/camera/legacy/app/activity/CameraImageActivity;->f()Ldtj;

    move-result-object v0

    invoke-virtual {p0}, Lcom/google/android/apps/camera/legacy/app/activity/CameraImageActivity;->g()Ldol;

    move-result-object v1

    invoke-interface {p1, v0, v1}, Ldvx;->b(Ldtj;Ldol;)Lduc;

    move-result-object p1

    invoke-interface {p1}, Lduc;->a()Lebq;
    ...
    invoke-virtual {p1, v0}, Lebq;->a(Landroid/content/Intent;)Lnre;

    move-result-object v1

    iget-object v2, p1, Lebq;->a:Landroid/app/Activity;
    ...
    invoke-virtual {p1, v1}, Lebq;->a(Lkac;)Z
    ...
    :cond_1
    iget-object p1, p1, Lebq;->a:Landroid/app/Activity;
