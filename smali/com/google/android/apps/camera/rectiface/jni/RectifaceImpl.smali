...
.method public constructor <init>(Lcvm;Lieg;Lkbn;)V
    .locals 2
    ...
    iput-object p1, p0, Lcom/google/android/apps/camera/rectiface/jni/RectifaceImpl;->b:Lcvm;

    iput-object p2, p0, Lcom/google/android/apps/camera/rectiface/jni/RectifaceImpl;->g:Lieg;

    iput-object p3, p0, Lcom/google/android/apps/camera/rectiface/jni/RectifaceImpl;->c:Lkbn;
...
.method private static a(Lcom/google/googlex/gcam/ExifMetadata;)V
    ...
    invoke-static {p0, v1}, Lpjn;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static a(Lcom/google/googlex/gcam/InterleavedReadViewU8;Lcom/google/googlex/gcam/ExifMetadata;ILjava/lang/String;)V
    ...
    invoke-static {p0, v1}, Lcom/google/googlex/gcam/imageio/JpgHelper;->encodeToJpegAsByteArray(Lcom/google/googlex/gcam/InterleavedReadViewU8;Lcom/google/googlex/gcam/JpgEncodeOptions;)Lnre;
...
.method private final a(Z)Z
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/rectiface/jni/RectifaceImpl;->c:Lkbn;
    ...
    :cond_1
    :goto_0
    iget-object p1, p0, Lcom/google/android/apps/camera/rectiface/jni/RectifaceImpl;->b:Lcvm;

    sget-object v0, Lild;->c:Lcvp;

    invoke-interface {p1, v0}, Lcvm;->a(Lcvp;)Z
...
.method private final b(Z)Z
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/rectiface/jni/RectifaceImpl;->b:Lcvm;
...
.method public final a(Landroid/hardware/HardwareBuffer;Lcom/google/googlex/gcam/ExifMetadata;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v0 .. v7}, Lcom/google/android/apps/camera/rectiface/jni/RectifaceImpl;->a(Landroid/hardware/HardwareBuffer;Lcom/google/googlex/gcam/ExifMetadata;ZZLjava/lang/String;Lizv;Lcom/google/android/apps/camera/rectiface/Rectiface$RectifaceProgressCallback;)V

    return-void
.end method

.method public final a(Landroid/hardware/HardwareBuffer;Lcom/google/googlex/gcam/ExifMetadata;ZZLjava/lang/String;Lizv;Lcom/google/android/apps/camera/rectiface/Rectiface$RectifaceProgressCallback;)V
    .locals 25
    ...
    :cond_0
    iget-object v1, v0, Lcom/google/android/apps/camera/rectiface/jni/RectifaceImpl;->b:Lcvm;

    sget-object v2, Lild;->b:Lcvp;
    ...
    sget-object v3, Lild;->a:Lcvp;

    invoke-interface {v1, v3}, Lcvm;->a(Lcvp;)Z
    ...
    sget-object v7, Lild;->e:Lcvp;

    invoke-interface {v1, v7}, Lcvm;->a(Lcvp;)Z

    move-result v10

    iget-object v1, v0, Lcom/google/android/apps/camera/rectiface/jni/RectifaceImpl;->b:Lcvm;

    sget-object v7, Lild;->f:Lcvp;
    ...
    sget-object v1, Lohp;->j:Lohp;

    invoke-virtual {v1}, Lohp;->g()Loxa;

    move-result-object v1

    check-cast v1, Lohq;

    invoke-static {}, Lohr;->b()[I
    ...
    invoke-virtual {v1, v2}, Lohq;->e(I)Lohq;
    ...
    invoke-virtual {v1, v2}, Lohq;->a(I)Lohq;
    ...
    invoke-virtual {v1, v2}, Lohq;->c(I)Lohq;
    ...
    invoke-virtual {v1, v2}, Lohq;->b(I)Lohq;
    ...
    invoke-virtual {v1, v2}, Lohq;->d(I)Lohq;
    ...
    invoke-virtual {v1, v2}, Lohq;->c(F)Lohq;
    ...
    invoke-virtual {v1, v4}, Lohq;->a(F)Lohq;
    ...
    invoke-virtual {v1, v4}, Lohq;->b(F)Lohq;
    ...
    :cond_f
    :goto_9
    invoke-virtual {v1}, Lohq;->f()Lowz;

    move-result-object v1

    check-cast v1, Lohp;

    invoke-interface {v0, v1}, Lizv;->a(Lohp;)V
...
.method public final a(Lcom/google/googlex/gcam/InterleavedWriteViewU8;Lcom/google/googlex/gcam/ExifMetadata;ZZLizv;Lcom/google/android/apps/camera/rectiface/Rectiface$RectifaceProgressCallback;)V
    .locals 25
    ...
    :cond_0
    iget-object v4, v0, Lcom/google/android/apps/camera/rectiface/jni/RectifaceImpl;->b:Lcvm;

    sget-object v5, Lild;->b:Lcvp;
    ...
    iget-object v15, v0, Lcom/google/android/apps/camera/rectiface/jni/RectifaceImpl;->b:Lcvm;

    sget-object v4, Lild;->e:Lcvp;

    invoke-interface {v15, v4}, Lcvm;->a(Lcvp;)Z

    move-result v19

    iget-object v4, v0, Lcom/google/android/apps/camera/rectiface/jni/RectifaceImpl;->b:Lcvm;

    sget-object v15, Lild;->f:Lcvp;

    invoke-interface {v4, v15}, Lcvm;->a(Lcvp;)Z
    ...
    sget-object v2, Lohp;->j:Lohp;

    invoke-virtual {v2}, Lohp;->g()Loxa;
    ...
    invoke-virtual {v2, v3}, Lohq;->e(I)Lohq;
    ...
    invoke-virtual {v2, v3}, Lohq;->a(I)Lohq;
    ...
    invoke-virtual {v2, v3}, Lohq;->c(I)Lohq;
    ...
    invoke-virtual {v2, v3}, Lohq;->b(I)Lohq;
    ...
    invoke-virtual {v2, v3}, Lohq;->d(I)Lohq;
    ...
    invoke-virtual {v2, v3}, Lohq;->c(F)Lohq;
    ...
    invoke-virtual {v2, v4}, Lohq;->a(F)Lohq;
    ...
    invoke-virtual {v2, v4}, Lohq;->b(F)Lohq;
    ...
    :cond_b
    invoke-virtual {v2}, Lohq;->f()Lowz;

    move-result-object v2

    check-cast v2, Lohp;

    invoke-interface {v1, v2}, Lizv;->a(Lohp;)V
...
.method public final b()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/rectiface/jni/RectifaceImpl;->g:Lieg;

    if-eqz v0, :cond_3

    invoke-virtual {v0}, Lieg;->b()J
    ...
    :goto_0
    iget-object v1, p0, Lcom/google/android/apps/camera/rectiface/jni/RectifaceImpl;->g:Lieg;

    invoke-virtual {v1}, Lieg;->b()J
