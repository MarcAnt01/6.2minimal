...
.method private final a(Landroid/content/Context;)V
    ...
    invoke-interface {p1, v0}, Ldpw;->a(Ljava/lang/Class;)Ldpx;

    move-result-object p1

    check-cast p1, Ljmc;

    invoke-interface {p1, p0}, Ljmc;->a(Lcom/google/android/apps/camera/ui/layout/GcaLayout;)V

    return-void
.end method

.method private static a(Ljmd;Landroid/view/View;Landroid/graphics/Rect;)V
    .locals 2
    ...
    iput v0, p0, Ljmd;->width:I

    invoke-virtual {p2}, Landroid/graphics/Rect;->height()I

    move-result v0

    iput v0, p0, Ljmd;->height:I
    ...
    invoke-virtual {p0, v0, p2, v1, v1}, Ljmd;->setMargins(IIII)V
...
.method protected final synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Ljmd;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final generateLayoutParams(Landroid/util/AttributeSet;)Landroid/widget/FrameLayout$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Ljmd;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public onMeasure(II)V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/ui/layout/GcaLayout;->b:Lnsk;
    ...
    iget-object v1, p0, Lcom/google/android/apps/camera/ui/layout/GcaLayout;->c:Ljlt;
    ...
    :pswitch_0
    invoke-virtual {v1}, Ljlt;->d()Landroid/graphics/Rect;

    move-result-object v6

    invoke-static {v5, v4, v6}, Lcom/google/android/apps/camera/ui/layout/GcaLayout;->a(Ljmd;Landroid/view/View;Landroid/graphics/Rect;)V

    goto/16 :goto_1

    :pswitch_1
    invoke-virtual {v1}, Ljlt;->g()Landroid/graphics/Rect;
    ...
    :pswitch_2
    invoke-virtual {v1}, Ljlt;->j()Landroid/graphics/Rect;
    ...
    :pswitch_3
    invoke-virtual {v0}, Ljlx;->c()Ljmf;

    move-result-object v6

    if-nez v6, :cond_0

    invoke-virtual {v1}, Ljlt;->c()Landroid/graphics/Rect;
    ...
    :cond_0
    invoke-virtual {v6}, Ljmf;->a()Landroid/util/Size;
    ...
    iput v7, v5, Ljmd;->height:I

    invoke-virtual {v6}, Ljmf;->d()I

    move-result v7

    iput v7, v5, Ljmd;->gravity:I

    invoke-virtual {v6}, Ljmf;->e()I

    move-result v7

    invoke-virtual {v5, v7}, Ljmd;->setLayoutDirection(I)V

    invoke-virtual {v6}, Ljmf;->c()Landroid/graphics/Rect;
    ...
    invoke-virtual {v5, v7, v8, v9, v10}, Ljmd;->setMargins(IIII)V

    invoke-virtual {v4, v5}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {v6}, Ljmf;->b()Landroid/graphics/Rect;
    ...
    :pswitch_5
    invoke-virtual {v1}, Ljlt;->f()Landroid/graphics/Rect;
    ...
    :pswitch_6
    invoke-virtual {v1}, Ljlt;->e()Landroid/graphics/Rect;
    ...
    :pswitch_8
    invoke-virtual {v1}, Ljlt;->b()Landroid/graphics/Rect;
    ...
    :pswitch_9
    invoke-virtual {v1}, Ljlt;->i()Landroid/graphics/Rect;
    ...
    :cond_3
    iput-object v1, p0, Lcom/google/android/apps/camera/ui/layout/GcaLayout;->c:Ljlt;
...
.method public final requestLayout()V
    ...
    iput-object v0, p0, Lcom/google/android/apps/camera/ui/layout/GcaLayout;->c:Ljlt;
