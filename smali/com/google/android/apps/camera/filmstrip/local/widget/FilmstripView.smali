...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    new-array p1, p1, [Lcsv;

    iput-object p1, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;

    const/4 p1, 0x0

    iput-object p1, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->o:Ljwy;
    ...
    iput-object p1, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->w:Loss;

    new-instance p1, Lcsf;

    invoke-direct {p1, p0}, Lcsf;-><init>(Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;)V

    iput-object p1, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->f:Lcrq;
...
.method private final a(II)V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;
    ...
    invoke-virtual {v1, v2, v3, v4}, Lcsv;->a(Landroid/graphics/Rect;IF)V

    const/high16 v2, 0x3f800000    # 1.0f

    invoke-virtual {v1, v2}, Lcsv;->c(F)V

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Lcsv;->a(I)V
    ...
    invoke-virtual {v1, p1}, Lcsv;->b(F)V
...
.method private final a(Z)V
    ...
    invoke-direct {p0, v0}, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->a([Lcsv;)V
    ...
    invoke-virtual {v0, v2, v3, v6}, Lcsv;->a(Landroid/graphics/Rect;IF)V

    const/4 v2, 0x0

    invoke-virtual {v0, v2}, Lcsv;->b(F)V

    const/high16 v2, 0x3f800000    # 1.0f

    invoke-virtual {v0, v2}, Lcsv;->c(F)V

    invoke-virtual {v0, v4}, Lcsv;->a(I)V
    ...
    iget-object v2, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;
    ...
    invoke-virtual {v2, p1, v3, v5}, Lcsv;->a(Landroid/graphics/Rect;IF)V
    ...
    iget-object v5, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;
    ...
    iget-object v6, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;

    aget-object v6, v6, v2

    invoke-virtual {v6}, Lcsv;->c()I
    ...
    iget-object v8, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;
    ...
    iget-object p1, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;
    ...
    :cond_10
    iget-object v2, v2, Lcsv;->g:Lbhz;

    invoke-interface {v2}, Lbhz;->b()Lbhz;

    move-result-object v2

    invoke-virtual {p0, v2}, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->a(Lbhz;)Lcsv;
    ...
    iget-object v3, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;
    ...
    :cond_14
    iget-object v5, v5, Lcsv;->g:Lbhz;

    invoke-interface {v5}, Lbhz;->a()Lbhz;

    move-result-object v5

    invoke-virtual {p0, v5}, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->a(Lbhz;)Lcsv;
    ...
    :cond_17
    iget-object p1, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->y:Lcsu;
    ...
    iget-object v2, v2, Lcsv;->h:Lbhx;

    invoke-interface {p1, v2}, Lcsu;->a(Lbhx;)V
...
.method private final a([Lcsv;)V
    ...
    iget-object v3, v2, Lcsv;->b:Landroid/view/View;
...
.method private final d(I)V
    ...
    invoke-virtual {v1, p1, v0, v3}, Lcsv;->a(Landroid/graphics/Rect;IF)V
    ...
    invoke-virtual {v1, p1}, Lcsv;->a(I)V
...
# virtual methods
.method public final a(Lbhz;)Lcsv;
    .locals 7
    ...
    invoke-static {v4, v3}, Lpjn;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v0, v2, p1, p0}, Lcsv;-><init>(ILandroid/view/View;Lbhz;Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;)V

    iget-object p1, v1, Lcsv;->a:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;

    iget-object v0, v1, Lcsv;->b:Landroid/view/View;
    ...
    invoke-virtual {v1, p1}, Lcsv;->c(F)V

    const/4 p1, 0x0

    invoke-virtual {v1, p1}, Lcsv;->b(F)V

    invoke-virtual {v1, p1}, Lcsv;->a(F)V
...
.method public final a(Landroid/graphics/Bitmap;)V
    ...
    :cond_1
    iget-object v2, v0, Lcsv;->b:Landroid/view/View;
...
.method public final a(Lcsv;)V
    ...
    iget-object v1, p1, Lcsv;->i:Landroid/animation/ValueAnimator;
    ...
    iput-object v1, p1, Lcsv;->i:Landroid/animation/ValueAnimator;

    iget-object v1, p1, Lcsv;->i:Landroid/animation/ValueAnimator;

    new-instance v2, Lcsw;

    invoke-direct {v2, p1}, Lcsw;-><init>(Lcsv;)V
    ...
    invoke-virtual {p1}, Lcsv;->b()F

    move-result v2

    const/4 v3, 0x0

    invoke-static {v1, v2, v3, v0}, Lcsv;->a(Landroid/animation/ValueAnimator;FFLandroid/animation/TimeInterpolator;)V

    iget-object v0, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->q:Landroid/animation/TimeInterpolator;

    invoke-virtual {p1, v3, v0}, Lcsv;->a(FLandroid/animation/TimeInterpolator;)V
    ...
    invoke-virtual {p1, v0, v1}, Lcsv;->b(FLandroid/animation/TimeInterpolator;)V
...
.method public final b(I)V
    ...
    iget-object v1, v0, Lcsv;->g:Lbhz;

    invoke-interface {v1}, Lbhz;->c()Lbhx;

    move-result-object v2

    iget-object v3, v0, Lcsv;->h:Lbhx;
    ...
    iput-object v3, v0, Lcsv;->g:Lbhz;

    invoke-interface {v1}, Lbhz;->c()Lbhx;

    move-result-object v3

    iput-object v3, v0, Lcsv;->h:Lbhx;

    iget-object v3, v0, Lcsv;->h:Lbhx;

    invoke-interface {v3}, Lbhx;->f()Llrt;

    move-result-object v3

    iget v3, v3, Llrt;->a:I

    iget-object v4, v0, Lcsv;->h:Lbhx;

    invoke-interface {v4}, Lbhx;->f()Llrt;

    move-result-object v4

    iget v4, v4, Llrt;->b:I

    iget-object v7, v0, Lcsv;->h:Lbhx;

    invoke-interface {v7}, Lbhx;->g()I

    move-result v7

    iget-object v8, v0, Lcsv;->a:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;

    invoke-virtual {v8}, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->getMeasuredWidth()I

    move-result v8

    iget-object v9, v0, Lcsv;->a:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;

    invoke-virtual {v9}, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->getMeasuredHeight()I

    move-result v9

    invoke-static {v3, v4, v7, v8, v9}, Lkbo;->a(IIIII)Landroid/graphics/Point;

    move-result-object v3

    iput-object v3, v0, Lcsv;->d:Landroid/graphics/Point;
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->k:Lcsl;

    invoke-virtual {v0, v6}, Lcsl;->a(Z)Z
    ...
    iget-object v1, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->k:Lcsl;

    invoke-virtual {v1}, Lcsl;->f()Z
    ...
    iget-object p1, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->k:Lcsl;
...
.method public final b(Lbhz;)V
    ...
    invoke-virtual {v2}, [Lcsv;->clone()Ljava/lang/Object;
    ...
    invoke-static {v3, v4}, Lcsz;->a(Ljava/util/List;Lbhz;)Lcta;
    ...
    iget-object v7, v3, Lcta;->a:Ljava/util/List;
    ...
    iget-object v8, v3, Lcta;->b:Ljava/util/List;
    ...
    invoke-virtual {p0, v7}, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->a(Lbhz;)Lcsv;
    ...
    :cond_3
    iget-object v7, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;
    ...
    iget-object v9, v8, Lcsv;->b:Landroid/view/View;
    ...
    invoke-virtual {v8, v7}, Lcsv;->b(F)V

    aget-object v7, v2, v6

    invoke-virtual {p0, v7}, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->a(Lcsv;)V
    ...
    :cond_5
    invoke-direct {p0, v2}, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->a([Lcsv;)V

    :goto_3
    if-ge v5, v7, :cond_6

    iget-object v1, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;
    ...
    invoke-virtual {v0, v2, v1}, Lcsv;->a(FLandroid/animation/TimeInterpolator;)V

    iget-object v1, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->q:Landroid/animation/TimeInterpolator;

    invoke-virtual {v0, v3, v1}, Lcsv;->b(FLandroid/animation/TimeInterpolator;)V

    new-instance v1, Lcsd;

    invoke-direct {v1, v0}, Lcsd;-><init>(Lcsv;)V
...
.method public final c(Lbhz;)V
    ...
    invoke-static {v1, v2}, Lcsz;->a(Ljava/util/List;Lbhz;)Lcta;
    ...
    iget-object v4, v1, Lcta;->a:Ljava/util/List;
    ...
    iget-object v7, v1, Lcta;->b:Ljava/util/List;
    ...
    :cond_5
    :goto_1
    invoke-virtual {p0, v4}, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->a(Lbhz;)Lcsv;
    ...
    iget-object v6, v5, Lcsv;->b:Landroid/view/View;
    ...
    invoke-virtual {v5, v4}, Lcsv;->b(F)V
    ...
    invoke-virtual {v4, v5}, Lcsv;->c(F)V
    ...
    invoke-virtual {v4, v5}, Lcsv;->a(F)V

    :goto_4
    aget-object v4, v0, v3

    invoke-virtual {p0, v4}, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->a(Lcsv;)V
...
.method public final d()V
    ...
    :cond_0
    iget-object v2, v1, Lcsv;->a:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->o:Ljwy;
...
.method public final g()V
    ...
    iget-object v2, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->k:Lcsl;

    invoke-virtual {v2}, Lcsl;->i()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Lcsl;->b:Landroid/animation/ValueAnimator;
    ...
    invoke-virtual {v2}, Lcsl;->h()Z

    move-result v3

    if-eqz v3, :cond_1

    iget-object v2, v2, Lcsl;->c:Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {v0, v2}, Ljwy;->setVisibility(I)V
    ...
    :cond_2
    invoke-virtual {v4, v2}, Lcsv;->a(I)V
...
.method public final l()V
    ...
    invoke-virtual {v0, v1}, Lcsl;->a(Z)Z

    iget-object v0, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->k:Lcsl;

    iget-object v0, v0, Lcsl;->a:Landroid/animation/ValueAnimator;
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object p2, p0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->o:Ljwy;
    ...
    invoke-virtual {p2, p3, p4, p5, v0}, Ljwy;->layout(IIII)V
...
.method protected final onMeasure(II)V
    ...
    invoke-virtual {v0, p1, p2}, Ljwy;->measure(II)V
    ...
    invoke-static {v5, v6}, Lpjn;->e(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_1

    :cond_3
    invoke-interface {v7}, Lbhx;->f()Llrt;
    ...
    invoke-static {v8, v9, v7, v0, v1}, Lkbo;->a(IIIII)Landroid/graphics/Point;

    move-result-object v7

    iput-object v7, v6, Lcsv;->d:Landroid/graphics/Point;
    ...
    iget-object v6, v6, Lcsv;->b:Landroid/view/View;
