...
.field private final o:Lcwg;

.field private final p:Landroid/graphics/PointF;

.field private final q:[I

.field private volatile r:Lkau;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p2, p0}, Lcwe;-><init>(Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;)V
    ...
    invoke-direct {p0, p1}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->a(Landroid/content/Context;)Lcwg;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->o:Lcwg;

    iget-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->o:Lcwg;

    invoke-interface {p1, p0}, Lcwg;->a(Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;)V

    iget-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->e:Lkbe;

    invoke-direct {p0, p1}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->a(Lkbe;)Lkbe;

    iget-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->f:Lkbe;

    invoke-direct {p0, p1}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->a(Lkbe;)Lkbe;

    iget-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->g:Lkbe;

    invoke-direct {p0, p1}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->a(Lkbe;)Lkbe;

    iget-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->h:Lkbe;

    invoke-direct {p0, p1}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->a(Lkbe;)Lkbe;

    iget-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->j:Lkbe;

    invoke-direct {p0, p1}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->a(Lkbe;)Lkbe;

    iget-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->k:Lkbe;

    invoke-direct {p0, p1}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->a(Lkbe;)Lkbe;

    iget-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->i:Lkbe;
...
.method constructor <init>(Landroid/content/Context;Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;Lcvz;Lcwb;Landroid/widget/TextView;Lkbe;Lkbe;Lkbe;Lkbe;Lkbe;Lkbe;Lkbe;)V
    .locals 2
    ...
    invoke-direct {v0, p0}, Lcwe;-><init>(Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;)V
    ...
    iput-object p3, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->b:Lcvz;

    iput-object p4, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->c:Lcwb;

    iput-object p5, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->d:Landroid/widget/TextView;

    invoke-direct {p0, p6}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->a(Lkbe;)Lkbe;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->e:Lkbe;

    invoke-direct {p0, p7}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->a(Lkbe;)Lkbe;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->f:Lkbe;

    invoke-direct {p0, p8}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->a(Lkbe;)Lkbe;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->g:Lkbe;

    invoke-direct {p0, p9}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->a(Lkbe;)Lkbe;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->h:Lkbe;

    invoke-direct {p0, p10}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->a(Lkbe;)Lkbe;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->j:Lkbe;

    invoke-direct {p0, p11}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->a(Lkbe;)Lkbe;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->k:Lkbe;

    invoke-direct {p0, p12}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->a(Lkbe;)Lkbe;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->i:Lkbe;

    return-void
.end method

.method private final a(Landroid/content/Context;)Lcwg;
    .locals 2

    new-instance v0, Lcwh;

    invoke-direct {v0, p1, p0}, Lcwh;-><init>(Landroid/content/Context;Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;)V

    new-instance p1, Lcvy;

    invoke-direct {p1}, Lcvy;-><init>()V

    invoke-static {v0}, Lpwe;->a(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcwh;

    iput-object v0, p1, Lcvy;->a:Lcwh;

    iget-object v0, p1, Lcvy;->a:Lcwh;
    ...
    iget-object p1, p1, Lcvy;->a:Lcwh;

    invoke-direct {v0, p1}, Lcvx;-><init>(Lcwh;)V

    return-object v0
.end method

.method private final a(Lkbe;)Lkbe;
    .locals 1
    ...
    invoke-interface {p1, v0}, Lkbe;->a(Landroid/animation/Animator$AnimatorListener;)V
...
.method private final f(Landroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    iget-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->r:Lkau;
...
.method private final g()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->c:Lcwb;

    const/4 v1, 0x0

    invoke-interface {v0, v1}, Lcwb;->b(F)V

    iget-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->b:Lcvz;

    invoke-interface {v0, v1}, Lcvz;->c(F)V
...
# virtual methods
.method public final a(Landroid/graphics/PointF;)Lkbc;
    .locals 1
    ...
    invoke-interface {p1}, Lkbe;->a()Lkbc;
...
.method public final a(Lnre;)Lkbc;
    .locals 3
...
.method public final a(Lnre;I)Lkbc;
    .locals 4
    ...
    :goto_0
    iget-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->i:Lkbe;

    new-instance v1, Lcwd;

    invoke-direct {v1, p0, p1, p2}, Lcwd;-><init>(Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;Lnre;I)V

    invoke-interface {v0, v1}, Lkbe;->a(Landroid/animation/Animator$AnimatorListener;)V
...
.method public final synthetic a(Ljava/lang/Object;)V
    ...
    iget-object v1, p1, Lgks;->a:Lijo;

    invoke-static {v1}, Ljava/lang/String;->valueOf(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v1

    iget-object v2, p1, Lgks;->b:Lijp;
    ...
    invoke-virtual {v3}, Lgkq;->b()Landroid/graphics/PointF;
...
.method public final b()Lkbc;
    ...
    sget-object v0, Lkbe;->a:Lkbc;

    return-object v0

    :cond_0
    iget-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->f:Lkbe;

    invoke-interface {v0}, Lkbe;->a()Lkbc;
...
.method public final b(Landroid/graphics/PointF;)Lkbc;
    .locals 1
    ...
    iget-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->l:Lkbe;
...
.method public final c()Lkbc;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->h:Lkbe;
...
.method public final d()Lkbc;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->m:Lkbe;
...
.method protected final onLayout(ZIIII)V
    ...
    invoke-static {p2}, Ljtj;->c(Landroid/content/Context;)I
    ...
    invoke-static {p3}, Ljtj;->b(Landroid/content/Context;)Z
    ...
    invoke-static {p2, p3, p4, p1}, Lkau;->a(IZII)Lkau;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorView;->r:Lkau;
