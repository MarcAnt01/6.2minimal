...
# virtual methods
.method public final a(Lmjb;Lpdg;)Lpeo;
    .locals 1

    new-instance v0, Lcom/google/android/apps/camera/photobooth/analysis/jni/AnalysisImage;

    invoke-direct {v0, p1}, Lcom/google/android/apps/camera/photobooth/analysis/jni/AnalysisImage;-><init>(Lmjb;)V

    invoke-virtual {p2}, Lpdg;->d()[B
    ...
    sget-object p2, Lpeo;->h:Lpeo;

    invoke-static {p2, p1}, Lowz;->a(Lowz;[B)Lowz;
