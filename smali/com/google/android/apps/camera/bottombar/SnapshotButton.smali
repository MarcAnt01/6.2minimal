...
.method static synthetic access$000(Lcom/google/android/apps/camera/bottombar/SnapshotButton;ZLjqz;)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lcom/google/android/apps/camera/bottombar/SnapshotButton;->runPressedStateAnimation(ZLjqz;)V
...
.method public setMode(Ljqv;Ljqz;)V
    ...
    invoke-virtual {p1, v0}, Ljqv;->equals(Ljava/lang/Object;)Z
    ...
    invoke-super {p0, p1, p2}, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->setMode(Ljqv;Ljqz;)V
...
.method wirePressedStateAnimationListener()V
    ...
    invoke-direct {v0, p0, v1}, Ljqz;-><init>(Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;Z)V

    new-instance v2, Lcom/google/android/apps/camera/bottombar/SnapshotButton$1;

    invoke-direct {v2, p0, v0}, Lcom/google/android/apps/camera/bottombar/SnapshotButton$1;-><init>(Lcom/google/android/apps/camera/bottombar/SnapshotButton;Ljqz;)V

    invoke-virtual {p0, v2}, Lcom/google/android/apps/camera/bottombar/SnapshotButton;->setListener(Ljsa;)V
