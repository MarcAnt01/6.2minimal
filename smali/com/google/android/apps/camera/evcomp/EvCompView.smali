...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p2, p1}, Lcnj;-><init>(Landroid/content/res/Resources;)V

    iput-object p2, p0, Lcom/google/android/apps/camera/evcomp/EvCompView;->a:Lcni;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lcni;)V
    .locals 1
...
.method protected final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/evcomp/EvCompView;->a:Lcni;

    if-eqz v0, :cond_4

    invoke-interface {v0, p1}, Lcni;->a(Landroid/graphics/Canvas;)V
    ...
    iget-object p1, p0, Lcom/google/android/apps/camera/evcomp/EvCompView;->a:Lcni;

    invoke-interface {p1}, Lcni;->b()V

    iget-object p1, p0, Lcom/google/android/apps/camera/evcomp/EvCompView;->a:Lcni;

    invoke-interface {p1}, Lcni;->c()V
    ...
    invoke-interface {p1, v0}, Lcni;->b(F)V
    ...
    invoke-interface {p1, v0, v1, v2}, Lcni;->a(FFF)V
...
.method protected final onLayout(ZIIII)V
    ...
    invoke-static {p1}, Ljtj;->c(Landroid/content/Context;)I
    ...
    invoke-static {p1, v0, v1, v2}, Lkau;->a(IZII)Lkau;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/camera/evcomp/EvCompView;->f:Lkau;

    iget-object p1, p0, Lcom/google/android/apps/camera/evcomp/EvCompView;->a:Lcni;

    iget-object v0, p0, Lcom/google/android/apps/camera/evcomp/EvCompView;->f:Lkau;

    invoke-interface {p1, v0}, Lcni;->a(Lkau;)V
    ...
    invoke-interface/range {v0 .. v5}, Lcni;->a(IIIII)Landroid/graphics/Rect;
