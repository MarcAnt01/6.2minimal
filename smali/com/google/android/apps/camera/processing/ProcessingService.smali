...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lifo;-><init>(Lcom/google/android/apps/camera/processing/ProcessingService;)V

    iput-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->u:Lifo;
...
.method private final b()V
    ...
    invoke-interface {v0, p0}, Lifn;->a(Lcom/google/android/apps/camera/processing/ProcessingService;)V

    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->q:Lmhy;
...
.method public final a()V
    ...
    invoke-direct {v2, p0}, Lifm;-><init>(Lcom/google/android/apps/camera/processing/ProcessingService;)V
...
.method public final onCreate()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->o:Llsl;
    ...
    invoke-direct {v0, v3, v4, v5, v6}, Lifv;-><init>(Landroid/os/PowerManager;Ljava/lang/String;J)V

    iput-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->d:Lifv;

    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->d:Lifv;

    const-string v3, "onCreate"

    invoke-virtual {v0, v3}, Lifv;->a(Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->u:Lifo;
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->r:Lcfp;

    invoke-interface {v0}, Lcfp;->c()Z
...
.method public final onDestroy()V
    ...
    iget-object v1, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->u:Lifo;
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->l:Lifp;

    iget-object v1, v0, Lifp;->b:Ljava/lang/Object;
    ...
    iget-object v2, v0, Lifp;->a:Llsg;

    const-string v3, "Service destroyed, restarting? "

    iget-boolean v5, v0, Lifp;->d:Z
    ...
    iget-boolean v2, v0, Lifp;->d:Z

    if-eqz v2, :cond_9

    iput-boolean v4, v0, Lifp;->d:Z

    invoke-virtual {v0}, Lifp;->d()V

    goto :goto_8

    :cond_9
    iget-object v0, v0, Lifp;->c:Ljava/util/LinkedList;
...
.method public final onStartCommand(Landroid/content/Intent;II)I
    ...
    iget-object p1, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->s:Lfrk;

    new-instance p2, Lfrl;

    invoke-direct {p2, p1}, Lfrl;-><init>(Lfrk;)V

    new-instance p1, Llij;

    new-instance p3, Lifk;

    invoke-direct {p3, p0, p2}, Lifk;-><init>(Lcom/google/android/apps/camera/processing/ProcessingService;Lfrl;)V

    const/16 p2, 0x9

    const-string v0, "CameraProcessingThread"

    invoke-direct {p1, p2, p3, v0}, Llij;-><init>(ILjava/lang/Runnable;Ljava/lang/String;)V
