...
.field private c:Llcd;

.field private d:Landroid/app/PendingIntent;

.field private e:Llca;

.field private f:Llbp;
...
.method public constructor <init>(ILcom/google/android/gms/location/internal/zzo;Landroid/os/IBinder;Landroid/app/PendingIntent;Landroid/os/IBinder;Landroid/os/IBinder;)V
    ...
    invoke-direct {p2, p3}, Llcf;-><init>(Landroid/os/IBinder;)V

    :goto_1
    iput-object p2, p0, Lcom/google/android/gms/location/internal/zzq;->c:Llcd;
    ...
    invoke-direct {p2, p5}, Llcc;-><init>(Landroid/os/IBinder;)V

    :goto_3
    iput-object p2, p0, Lcom/google/android/gms/location/internal/zzq;->e:Llca;
    ...
    invoke-direct {p1, p6}, Llbr;-><init>(Landroid/os/IBinder;)V

    :goto_5
    iput-object p1, p0, Lcom/google/android/gms/location/internal/zzq;->f:Llbp;

    return-void
.end method

.method public static a(Llcd;Llbp;)Lcom/google/android/gms/location/internal/zzq;
    .locals 8

    new-instance v7, Lcom/google/android/gms/location/internal/zzq;

    invoke-interface {p0}, Llcd;->asBinder()Landroid/os/IBinder;

    move-result-object v3

    if-eqz p1, :cond_0

    invoke-interface {p1}, Llbp;->asBinder()Landroid/os/IBinder;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/location/internal/zzq;->c:Llcd;

    const/4 v2, 0x0

    if-eqz v1, :cond_0

    invoke-interface {v1}, Llcd;->asBinder()Landroid/os/IBinder;
    ...
    invoke-static {p1, v3, v1}, Lkrl;->a(Landroid/os/Parcel;ILandroid/os/IBinder;)V

    const/4 v1, 0x4

    iget-object v3, p0, Lcom/google/android/gms/location/internal/zzq;->d:Landroid/app/PendingIntent;

    invoke-static {p1, v1, v3, p2}, Lkrl;->a(Landroid/os/Parcel;ILandroid/os/Parcelable;I)V

    iget-object p2, p0, Lcom/google/android/gms/location/internal/zzq;->e:Llca;

    if-eqz p2, :cond_1

    invoke-interface {p2}, Llca;->asBinder()Landroid/os/IBinder;
    ...
    invoke-static {p1, v1, p2}, Lkrl;->a(Landroid/os/Parcel;ILandroid/os/IBinder;)V

    iget-object p2, p0, Lcom/google/android/gms/location/internal/zzq;->f:Llbp;

    if-eqz p2, :cond_2

    invoke-interface {p2}, Llbp;->asBinder()Landroid/os/IBinder;
    ...
    invoke-static {p1, p2, v2}, Lkrl;->a(Landroid/os/Parcel;ILandroid/os/IBinder;)V
