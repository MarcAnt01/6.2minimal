...
.method protected final synthetic a(Ljava/lang/Object;)Ljava/util/List;
    ...
    :cond_0
    iget-object p1, p1, Lncq;->b:Ljava/util/List;
    ...
    iget-object v3, v1, Lour;->d:Ljava/lang/String;
    ...
    :goto_1
    invoke-static {v4}, Lpkb;->a(Lpuw;)Lpri;
    ...
    invoke-virtual {v5, v6}, Lpri;->a(Ljava/text/CharacterIterator;)V
    ...
    :goto_2
    invoke-static {v4}, Lpnz;->a(Lpuw;)I

    move-result v4

    invoke-static {v4, v5, v3}, Lpkb;->a(ILpri;Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    iget-object v1, v1, Lour;->a:[Louz;

    invoke-static {v0, v3, v1}, Lndt;->a(Ljava/util/List;Lnmd;[Louz;)V
