...
.method public constructor <init>(Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;)V
    ...
    iput-object p1, p0, Lcsf;->e:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
...
.method public final a()V
    ...
    iget-object v0, p0, Lcsf;->e:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    iget-object v3, v0, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    iget-object v2, v0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;
    ...
    :cond_6
    iget-object v3, v0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->k:Lcsl;

    invoke-virtual {v3}, Lcsl;->f()Z
    ...
    invoke-virtual {v0, v2, v3, v1}, Lcsl;->a(IIZ)V
    ...
    :cond_a
    :goto_5
    iget-object v0, v0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->y:Lcsu;

    if-eqz v0, :cond_b

    iget-object v1, v2, Lcsv;->h:Lbhx;

    invoke-interface {v0, v1}, Lcsu;->a(Lbhx;)V
...
.method public final a(FF)Z
    ...
    iget-object p2, p0, Lcsf;->e:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;

    iget-object p2, p2, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->k:Lcsl;

    invoke-virtual {p2}, Lcsl;->h()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object p2, p2, Lcsl;->c:Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {p2, p1}, Lcsl;->a(Z)Z
...
.method public final a(FFF)Z
    ...
    iget-object v1, v0, Lcsf;->e:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    iget-object v1, v1, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->k:Lcsl;

    :goto_5
    if-ge v3, v9, :cond_c

    iget-object v2, v1, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    :cond_b
    invoke-virtual {v2, v8}, Lcsv;->a(I)V
    ...
    iget-object v4, v1, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    :cond_10
    invoke-virtual {v4, v8}, Lcsv;->a(I)V
    ...
    iget-object v2, v0, Lcsf;->e:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    invoke-virtual/range {v10 .. v15}, Lcsv;->a(FFFII)V
    ...
    iget-object v2, v1, Lcsv;->h:Lbhx;

    iget-object v1, v1, Lcsv;->b:Landroid/view/View;
...
.method public final a(FFFFFFIJ)Z
    ...
    iget-object v2, v1, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;
    ...
    iget-object v6, v1, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->k:Lcsl;

    iget-object v6, v6, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;

    iget-object v6, v6, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->o:Ljwy;

    invoke-virtual {v6}, Ljwy;->a()V

    iget-object v1, v1, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->o:Ljwy;

    const/16 v6, 0x8

    invoke-virtual {v1, v6}, Ljwy;->setVisibility(I)V
    ...
    invoke-virtual {v1}, Lcsv;->b()F

    move-result v2

    iget-object v3, v0, Lcsf;->e:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;

    iget v3, v3, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->j:F

    invoke-virtual {v1}, Lcsv;->a()F

    move-result v4

    iget-object v6, v0, Lcsf;->e:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    invoke-virtual/range {p1 .. p7}, Lcsv;->a(FFFFII)V
    ...
    invoke-virtual {v1, v5}, Lcsl;->a(Z)Z
    ...
    invoke-virtual {v1, v2}, Lcsl;->a(F)V
    ...
    :cond_8
    iget-object v3, v3, Lcsv;->b:Landroid/view/View;
    ...
    invoke-virtual {v1, v7}, Lcsv;->a(F)V
    ...
    iget-object v7, v1, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;
...
.method public final b(FF)Z
    ...
    iget-object p1, p0, Lcsf;->e:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;

    iget-object p2, p1, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;
    ...
    iget-object v2, p0, Lcsf;->e:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    iget-object v3, v2, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;

    aget-object v3, v3, p1

    invoke-virtual {v2, v3}, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->a(Lcsv;)V
    ...
    iget-object v2, p1, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;
    ...
    :cond_6
    iget-object p2, p1, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->k:Lcsl;

    invoke-virtual {p2}, Lcsl;->f()Z
    ...
    invoke-virtual {p1, p2, v0, v1}, Lcsl;->a(IIZ)V
    ...
    :cond_a
    :goto_4
    iget-object p1, p1, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->y:Lcsu;

    if-eqz p1, :cond_b

    iget-object p2, v0, Lcsv;->h:Lbhx;

    invoke-interface {p1, p2}, Lcsu;->a(Lbhx;)V
...
.method public final c(FF)Z
    ...
    iget-object v0, v1, Lcsv;->c:Landroid/graphics/RectF;
    ...
    iget-object p1, p1, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->d:Lctv;

    invoke-virtual {p1}, Lctv;->q()V
...
.method public final d(FF)Z
    ...
    invoke-virtual {v0, v9}, Lcsl;->a(Z)Z
    ...
    iget-object v7, v0, Lcsl;->b:Landroid/animation/ValueAnimator;
    ...
    invoke-virtual {v0, v9}, Lcsl;->b(Z)F

    move-result v7

    iget-object v8, v0, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    iput-object v3, v0, Lcsl;->b:Landroid/animation/ValueAnimator;

    iget-object v3, v0, Lcsl;->b:Landroid/animation/ValueAnimator;
    ...
    iget-object v9, v0, Lcsl;->b:Landroid/animation/ValueAnimator;
    ...
    invoke-direct/range {v3 .. v8}, Lcsp;-><init>(Lcsl;FLcsv;FF)V
    ...
    invoke-direct {v4, v0, v1, p1, p2}, Lcsq;-><init>(Lcsl;Lcsv;FF)V

    invoke-virtual {v3, v4}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget-object p1, v0, Lcsl;->b:Landroid/animation/ValueAnimator;

    invoke-virtual {p1}, Landroid/animation/ValueAnimator;->start()V

    iget-object p1, p0, Lcsf;->e:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;

    iget-object p1, p1, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;
    ...
    iget-object p2, p1, Lcsv;->h:Lbhx;

    iget-object p1, p1, Lcsv;->b:Landroid/view/View;
    ...
    iget-object v4, v0, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    iget-object v2, v0, Lcsl;->b:Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v3, v0, v1, p1, p2}, Lcsq;-><init>(Lcsl;Lcsv;FF)V
...
.method public final f(FF)Z
    ...
    iget-object v2, v2, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->k:Lcsl;

    iget-object v3, v2, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    invoke-virtual {v3}, Lcsv;->b()F

    move-result v8

    iget-object v9, v2, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;

    iget v9, v9, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->j:F

    mul-float v8, v8, v9

    invoke-virtual {v3}, Lcsv;->a()F

    move-result v9

    iget-object v10, v2, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    invoke-direct {v5, v2, v1, v4, v3}, Lcsr;-><init>(Lcsl;Landroid/animation/ValueAnimator;Landroid/animation/ValueAnimator;Lcsv;)V
    ...
    iput-object v3, v2, Lcsl;->c:Landroid/animation/AnimatorSet;

    iget-object v3, v2, Lcsl;->c:Landroid/animation/AnimatorSet;
    ...
    iget-object v1, v2, Lcsl;->c:Landroid/animation/AnimatorSet;
    ...
    invoke-direct {v3, v2}, Lcst;-><init>(Lcsl;)V
    ...
    iget-object v7, v0, Lcsf;->e:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;

    iget v9, v7, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->l:I

    if-gt v9, v2, :cond_3

    iget-object v2, v7, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;

    aget-object v2, v2, v6

    if-eqz v2, :cond_2

    iget-object v7, v7, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->k:Lcsl;

    invoke-virtual {v2}, Lcsv;->c()I

    move-result v2

    invoke-virtual {v7, v2, v3, v6}, Lcsl;->a(IIZ)V
    ...
    :cond_3
    iget-object v1, v7, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->k:Lcsl;

    invoke-virtual {v1, v2, v3, v6}, Lcsl;->a(IIZ)V
    ...
    invoke-virtual {v7, v5}, Lcsl;->a(Z)Z
    ...
    invoke-virtual {v2, v5}, Lcsl;->a(Z)Z
    ...
    iget-object v5, v3, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;
    ...
    iget-object v7, v2, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    iget-object v1, v2, Lcsg;->a:Landroid/os/Handler;

    if-eqz v1, :cond_a

    iget-object v3, v2, Lcsg;->b:Lcsk;

    if-eqz v3, :cond_a

    iget-object v3, v2, Lcsg;->e:Ljava/lang/Runnable;

    invoke-virtual {v1, v3}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object v1, v2, Lcsg;->a:Landroid/os/Handler;

    iget-object v2, v2, Lcsg;->e:Ljava/lang/Runnable;
...
.method public final g(FF)Z
    ...
    iget-object v0, p1, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->k:Lcsl;

    iget-object v0, v0, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;

    iget-object v0, v0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->o:Ljwy;

    invoke-virtual {v0}, Ljwy;->a()V
    ...
    iput-object p1, p0, Lcsf;->d:Lcsv;

    iget-object p1, p0, Lcsf;->d:Lcsv;

    const/high16 v0, 0x3f800000    # 1.0f

    if-eqz p1, :cond_1

    iget-boolean v1, p1, Lcsv;->j:Z

    if-nez v1, :cond_1

    iput-boolean p2, p1, Lcsv;->j:Z
    ...
    invoke-virtual {p1, p2}, Lcsl;->b(Z)F
