...
.method constructor <init>(Ljava/lang/String;Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p3, p0, Ljlh;->d:Landroid/graphics/drawable/Drawable;

    const/4 p1, 0x0

    iput-object p1, p0, Ljlh;->g:Landroid/widget/PopupWindow;

    const/4 p2, 0x0

    iput-boolean p2, p0, Ljlh;->e:Z

    iput-object p1, p0, Ljlh;->h:Ljava/lang/Runnable;

    iput-object p1, p0, Ljlh;->i:Ljava/lang/Runnable;

    iput-object p1, p0, Ljlh;->j:Ljava/lang/Runnable;

    iput-object p1, p0, Ljlh;->a:Ljava/lang/Runnable;
...
.method private final declared-synchronized a(Landroid/content/Context;IILandroid/graphics/Rect;)Landroid/widget/PopupWindow;
    ...
    iget-object v4, p0, Ljlh;->d:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v0, p0, v5}, Ljli;-><init>(Ljlh;Landroid/os/Handler;)V
    ...
    :cond_0
    iget-object v0, p0, Ljlh;->a:Ljava/lang/Runnable;
    ...
    invoke-direct {v0, p0, v5}, Ljlj;-><init>(Ljlh;Landroid/os/Handler;)V

    invoke-virtual {v9, v0}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    :cond_1
    iput-object p1, p0, Ljlh;->f:Landroid/view/View;

    iget-object p1, p0, Ljlh;->f:Landroid/view/View;
    ...
    iput-boolean v2, p0, Ljlh;->e:Z

    :cond_2
    new-instance p1, Landroid/widget/PopupWindow;

    iget-object p4, p0, Ljlh;->f:Landroid/view/View;
...
.method private final declared-synchronized a(Landroid/view/View;IIIILandroid/graphics/Rect;)V
    ...
    invoke-direct {p0, v0, p4, p5, p6}, Ljlh;->a(Landroid/content/Context;IILandroid/graphics/Rect;)Landroid/widget/PopupWindow;
    ...
    iget-object p1, p0, Ljlh;->j:Ljava/lang/Runnable;
    ...
    :cond_0
    iput-object p4, p0, Ljlh;->g:Landroid/widget/PopupWindow;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
# virtual methods
.method public final declared-synchronized a(Ljava/lang/Runnable;)Ljlf;
    .locals 0
...
.method public final declared-synchronized a()V
    ...
    :try_start_0
    invoke-virtual {p0, v0}, Ljlh;->a(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized a(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-direct/range {v0 .. v6}, Ljlh;->a(Landroid/view/View;IIIILandroid/graphics/Rect;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method final declared-synchronized a(Z)V
    ...
    :try_start_0
    iget-object v0, p0, Ljlh;->g:Landroid/widget/PopupWindow;
    ...
    iget-object p1, p0, Ljlh;->h:Ljava/lang/Runnable;
    ...
    :cond_0
    iget-object p1, p0, Ljlh;->i:Ljava/lang/Runnable;
...
.method public final b(Ljava/lang/Runnable;)Ljlf;
    .locals 0
...
.method public final declared-synchronized c(Ljava/lang/Runnable;)Ljlf;
    .locals 0
...
.method public final declared-synchronized d(Ljava/lang/Runnable;)Ljlf;
    .locals 0
