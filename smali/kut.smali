...
# instance fields
.field private final synthetic a:Lkus;


# direct methods
.method constructor <init>(Lkus;)V
    .locals 0
...
.method public final a(Lcom/google/android/gms/googlehelp/GoogleHelp;)V
    ...
    iget-object v2, p0, Lkut;->a:Lkus;

    iget-object v3, v2, Lkus;->b:Lkul;

    if-nez v3, :cond_0

    iget-object v3, v2, Lkus;->d:Lkul;
    ...
    :cond_0
    invoke-static {v2, p1, v0, v1}, Lkus;->a(Lkus;Lcom/google/android/gms/googlehelp/GoogleHelp;J)V
    ...
    iget-object v3, p0, Lkut;->a:Lkus;

    iget-object v3, v3, Lkus;->c:Landroid/app/Activity;
    ...
    iget-object v2, v2, Lkus;->a:Landroid/content/Intent;
    ...
    iget-object p1, p0, Lkut;->a:Lkus;

    iget-object v0, p1, Lkus;->c:Landroid/app/Activity;

    iget-object p1, p1, Lkus;->a:Landroid/content/Intent;
    ...
    invoke-virtual {p1, v0}, Lkus;->a(Lkqq;)V
