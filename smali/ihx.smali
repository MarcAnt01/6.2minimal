...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lihx;->b:Ljava/lang/String;

    return-void
.end method

.method constructor <init>(Liha;Ljava/util/concurrent/Executor;Ligz;ILisf;Llrt;ILlsl;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lihy;-><init>(Liha;Ljava/util/concurrent/Executor;Ligz;ILisf;)V

    iput-object p6, p0, Lihx;->a:Llrt;

    iput p7, p0, Lihx;->j:I

    iput-object p8, p0, Lihx;->i:Llsl;
...
.method protected static a(Liha;)Liia;
    .locals 3

    new-instance v0, Liia;

    iget-object v1, p0, Liha;->b:Llrp;

    iget-object v2, p0, Liha;->a:Lmjb;

    invoke-interface {v2}, Lmjb;->c()I

    move-result v2

    iget-object p0, p0, Liha;->a:Lmjb;

    invoke-interface {p0}, Lmjb;->d()I

    move-result p0

    invoke-direct {v0, v1, v2, p0}, Liia;-><init>(Llrp;II)V

    return-object v0
.end method

.method private final a(Lmjb;Landroid/graphics/Rect;IZ)[I
    .locals 35

    move-object/from16 v0, p0

    invoke-static/range {p1 .. p2}, Lihx;->a(Lmjb;Landroid/graphics/Rect;)Landroid/graphics/Rect;

    move-result-object v1

    invoke-interface/range {p1 .. p1}, Lmjb;->e()Ljava/util/List;
    ...
    invoke-interface {v5}, Lmjc;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    :cond_0
    invoke-static {v3, v4}, Lihx;->a(II)I
    ...
    invoke-virtual {v0, v1}, Lihx;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3}, Lihx;->a(Ljava/lang/String;)V
    ...
    invoke-interface {v3}, Lmjc;->getRowStride()I
    ...
    invoke-static/range {v1 .. v8}, Lihx;->a(IIIIIIII)I
...
# virtual methods
.method protected final a(Liha;I)Liia;
    .locals 3
    ...
    invoke-static {v0, v1}, Lihx;->a(Lmjb;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-static {v1, v0}, Lihx;->a(II)I
    ...
    iget-object p1, p1, Liha;->b:Llrp;

    invoke-direct {p2, p1, v1, v0}, Liia;-><init>(Llrp;II)V

    return-object p2
.end method

.method public final a(Liia;[II)V
    .locals 3

    new-instance v0, Liib;

    iget-wide v1, p0, Lihx;->e:J

    invoke-direct {v0, v1, v2, p1, p3}, Liib;-><init>(JLiia;I)V

    iget-object p1, p0, Lihx;->c:Ligz;
    ...
    invoke-direct {p3, p2}, Liic;-><init>([I)V

    invoke-interface {p1, v0, p3}, Ligr;->a(Liib;Liic;)V
...
.method public a(Ljava/lang/String;)V
    ...
    sget-object v0, Lihx;->b:Ljava/lang/String;
...
.method protected final a(Lmjb;Landroid/graphics/Rect;I)[I
    .locals 40
    ...
    invoke-direct {v0, v1, v2, v9, v12}, Lihx;->a(Lmjb;Landroid/graphics/Rect;IZ)[I
    ...
    invoke-direct {v0, v1, v2, v9, v14}, Lihx;->a(Lmjb;Landroid/graphics/Rect;IZ)[I
    ...
    invoke-interface/range {v19 .. v19}, Lmjc;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface/range {v19 .. v19}, Lmjc;->getRowStride()I
    ...
    invoke-interface/range {v20 .. v20}, Lmjc;->getRowStride()I
    ...
    invoke-interface/range {v21 .. v21}, Lmjc;->getRowStride()I
    ...
    invoke-interface/range {v22 .. v22}, Lmjc;->getPixelStride()I
    ...
    invoke-interface/range {v23 .. v23}, Lmjc;->getPixelStride()I
    ...
    invoke-interface/range {v24 .. v24}, Lmjc;->getPixelStride()I
    ...
    invoke-virtual {v0, v12}, Lihx;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v4}, Lihx;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v0}, Lihx;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v1}, Lihx;->a(Ljava/lang/String;)V
    ...
    invoke-interface/range {p1 .. p1}, Lmjb;->c()I

    move-result v0

    div-int v0, v0, p3

    invoke-interface/range {p1 .. p1}, Lmjb;->d()I

    move-result v1

    div-int v1, v1, p3

    invoke-static {v0, v1}, Lihx;->a(II)I
...
.method public run()V
    ...
    iget-object v0, p0, Lihx;->i:Llsl;

    sget-object v1, Lihx;->b:Ljava/lang/String;

    invoke-interface {v0, v1}, Llsl;->a(Ljava/lang/String;)V

    iget-object v0, p0, Lihx;->f:Liha;
    ...
    invoke-static {v1, v2}, Lihx;->a(Lmjb;Landroid/graphics/Rect;)Landroid/graphics/Rect;

    move-result-object v1

    invoke-static {v0}, Lihx;->a(Liha;)Liia;
    ...
    invoke-static {v2, v3}, Lihq;->a(II)Z
    ...
    :goto_1
    invoke-virtual {p0, v0, v4}, Lihx;->a(Liha;I)Liia;

    move-result-object v2

    :try_start_0
    iget-wide v6, p0, Lihx;->e:J

    invoke-virtual {p0, v6, v7, v2, v5}, Lihx;->a(JLiia;I)V
    ...
    invoke-virtual {p0, v3}, Lihx;->a(Ljava/lang/String;)V

    iget-object v3, v0, Liha;->a:Lmjb;

    invoke-virtual {p0, v3, v1, v4}, Lihx;->a(Lmjb;Landroid/graphics/Rect;I)[I

    move-result-object v1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v3, p0, Lihx;->c:Ligz;

    iget-object v0, v0, Liha;->a:Lmjb;

    iget-object v4, p0, Lihx;->d:Ljava/util/concurrent/Executor;

    invoke-interface {v3, v0, v4}, Ligz;->a(Lmjb;Ljava/util/concurrent/Executor;)V

    invoke-virtual {p0, v2, v1, v5}, Lihx;->a(Liia;[II)V
