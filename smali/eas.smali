...
# direct methods
.method public constructor <init>(Leap;Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;)V
    .locals 0

    iput-object p1, p0, Leas;->b:Leap;

    iput-object p2, p0, Leas;->a:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;
...
.method public final onPreDraw()Z
    ...
    iget-object v0, p0, Leas;->b:Leap;

    iget-object v1, p0, Leas;->a:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;

    iget-object v2, v0, Leap;->b:Ljava/util/List;

    iget-object v3, v0, Leap;->l:Landroid/support/v4/view/ViewPager;
    ...
    iget-object v3, v0, Leap;->k:Ljava/util/Map;
    ...
    invoke-static {v2}, Leap;->b(Landroid/view/View;)V

    invoke-virtual {v0, v1, v2}, Leap;->a(Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;Lpvh;)Lebb;

    move-result-object v3

    iput-object v3, v0, Leap;->g:Lebb;

    new-instance v4, Landroid/animation/AnimatorSet;

    invoke-direct {v4}, Landroid/animation/AnimatorSet;-><init>()V

    iput-object v4, v0, Leap;->d:Landroid/animation/Animator;
    ...
    invoke-direct {v7, v2, v3}, Lean;-><init>(Lpvh;Lebb;)V
    ...
    iget-object v7, v0, Leap;->f:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v7, v0, Leap;->i:Landroid/view/View;
    ...
    invoke-direct {v3, v0, v1, v2}, Leat;-><init>(Leap;Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;Lpvh;)V
    ...
    iget-object v0, v0, Leap;->l:Landroid/support/v4/view/ViewPager;
