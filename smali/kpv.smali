...
# static fields
.field public static final a:Lkpv;
...
.method public static a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p0, p1, v0}, Lkpx;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    new-instance v1, Lkse;

    invoke-direct {v1, v0, p0, p2}, Lkse;-><init>(Landroid/content/Intent;Landroid/app/Activity;I)V
    ...
    :cond_1
    invoke-static {p0, p1}, Lksd;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p0, p1}, Lksd;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :goto_1
    invoke-static {p0, p1}, Lksd;->a(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Llau;)Llat;
    .locals 2
    ...
    invoke-direct {v1, p1}, Llat;-><init>(Llau;)V

    invoke-virtual {p0, v1, v0}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    iput-object p0, v1, Llat;->a:Landroid/content/Context;

    const-string v0, "com.google.android.gms"

    invoke-static {p0, v0}, Lkpz;->a(Landroid/content/Context;Ljava/lang/String;)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-virtual {p1}, Llau;->a()V
...
.method public final a(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    invoke-direct {p2, p0, p1}, Lkpw;-><init>(Lkpv;Landroid/content/Context;)V
    ...
    invoke-static {p1, p2}, Lksd;->b(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v1

    invoke-static {p1, p2}, Lksd;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_2
    sget-object p2, Lkpz;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final b(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    invoke-static {p1, p2, p3, p4}, Lkpv;->a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    iput-object p2, v2, Lkqb;->mDialog:Landroid/app/Dialog;

    if-eqz p4, :cond_0

    iput-object p4, v2, Lkqb;->a:Landroid/content/DialogInterface$OnCancelListener;
    ...
    iput-object p2, v2, Lkpu;->a:Landroid/app/Dialog;

    if-eqz p4, :cond_2

    iput-object p4, v2, Lkpu;->b:Landroid/content/DialogInterface$OnCancelListener;
