...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfuk;->a:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Lcgc;Llji;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lfuk;->c:Llji;
...
# virtual methods
.method public final a(Lfuj;Ljava/lang/String;)Z
    .locals 10
    ...
    :cond_1
    :goto_0
    sget-object v6, Lfuk;->a:Ljava/lang/String;
    ...
    :goto_1
    invoke-static {v6, v7}, Lpjn;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_4
    iput-object v2, p1, Lfuj;->b:Ljava/lang/String;
    ...
    :cond_5
    sget-object p1, Lfuk;->a:Ljava/lang/String;
    ...
    :try_start_2
    iget-boolean p2, p0, Lfuk;->b:Z

    if-eqz p2, :cond_8

    iget-object p2, p0, Lfuk;->c:Llji;

    new-instance v2, Lful;

    invoke-direct {v2, p1}, Lful;-><init>(Ljava/lang/RuntimeException;)V

    invoke-virtual {p2, v2}, Llji;->execute(Ljava/lang/Runnable;)V

    goto :goto_7

    :cond_8
    sget-object p2, Lfuk;->a:Ljava/lang/String;

    const-string v2, "VideoRotationMetadataLoader.loadRotationMetadata() failed!"

    invoke-static {p2, v2, p1}, Lpjn;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_2
