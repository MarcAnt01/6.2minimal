...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljgx;->m:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Lbhi;Lipi;Lipe;)V
    .locals 2
    ...
    iput-object v0, p0, Ljgx;->a:Ljava/util/concurrent/locks/Lock;

    new-instance v0, Landroid/os/Handler;

    invoke-direct {v0}, Landroid/os/Handler;-><init>()V

    iput-object v0, p0, Ljgx;->o:Landroid/os/Handler;
    ...
    iput-object v1, p0, Ljgx;->h:Ljava/lang/String;

    invoke-static {v0}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Ljgx;->k:Ljava/lang/Boolean;

    iput-object v0, p0, Ljgx;->l:Ljava/lang/Boolean;

    new-instance v0, Ljgy;

    invoke-direct {v0, p0}, Ljgy;-><init>(Ljgx;)V

    iput-object v0, p0, Ljgx;->s:Ljava/lang/Runnable;
...
.method private static a(Landroid/graphics/Bitmap;Lzt;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, v0}, Ljgx;->a(Lzt;Ljava/lang/String;)I

    move-result v0

    const-string v1, "CroppedAreaImageHeightPixels"

    invoke-static {p1, v1}, Ljgx;->a(Lzt;Ljava/lang/String;)I

    move-result v1

    const-string v2, "FullPanoWidthPixels"

    invoke-static {p1, v2}, Ljgx;->a(Lzt;Ljava/lang/String;)I

    move-result v2

    const-string v3, "FullPanoHeightPixels"

    invoke-static {p1, v3}, Ljgx;->a(Lzt;Ljava/lang/String;)I

    move-result v3

    const-string v4, "CroppedAreaLeftPixels"

    invoke-static {p1, v4}, Ljgx;->a(Lzt;Ljava/lang/String;)I

    move-result v4

    const-string v5, "CroppedAreaTopPixels"

    invoke-static {p1, v5}, Ljgx;->a(Lzt;Ljava/lang/String;)I
    ...
    invoke-static {v2, v3}, Ljgx;->a(II)Landroid/graphics/Bitmap;
...
.method private final a(Landroid/net/Uri;Z)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1}, Ljgx;->a(Landroid/net/Uri;)Ljava/io/InputStream;

    move-result-object v0

    if-nez v0, :cond_0

    sget-object v1, Ljgx;->m:Ljava/lang/String;

    const-string v2, "Could not create input stream for image."

    invoke-static {v1, v2}, Lpjn;->b(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0}, Ljgx;->dismiss()V
    ...
    :try_start_1
    invoke-static {v0}, Lfuo;->a(Ljava/io/InputStream;)Lzt;

    move-result-object p1
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    invoke-static {v0}, Ljgx;->a(Ljava/io/InputStream;)V
    ...
    :goto_0
    invoke-static {v1, p1, p2}, Ljgx;->a(Landroid/graphics/Bitmap;Lzt;I)Landroid/graphics/Bitmap;
...
.method private final a(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    sget-object v0, Ljgx;->m:Ljava/lang/String;
...
.method private static a([B)[B
    ...
    invoke-static {v0, v2, p0}, Lpjn;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method final a()Ljhf;
    ...
    iget-object v0, p0, Ljgx;->a:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v0}, Ljava/util/concurrent/locks/Lock;->lock()V

    :try_start_0
    iget-object v0, p0, Ljgx;->j:Landroid/graphics/Bitmap;

    invoke-virtual {v0}, Landroid/graphics/Bitmap;->recycle()V

    const/4 v0, 0x0

    iput-object v0, p0, Ljgx;->j:Landroid/graphics/Bitmap;

    iget-object v1, p0, Ljgx;->i:Landroid/graphics/Bitmap;

    invoke-virtual {v1}, Landroid/graphics/Bitmap;->recycle()V

    iput-object v0, p0, Ljgx;->i:Landroid/graphics/Bitmap;
    :try_end_0
    ...
    iget-object v0, p0, Ljgx;->p:Landroid/net/Uri;

    const/4 v1, 0x0

    invoke-direct {p0, v0, v1}, Ljgx;->a(Landroid/net/Uri;Z)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v1}, Ljgx;->a(II)Landroid/graphics/Bitmap;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Ljgx;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
    ...
    invoke-direct {v2, v0, v1}, Ljhf;-><init>([BI)V
    ...
    iget-object v1, p0, Ljgx;->a:Ljava/util/concurrent/locks/Lock;
...
.method public final a(I)V
    ...
    :cond_0
    iget-object p1, p0, Ljgx;->j:Landroid/graphics/Bitmap;
    ...
    iput-object p1, p0, Ljgx;->j:Landroid/graphics/Bitmap;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :cond_2
    iget-object p1, p0, Ljgx;->a:Ljava/util/concurrent/locks/Lock;
...
.method final a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
    ...
    iget-object v3, v0, Ljhh;->c:Labg;

    iget-object v4, v0, Ljhh;->b:Landroid/support/v8/renderscript/RenderScript;
    ...
    iget-object v1, v0, Ljhh;->c:Labg;

    invoke-virtual {v1, v2}, Labg;->a(F)V

    iget-object v1, v0, Ljhh;->b:Landroid/support/v8/renderscript/RenderScript;
    ...
    sget-object p2, Ljhh;->a:Ljava/lang/String;
...
.method final b()V
    ...
    iget-object v0, p0, Ljgx;->o:Landroid/os/Handler;

    iget-object v1, p0, Ljgx;->s:Ljava/lang/Runnable;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1, v0}, Ljgx;->setStyle(II)V

    new-instance p1, Ljhh;

    invoke-virtual {p0}, Ljgx;->getActivity()Landroid/app/Activity;
    ...
    invoke-direct {p1, v0}, Ljhh;-><init>(Landroid/content/Context;)V

    iput-object p1, p0, Ljgx;->r:Ljhh;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-virtual {p0}, Ljgx;->getDialog()Landroid/app/Dialog;
    ...
    iput-object p2, p0, Ljgx;->d:Lcom/google/android/apps/camera/tinyplanet/TinyPlanetPreview;

    iget-object p2, p0, Ljgx;->d:Lcom/google/android/apps/camera/tinyplanet/TinyPlanetPreview;

    iput-object p0, p2, Lcom/google/android/apps/camera/tinyplanet/TinyPlanetPreview;->c:Ljhg;
    ...
    invoke-direct {p3, p0}, Ljha;-><init>(Ljgx;)V
    ...
    invoke-direct {p3, p0}, Ljhb;-><init>(Ljgx;)V
    ...
    invoke-direct {p3, p0}, Ljhc;-><init>(Ljgx;)V

    invoke-virtual {p2, p3}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p0}, Ljgx;->getArguments()Landroid/os/Bundle;
    ...
    iput-object p2, p0, Ljgx;->h:Ljava/lang/String;
    ...
    iput-object p2, p0, Ljgx;->p:Landroid/net/Uri;

    iget-object p2, p0, Ljgx;->p:Landroid/net/Uri;

    invoke-direct {p0, p2, v0}, Ljgx;->a(Landroid/net/Uri;Z)Landroid/graphics/Bitmap;

    move-result-object p2

    iput-object p2, p0, Ljgx;->i:Landroid/graphics/Bitmap;

    iget-object p2, p0, Ljgx;->i:Landroid/graphics/Bitmap;

    if-nez p2, :cond_0

    sget-object p2, Ljgx;->m:Ljava/lang/String;

    const-string p3, "Could not decode source image."

    invoke-static {p2, p3}, Lpjn;->b(Ljava/lang/String;Ljava/lang/String;)V
