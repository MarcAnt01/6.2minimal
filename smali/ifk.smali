.class public final synthetic Lifk;
...
# direct methods
.method public constructor <init>(Lcom/google/android/apps/camera/processing/ProcessingService;Lfrl;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lifk;->a:Lcom/google/android/apps/camera/processing/ProcessingService;

    iput-object p2, p0, Lifk;->b:Lfrl;
...
.method public final run()V
    ...
    iget-object v0, p0, Lifk;->a:Lcom/google/android/apps/camera/processing/ProcessingService;

    iget-object v1, p0, Lifk;->b:Lfrl;

    :goto_0
    :try_start_0
    iget-object v2, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->l:Lifp;

    invoke-virtual {v2}, Lifp;->a()Lifr;
    ...
    :try_start_1
    iput-object v2, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->e:Lifr;

    iget-boolean v5, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->f:Z

    if-eqz v5, :cond_0

    iget-object v5, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->e:Lifr;

    invoke-interface {v5}, Lifr;->suspend()V
    ...
    :try_start_2
    invoke-interface {v2}, Lifr;->getUsageStatsName()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v1, v4}, Lfrl;->a(Ljava/lang/String;)V
    ...
    invoke-interface {v2}, Lifr;->getSession()Lifq;

    move-result-object v3

    if-eqz v3, :cond_2

    invoke-interface {v3, v0}, Lifq;->a(Lift;)V

    :cond_2
    invoke-static {}, Ljava/lang/System;->gc()V

    iget-object v3, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->d:Lifv;

    invoke-interface {v2}, Lifr;->getUsageStatsName()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4}, Lifv;->a(Ljava/lang/String;)V
    ...
    invoke-interface {v2, v0}, Lifr;->process(Landroid/content/Context;)V
    ...
    invoke-static {v3, v2}, Lpjn;->a(Ljava/lang/String;Ljava/lang/String;)V

    :goto_1
    invoke-virtual {v1}, Lfrl;->a()V
    :try_end_2
    ...
    :try_start_5
    iput-object v4, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->e:Lifr;
    ...
    :try_start_b
    iget-object v3, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->p:Llji;

    new-instance v4, Lifl;

    invoke-direct {v4, v2}, Lifl;-><init>(Ljava/lang/Exception;)V
