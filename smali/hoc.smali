...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhoc;->a:Ljava/nio/file/SimpleFileVisitor;

    return-void
.end method

.method constructor <init>(Landroid/content/Context;Llsg;Llsl;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lhoc;->b:Landroid/content/Context;
    ...
    iput-object p1, p0, Lhoc;->c:Llsg;

    iput-object p3, p0, Lhoc;->d:Llsl;
...
.method private final a(I)Ljava/lang/String;
    ...
    :try_start_2
    invoke-static {v1, p1}, Lhoc;->a(Ljava/lang/Throwable;Ljava/io/InputStream;)V
    :try_end_2
    ...
    :cond_3
    :try_start_4
    invoke-static {v0, p1}, Lhoc;->a(Ljava/lang/Throwable;Ljava/io/InputStream;)V
...
.method private final a(ILjava/nio/file/Path;)Z
    ...
    :try_start_0
    iget-object v1, p0, Lhoc;->b:Landroid/content/Context;
    ...
    :try_start_1
    invoke-direct {p0, p1, p2}, Lhoc;->a(Ljava/io/InputStream;Ljava/nio/file/Path;)Z
    ...
    :cond_3
    :try_start_5
    invoke-static {p2, p1}, Lhoc;->a(Ljava/lang/Throwable;Ljava/io/InputStream;)V
    ...
    :try_start_6
    iget-object p2, p0, Lhoc;->c:Llsg;

    const-string v1, "Failed to unzip resource."

    invoke-interface {p2, v1, p1}, Llsg;->c(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_6
...
.method private final a(Ljava/io/InputStream;Ljava/nio/file/Path;)Z
    ...
    :try_start_2
    invoke-static {p2, v1}, Lhoc;->a(Ljava/lang/Throwable;Ljava/util/zip/ZipInputStream;)V
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_2
...
.method private final a(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;I)Z
    ...
    invoke-direct {p0, p3}, Lhoc;->a(I)Ljava/lang/String;
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0, p2}, Lhoc;->a(Ljava/nio/file/Path;)Ljava/lang/String;
    ...
    invoke-direct {p0, p4, p1}, Lhoc;->a(Ljava/lang/String;Ljava/nio/file/Path;)Z
    ...
    invoke-interface {p3, p1}, Llsg;->b(Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :cond_2
    :try_start_2
    invoke-direct {p0, p2}, Lhoc;->b(Ljava/nio/file/Path;)Z
    ...
    invoke-direct {p0, p1, v2}, Lhoc;->a(Ljava/nio/file/Path;[Ljava/nio/file/Path;)Z

    move-result v2

    if-eqz v2, :cond_3

    invoke-direct {p0, p5, p1}, Lhoc;->a(ILjava/nio/file/Path;)Z
    ...
    invoke-interface {p2, p3, p1}, Llsg;->c(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private final varargs a(Ljava/nio/file/Path;[Ljava/nio/file/Path;)Z
    ...
    sget-object v0, Lhoc;->a:Ljava/nio/file/SimpleFileVisitor;
    ...
    invoke-interface {p2, v0, p1}, Llsg;->c(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method private final b(Ljava/nio/file/Path;)Z
    ...
    iget-object v1, p0, Lhoc;->c:Llsg;

    const-string v2, "Failed to delete cached fingerprint"

    invoke-interface {v1, v2, p1}, Llsg;->c(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final declared-synchronized a()Z
    ...
    :goto_1
    invoke-interface {v4, v2, v3}, Llsg;->c(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v4, v0}, Llsg;->d(Ljava/lang/String;)V
    ...
    invoke-direct/range {v2 .. v7}, Lhoc;->a(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;I)Z

    move-result v0

    iput-boolean v0, p0, Lhoc;->e:Z
    ...
    invoke-direct/range {v3 .. v8}, Lhoc;->a(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;I)Z

    move-result v2

    iput-boolean v2, p0, Lhoc;->f:Z
    ...
    iget-object v3, p0, Lhoc;->c:Llsg;

    const-string v4, "Failed to initialize OCR"

    invoke-interface {v3, v4}, Llsg;->c(Ljava/lang/String;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
