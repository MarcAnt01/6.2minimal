...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lilf;->j:[Laeu;

    new-instance v0, Lilg;

    invoke-direct {v0}, Lilg;-><init>()V

    sput-object v0, Lilf;->m:Ljava/util/Comparator;
...
.method public constructor <init>(Lbhe;Landroid/os/Handler;Ladz;I)V
    ...
    iput-object v3, v1, Lilf;->b:Ladz;

    iput-object v3, v1, Lilf;->c:Laey;

    const/4 v4, 0x0

    iput-boolean v4, v1, Lilf;->d:Z

    iput-object v3, v1, Lilf;->e:Lili;

    iput-object v3, v1, Lilf;->k:Lcom/google/android/apps/refocus/image/ColorImage;

    move-object/from16 v5, p1

    iput-object v5, v1, Lilf;->g:Lbhe;

    move-object/from16 v5, p2

    iput-object v5, v1, Lilf;->h:Landroid/os/Handler;

    iput-object v2, v1, Lilf;->b:Ladz;

    invoke-virtual/range {p3 .. p3}, Ladz;->g()Laff;

    move-result-object v5

    iput-object v5, v1, Lilf;->f:Laff;

    invoke-virtual/range {p3 .. p3}, Ladz;->c()Laer;

    move-result-object v5

    iput-object v5, v1, Lilf;->l:Laer;

    iget-object v5, v1, Lilf;->b:Ladz;
    ...
    iput-object v5, v1, Lilf;->c:Laey;

    iget-object v5, v1, Lilf;->l:Laer;

    iget-object v6, v1, Lilf;->f:Laff;
    ...
    sget-object v8, Lilf;->a:Ljava/lang/String;

    invoke-static {v7}, Lilf;->a(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-static {v5}, Lilf;->a(Ljava/util/List;)Ljava/lang/String;
    ...
    sget-object v8, Lilf;->m:Ljava/util/Comparator;
    ...
    invoke-direct {v9, v0}, Lknb;-><init>(I)V

    invoke-direct {v8, v9}, Lkna;-><init>(Lknb;)V
    ...
    iget-object v11, v8, Lkna;->a:Lknb;

    iget-wide v11, v11, Lknb;->a:D
    ...
    invoke-static {v0, v5}, Lpjn;->b(Ljava/lang/String;Ljava/lang/String;)V

    goto/16 :goto_b

    :cond_c
    sget-object v7, Lilf;->a:Ljava/lang/String;
    ...
    invoke-static {v7, v0}, Lpjn;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v7}, Lpjn;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_b
    iget-object v0, v1, Lilf;->l:Laer;

    iget-object v5, v1, Lilf;->f:Laff;
    ...
    :try_start_0
    iget-object v0, v1, Lilf;->b:Ladz;

    iget-object v3, v1, Lilf;->f:Laff;
    ...
    sget-object v3, Lilf;->a:Ljava/lang/String;

    invoke-virtual {v0}, Ljava/lang/RuntimeException;->toString()Ljava/lang/String;

    move-result-object v0

    invoke-static {v3, v0}, Lpjn;->b(Ljava/lang/String;Ljava/lang/String;)V

    :goto_12
    invoke-virtual/range {p0 .. p0}, Lilf;->d()V
    ...
    iput-object v0, v1, Lilf;->i:Ljava/lang/Object;
...
.method public final a(Lael;)V
    ...
    iget-object v0, p0, Lilf;->i:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, p0, Lilf;->d:Z
    ...
    :cond_1
    iget-object v1, p0, Lilf;->f:Laff;

    invoke-virtual {v1}, Laff;->b()Lafo;

    move-result-object v1

    iget-object v2, p0, Lilf;->f:Laff;
    ...
    iput-object v3, p0, Lilf;->k:Lcom/google/android/apps/refocus/image/ColorImage;

    iget-object v1, p0, Lilf;->b:Ladz;

    iget-object v2, p0, Lilf;->h:Landroid/os/Handler;
...
.method public final a(Laff;)V
    ...
    iput-object p1, p0, Lilf;->f:Laff;

    iget-object p1, p0, Lilf;->b:Ladz;

    iget-object v0, p0, Lilf;->f:Laff;
...
.method public final a(Landroid/graphics/SurfaceTexture;Lael;)V
    ...
    invoke-virtual {p0, p2}, Lilf;->a(Lael;)V

    return-void

    :cond_1
    :goto_0
    sget-object p1, Lilf;->a:Ljava/lang/String;
...
.method public final a([BLadz;)V
    ...
    iget-object v0, p0, Lilf;->e:Lili;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lilf;->k:Lcom/google/android/apps/refocus/image/ColorImage;

    invoke-virtual {v0, p1}, Lcom/google/android/apps/refocus/image/ColorImage;->setBuffer([B)V

    iget-object p1, p0, Lilf;->e:Lili;
    ...
    invoke-interface {p1, v0, v1, v2}, Lili;->a(Lcom/google/android/apps/refocus/image/ColorImage;J)V

    iget-boolean p1, p0, Lilf;->d:Z

    if-eqz p1, :cond_0

    iget-object p1, p0, Lilf;->k:Lcom/google/android/apps/refocus/image/ColorImage;
...
.method public final c()V
    ...
    invoke-virtual {p0}, Lilf;->b()V

    const/4 v0, 0x0

    iput-object v0, p0, Lilf;->b:Ladz;
