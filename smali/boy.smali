...
.method public constructor <init>(Lbte;Lbtf;Lbuf;Lnre;Ljava/util/concurrent/Executor;Ljen;Llof;Lkdb;Lbty;Lbuu;Lbum;Lbwb;Lbvx;Lbxd;Lbtg;)V
    .locals 9
    ...
    invoke-direct {v6, v5}, Llkj;-><init>(Ljava/lang/Object;)V

    iput-object v6, v0, Lboy;->t:Lllr;
    ...
    iput-object v5, v0, Lboy;->f:Lnre;

    invoke-interface/range {p7 .. p7}, Llof;->g()Lnre;
    ...
    iput-object v5, v0, Lboy;->j:Ljen;

    invoke-interface/range {p7 .. p7}, Llof;->h()Lnre;

    move-result-object v5

    iput-object v5, v0, Lboy;->l:Lnre;

    new-instance v5, Lbxc;

    move-object/from16 v6, p8

    invoke-direct {v5, v6}, Lbxc;-><init>(Lkdb;)V

    iput-object v5, v0, Lboy;->y:Lbxc;

    sget-object v5, Lnqh;->a:Lnqh;

    iput-object v5, v0, Lboy;->m:Lnre;
    ...
    invoke-direct {v7}, Llrj;-><init>()V

    iput-object v7, v0, Lboy;->v:Llrj;

    sget-object v7, Lbxe;->c:Lbxe;

    invoke-virtual {v4, v7}, Lbxd;->a(Lbxe;)Lljf;

    move-result-object v4

    invoke-virtual/range {p12 .. p12}, Lbwb;->q()Lllr;
    ...
    invoke-interface {v7, v8, v3}, Lllr;->a(Llry;Ljava/util/concurrent/Executor;)Llrr;

    move-result-object v3

    invoke-virtual {v4, v3}, Lljf;->a(Llrr;)Llrr;

    invoke-virtual {v4, v1}, Lljf;->a(Llrr;)Llrr;

    invoke-virtual {v4, v2}, Lljf;->a(Llrr;)Llrr;

    invoke-virtual/range {p13 .. p13}, Lbvx;->c()Llmm;
    ...
    invoke-static/range {p7 .. p7}, Lpgn;->a(Llof;)Llnx;
    ...
    invoke-direct {v3, v1}, Lbpd;-><init>(Llnx;)V
...
.method private final a(J)Ljava/io/File;
    ...
    iget-object v1, p0, Lboy;->j:Ljen;

    invoke-interface {v1, p1, p2}, Ljen;->d(J)Ljava/lang/String;

    move-result-object p1

    iget-object p2, p0, Lboy;->j:Ljen;
...
.method private final a(Ljava/io/File;J)V
    ...
    iget-object v4, v0, Lboy;->d:Llof;

    invoke-interface {v4}, Llof;->k()Lnre;
    ...
    invoke-virtual {v4, v2}, Lnre;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v4, v7}, Lpjn;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, v3}, Lpjn;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v4, Llpa;->h:Llpa;

    invoke-virtual {v3, v4}, Lbqi;->a(Llpa;)V
    ...
    invoke-virtual {v4}, Lbvx;->g()Llnc;

    move-result-object v6

    iget-object v7, v0, Lboy;->l:Lnre;

    iget-object v4, v0, Lboy;->w:Lbwb;

    invoke-virtual {v4}, Lbwb;->l()Lllr;
    ...
    invoke-interface {v4}, Llof;->j()Lnre;
    ...
    invoke-direct/range {v4 .. v15}, Lbwe;-><init>(Ljava/io/File;Llnc;Lnre;ZJJILnre;Ljava/util/Map;)V
...
.method public final a(Lawy;)Lazp;
    ...
    invoke-static {v1}, Lnnj;->c(I)Ljava/lang/String;
...
.method public final a()Lose;
    ...
    invoke-virtual {p0, v0}, Lboy;->a(Z)Lose;
    ...
    invoke-direct {v2, p0, v1}, Lbpe;-><init>(Lboy;Loss;)V
...
.method final a(Z)Lose;
    ...
    :goto_3
    invoke-virtual {v1, p1}, Loss;->a(Lose;)Z
    ...
    invoke-virtual {v2, v3}, Lbxd;->a(Lbxe;)Lljf;
    ...
    invoke-direct {v2, p0, v1}, Lboz;-><init>(Lboy;Loss;)V
    ...
    invoke-static {v1, p1, v2}, Loqr;->a(Lose;Lorc;Ljava/util/concurrent/Executor;)Lose;
...
.method public final a(JJ)V
    ...
    iget-object v0, p0, Lboy;->v:Llrj;

    new-instance v1, Llrk;

    long-to-float p3, p3

    invoke-direct {v1, p1, p2, p3}, Llrk;-><init>(JF)V

    invoke-virtual {v0, v1}, Llrj;->a(Llrk;)F
    ...
    invoke-static {p4, p1}, Lpjn;->d(Ljava/lang/String;Ljava/lang/String;)V
