...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfld;->g:Ljava/lang/String;
...
.method public constructor <init>(Ladz;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lfld;->h:Landroid/graphics/SurfaceTexture;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lfld;->e:Z

    iput-object p1, p0, Lfld;->b:Ladz;

    iput-object p2, p0, Lfld;->a:Landroid/os/Handler;
...
.method public final declared-synchronized a(Landroid/view/WindowManager;Landroid/content/Context;Lady;Z)Lafo;
    ...
    :try_start_0
    iput-object p3, p0, Lfld;->c:Lady;

    const/4 p3, 0x1

    iput-boolean p3, p0, Lfld;->d:Z

    iget-object v0, p0, Lfld;->b:Ladz;

    const/4 v1, 0x0

    if-nez v0, :cond_0

    sget-object p1, Lfld;->g:Ljava/lang/String;
    ...
    iget-object p4, p0, Lfld;->b:Ladz;

    invoke-virtual {p4}, Ladz;->g()Laff;

    move-result-object p4

    invoke-static {p2, v0}, Lflg;->a(Landroid/content/Context;Laer;)Laeu;
    ...
    invoke-static {v0}, Lflg;->b(Laer;)Laet;

    move-result-object p2

    iput-object p2, p4, Laff;->p:Laet;

    invoke-static {v0}, Lflg;->a(Laer;)Laev;
    ...
    invoke-static {v0}, Lfle;->a(Laer;)Lflf;

    move-result-object p2

    iget-object v1, p2, Lflf;->a:Lafo;

    iput-object v1, p0, Lfld;->f:Lafo;

    iget-object v1, p0, Lfld;->f:Lafo;

    invoke-virtual {p4, v1}, Laff;->a(Lafo;)Z

    invoke-static {v0, p4}, Lflg;->a(Laer;Laff;)V
    ...
    invoke-static {v2}, Llrp;->c(I)Llrp;
    ...
    iget-object p2, p0, Lfld;->b:Ladz;

    invoke-virtual {p2, p1}, Ladz;->a(I)V

    iget-object p1, p0, Lfld;->b:Ladz;
    ...
    iget-object p2, p0, Lfld;->h:Landroid/graphics/SurfaceTexture;
    ...
    iget-object p2, p0, Lfld;->f:Lafo;

    iget-object p3, p0, Lfld;->a:Landroid/os/Handler;

    iget-object p4, p0, Lfld;->c:Lady;

    invoke-static {p1, p2, p3, p4}, Lflg;->a(Ladz;Lafo;Landroid/os/Handler;Lady;)V
    ...
    iget-object p2, p0, Lfld;->a:Landroid/os/Handler;

    iget-object p3, p0, Lfld;->c:Lady;

    invoke-virtual {p1, p2, p3}, Ladz;->a(Landroid/os/Handler;Lady;)V

    :goto_1
    iget-object p1, p0, Lfld;->f:Lafo;
    :try_end_2
