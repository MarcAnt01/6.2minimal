...
.method public constructor <init>(Lcbc;ZZLlkx;Llkx;Llkx;Llkx;Llkx;)V
    .locals 2
    ...
    invoke-direct {p0, p5}, Llma;-><init>(Llkx;)V

    iput-object p1, p0, Lhhf;->b:Lcbc;

    iput-boolean p2, p0, Lhhf;->c:Z

    iput-boolean p3, p0, Lhhf;->d:Z

    iput-boolean p4, p0, Lhhf;->e:Z
...
.method protected final synthetic a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-boolean v3, p0, Lhhf;->c:Z

    iget-boolean v4, p0, Lhhf;->d:Z
    ...
    invoke-direct/range {v2 .. v8}, Lhhc;-><init>(ZZIIZZ)V
    ...
    iget-boolean v2, p0, Lhhf;->d:Z

    if-eqz v2, :cond_0

    iget-object v2, p0, Lhhf;->b:Lcbc;
    ...
    invoke-static {v2, v4, v3}, Llhq;->a(Landroid/content/ContentResolver;Ljava/lang/String;F)F
    ...
    :goto_0
    iget-boolean v3, p0, Lhhf;->d:Z

    const/high16 v4, 0x42a00000    # 80.0f

    if-eqz v3, :cond_1

    iget-object v3, p0, Lhhf;->b:Lcbc;

    iget-object v3, v3, Lcbc;->a:Landroid/content/ContentResolver;

    const-string v5, "camera:simple_metering_dark_bmm_threshold_front"

    invoke-static {v3, v5, v4}, Llhq;->a(Landroid/content/ContentResolver;Ljava/lang/String;F)F
    ...
    :goto_3
    iget-boolean v2, p0, Lhhf;->e:Z

    if-nez v2, :cond_b

    invoke-static {v1, p1}, Lhhb;->a(Lhhc;Lgoa;)Lgoa;
    ...
    iget-boolean v2, v1, Lhhc;->a:Z

    if-eqz v2, :cond_d

    iget-boolean v2, v1, Lhhc;->b:Z
    ...
    :cond_e
    sget-object v2, Lgoa;->c:Lgoa;

    if-eq p1, v2, :cond_f

    sget-object v2, Lgoa;->e:Lgoa;

    if-eq p1, v2, :cond_f

    sget-object v2, Lgoa;->d:Lgoa;

    if-ne p1, v2, :cond_10

    :cond_f
    iget-boolean v2, v1, Lhhc;->c:Z
