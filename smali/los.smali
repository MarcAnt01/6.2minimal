...
# direct methods
.method constructor <init>(Lloq;ILandroid/media/MediaCodec$BufferInfo;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Llos;->a:Lloq;

    iput p2, p0, Llos;->b:I

    iput-object p3, p0, Llos;->c:Landroid/media/MediaCodec$BufferInfo;
...
.method public final run()V
    ...
    iget-object v0, p0, Llos;->a:Lloq;

    iget v1, p0, Llos;->b:I

    iget-object v2, p0, Llos;->c:Landroid/media/MediaCodec$BufferInfo;
    ...
    :cond_1
    iget-object v4, v0, Llok;->p:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    invoke-virtual {v8, v9}, Lnzp;->e(Ljava/lang/Comparable;)Z

    move-result v9

    if-nez v9, :cond_7

    invoke-virtual {v8}, Lnzp;->b()Z
    ...
    :cond_5
    :goto_3
    iget-object v4, v0, Llok;->g:Landroid/media/MediaCodec;
    ...
    iget-object v4, v0, Llok;->l:Ljava/util/List;

    new-instance v7, Lloy;

    invoke-direct {v7, v2, v6}, Lloy;-><init>(Landroid/media/MediaCodec$BufferInfo;Ljava/nio/ByteBuffer;)V

    invoke-interface {v4, v7}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-wide v6, v0, Llok;->t:J

    sget-wide v8, Llok;->a:J
    ...
    iput-boolean v3, v0, Llok;->q:Z

    iget-object v3, v0, Llok;->k:Llpc;

    sget-object v4, Llpa;->c:Llpa;

    invoke-virtual {v3, v4}, Llpc;->a(Llpa;)V

    goto :goto_4

    :cond_6
    invoke-virtual {v0, v2, v4}, Llok;->a(Landroid/media/MediaCodec$BufferInfo;Ljava/nio/ByteBuffer;)V

    :cond_7
    :goto_4
    iget-object v3, v0, Llok;->g:Landroid/media/MediaCodec;
