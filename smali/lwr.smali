...
.method public constructor <init>(Llyz;)V
    ...
    iput-object p1, p0, Llwr;->b:Llyz;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Llwr;->a:Ljava/util/Map;
...
.method private final declared-synchronized b()V
    ...
    :try_start_0
    iget-object v0, p0, Llwr;->c:Ljava/lang/Runnable;
...
.method public final declared-synchronized a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p0, Llwr;->b:Llyz;

    invoke-virtual {v0, p1}, Llyz;->a(Landroid/hardware/camera2/CaptureRequest$Key;)Z
    ...
    invoke-virtual {p0, p1}, Llwr;->a(Llvv;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized a(Ljava/lang/Runnable;)V
    ...
    iput-object p1, p0, Llwr;->c:Ljava/lang/Runnable;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized a(Ljava/util/Set;)V
    ...
    :cond_1
    iget-object v3, p0, Llwr;->a:Ljava/util/Map;
    ...
    iget-object v2, p0, Llwr;->a:Ljava/util/Map;
    ...
    invoke-virtual {v1, v2}, Llvv;->equals(Ljava/lang/Object;)Z
...
.method public final declared-synchronized a(Llvv;)V
    .locals 2
    ...
    iget-object v1, p1, Llvv;->a:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-virtual {v0, v1}, Llyz;->a(Landroid/hardware/camera2/CaptureRequest$Key;)Z
    ...
    invoke-virtual {p0, p1}, Llwr;->a(Ljava/util/Set;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
