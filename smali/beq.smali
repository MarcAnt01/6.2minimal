...
.method public constructor <init>(Lbev;Lgva;Lgpu;Lose;Lbeh;)V
    .locals 0
    ...
    iput-object p2, p0, Lbeq;->c:Lgva;

    iput-object p3, p0, Lbeq;->d:Lgpu;

    iput-object p4, p0, Lbeq;->e:Lose;
...
.method public final a()V
    ...
    :try_start_0
    iget-object v0, p0, Lbeq;->c:Lgva;

    invoke-interface {v0}, Lgva;->c()Lgtj;
    ...
    :try_start_1
    iget-object v1, p0, Lbeq;->d:Lgpu;

    invoke-interface {v1}, Lgpu;->a()Lgpv;
    ...
    :try_start_2
    iget-object v2, p0, Lbeq;->e:Lose;

    invoke-static {v2}, Llug;->a(Lose;)Ljava/lang/Object;
    ...
    invoke-virtual {v2}, Lgoc;->b_()Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lgqy;

    invoke-direct {v3, v2}, Lgra;-><init>(Lgqy;)V

    invoke-virtual {v3, v0}, Lgra;->a(Lgqo;)Lgra;
    ...
    invoke-interface {v1, v2, v3}, Lgpv;->a(Ljava/util/List;I)V

    invoke-interface {v1}, Lgpv;->close()V

    invoke-interface {v0}, Lgtj;->a()Ljava/lang/Object;
    ...
    invoke-virtual {v2, v4}, Lihb;->a(I)Lihb;
    ...
    invoke-interface {v3, v2}, Lbev;->a(Liha;)V
    :try_end_2
    ...
    :cond_0
    :try_start_3
    invoke-static {v2, v1}, Lbeq;->a(Ljava/lang/Throwable;Lgpv;)V
    :try_end_3
    ...
    :try_start_4
    invoke-static {v2, v0}, Lbeq;->a(Ljava/lang/Throwable;Lgtj;)V
    :try_end_4
    ...
    :try_start_8
    invoke-static {v1, v0}, Lbeq;->a(Ljava/lang/Throwable;Lgtj;)V
