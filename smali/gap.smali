...
.method public constructor <init>(Landroid/hardware/SensorManager;)V
    ...
    invoke-direct {v0, p1}, Lgaq;-><init>(Landroid/hardware/SensorManager;)V

    iput-object v0, p0, Lgap;->a:Lgaq;
...
.method public final a(J)Lnre;
    ...
    iget-object v3, v2, Lgap;->a:Lgaq;

    invoke-virtual {v3}, Lgaq;->c()Z

    move-result v4

    if-eqz v4, :cond_7

    iget-object v3, v3, Lgaq;->c:Lkcw;

    invoke-interface {v3}, Lkcw;->a()Ljava/util/List;

    move-result-object v3

    new-instance v4, Lgas;

    invoke-direct {v4, v0, v1}, Lgas;-><init>(J)V

    sget-object v5, Lgaq;->b:Ljava/util/Comparator;
    ...
    iget-wide v3, v5, Lfli;->a:D

    iget-wide v6, v5, Lfli;->b:D

    iget-wide v8, v5, Lfli;->c:D
    ...
    sget-object v2, Lgaq;->a:[F

    invoke-direct {v1, v2, v0}, Lgan;-><init>([F[F)V
