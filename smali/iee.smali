...
.method constructor <init>(Lidx;Liet;)V
    ...
    iput-object p1, p0, Liee;->b:Lidx;

    iput-object p2, p0, Liee;->a:Liet;
...
.method public final RgbReady(JLcom/google/googlex/gcam/InterleavedReadViewU8;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p4, p0, Liee;->a:Liet;

    if-eqz p4, :cond_2

    iget-object p4, p0, Liee;->b:Lidx;

    iget-object p4, p4, Lidx;->i:Lcom/google/googlex/gcam/clientallocator/MapInterleavedU8ClientAllocator;
    ...
    invoke-interface/range {v0 .. v5}, Liet;->b(JLcom/google/googlex/gcam/InterleavedReadViewU8;Lieu;Ljava/lang/String;)V
