...
.method constructor <init>(Landroid/content/Context;Lcds;Landroid/content/ContentResolver;Lcef;Ljdr;)V
    .locals 0
...
.method public final a(Landroid/net/Uri;)Lcei;
    ...
    :try_start_4
    invoke-static {v2, v1}, Lota;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v2, p1, v1}, Lpjn;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-object v0
.end method

.method public final a(Landroid/net/Uri;ZLnre;)Lcei;
    .locals 11

    iget-object v0, p0, Lcej;->e:Ljdr;

    invoke-interface {v0, p1}, Ljdr;->c(Landroid/net/Uri;)Z
    ...
    invoke-interface {v0, p1}, Ljdr;->d(Landroid/net/Uri;)Landroid/graphics/Point;
    ...
    invoke-static {v0}, Llrt;->a(Landroid/graphics/Point;)Llrt;

    move-result-object v6

    iget-object v0, p0, Lcej;->e:Ljdr;

    invoke-interface {v0, p1}, Ljdr;->e(Landroid/net/Uri;)J
    ...
    invoke-static/range {v5 .. v10}, Lcei;->a(Landroid/net/Uri;Llrt;JZLnre;)Lfuw;

    move-result-object v5

    iget-object v7, p0, Lcej;->e:Ljdr;

    move-object v2, v1

    move-object v6, p0

    invoke-direct/range {v2 .. v7}, Lcei;-><init>(Landroid/content/Context;Lcds;Lfuw;Lcej;Ljdr;)V
...
.method public final b(Landroid/database/Cursor;)Lcei;
    ...
    invoke-static {p1}, Lcef;->a(Landroid/database/Cursor;)Lfuw;
    ...
    iget-object v5, p0, Lcej;->e:Ljdr;

    move-object v0, p1

    move-object v4, p0

    invoke-direct/range {v0 .. v5}, Lcei;-><init>(Landroid/content/Context;Lcds;Lfuw;Lcej;Ljdr;)V
