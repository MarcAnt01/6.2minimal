...
.field private static final n:Ljpi;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljoe;->a:Ljava/lang/String;

    new-instance v0, Ljpi;

    invoke-direct {v0}, Ljpi;-><init>()V

    sput-object v0, Ljoe;->n:Ljpi;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Ljoe;->b:Ljava/util/EnumMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Ljoe;->p:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Ljoe;->c:Ljava/util/EnumSet;
    ...
    invoke-virtual {p0, v1}, Ljoe;->setVisibility(I)V

    const/4 v1, 0x0

    invoke-virtual {p0, v1}, Ljoe;->setAlpha(F)V
    ...
    invoke-virtual {p0}, Ljoe;->getContext()Landroid/content/Context;
    ...
    iput-object p1, p0, Ljoe;->j:Landroid/graphics/drawable/Drawable;

    iget-object p1, p0, Ljoe;->j:Landroid/graphics/drawable/Drawable;
...
.method private final c(Landroid/widget/TextView;)V
    ...
    iget-object v0, p0, Ljoe;->e:Landroid/widget/TextView;
    ...
    :cond_0
    iput-object p1, p0, Ljoe;->e:Landroid/widget/TextView;

    iget-object p1, p0, Ljoe;->e:Landroid/widget/TextView;
...
# virtual methods
.method final a(I)Lkac;
    .locals 2

    invoke-static {}, Llji;->a()V

    iget-object v0, p0, Ljoe;->b:Ljava/util/EnumMap;
    ...
    invoke-direct {v1, p1}, Ljoh;-><init>(I)V

    invoke-virtual {v0, v1}, Lnzo;->a(Lnqx;)Lnzo;
    ...
    invoke-virtual {p1, v0}, Lnzo;->a(Ljava/lang/Iterable;)Ljava/lang/Object;
...
.method final a(Lkac;)V
    ...
    iget-object v0, p0, Ljoe;->k:Landroid/animation/Animator;
    ...
    iget-object v1, p0, Ljoe;->j:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1}, Landroid/graphics/drawable/Drawable;->getBounds()Landroid/graphics/Rect;

    move-result-object v1

    iget-object v2, p0, Ljoe;->j:Landroid/graphics/drawable/Drawable;

    sget-object v3, Ljoe;->n:Ljpi;
    ...
    iget-object v1, p0, Ljoe;->b:Ljava/util/EnumMap;
    ...
    invoke-static {v1}, Ljoe;->b(Landroid/widget/TextView;)Landroid/graphics/Rect;
    ...
    invoke-direct {v2, p0}, Ljog;-><init>(Ljoe;)V
    ...
    iget-object v2, p0, Ljoe;->e:Landroid/widget/TextView;
    ...
    iget-object v3, p0, Ljoe;->b:Ljava/util/EnumMap;
    ...
    invoke-direct {p0, p1}, Ljoe;->c(Landroid/widget/TextView;)V
    ...
    invoke-virtual {p0}, Ljoe;->invalidate()V

    invoke-virtual {v0}, Landroid/animation/AnimatorSet;->start()V

    iput-object v0, p0, Ljoe;->k:Landroid/animation/Animator;
...
.method public final a(Lkac;Z)V
    ...
    iget-object v1, p0, Ljoe;->e:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, p1}, Ljoe;->a(Lkac;)V

    goto :goto_1

    :cond_2
    iget-object p1, p0, Ljoe;->k:Landroid/animation/Animator;
    ...
    invoke-static {v0}, Ljoe;->b(Landroid/widget/TextView;)Landroid/graphics/Rect;

    move-result-object v1

    invoke-virtual {p1, v1}, Landroid/graphics/drawable/Drawable;->setBounds(Landroid/graphics/Rect;)V

    invoke-direct {p0, v0}, Ljoe;->c(Landroid/widget/TextView;)V
    ...
    invoke-interface {p1, v1, p2}, Ljom;->a(IZ)V
...
.method public final a(ZZ)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Ljoe;->setAlpha(F)V

    return-void

    :cond_1
    iget-object p2, p0, Ljoe;->o:Landroid/animation/Animator;
    ...
    iput-object p1, p0, Ljoe;->o:Landroid/animation/Animator;
...
.method protected final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Ljoe;->j:Landroid/graphics/drawable/Drawable;
...
.method protected final onLayout(ZIIII)V
    ...
    invoke-static {v0, v6}, Lpjn;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_0
    iget-boolean v0, v1, Ljoe;->d:Z

    const/4 v6, 0x0

    if-eqz v0, :cond_1

    iget-object v0, v1, Ljoe;->c:Ljava/util/EnumSet;

    invoke-static {v0}, Ljava/util/EnumSet;->copyOf(Ljava/util/EnumSet;)Ljava/util/EnumSet;

    move-result-object v0

    iput-boolean v5, v1, Ljoe;->d:Z
    ...
    iget-object v7, v1, Ljoe;->b:Ljava/util/EnumMap;
    ...
    iget-object v9, v1, Ljoe;->b:Ljava/util/EnumMap;
    ...
    invoke-static {v9}, Ljoe;->b(Landroid/widget/TextView;)Landroid/graphics/Rect;

    move-result-object v8

    invoke-virtual/range {p0 .. p0}, Ljoe;->getContext()Landroid/content/Context;
    ...
    iget v15, v1, Ljoe;->q:I

    sub-int/2addr v11, v12

    sub-int v14, v11, v15

    iget v11, v1, Ljoe;->r:I
    ...
    sget-object v10, Ljoe;->a:Ljava/lang/String;

    const-string v11, "hideDotOnChip with animation"

    invoke-static {v10, v11}, Lpjn;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v10, v9}, Ljof;-><init>(Landroid/widget/TextView;)V
    ...
    iget v10, v1, Ljoe;->t:I

    int-to-long v10, v10

    invoke-virtual {v8, v10, v11}, Landroid/animation/ObjectAnimator;->setDuration(J)Landroid/animation/ObjectAnimator;

    iget v10, v1, Ljoe;->s:I

    int-to-long v10, v10

    invoke-virtual {v8, v10, v11}, Landroid/animation/ObjectAnimator;->setStartDelay(J)V

    new-instance v10, Ljoi;

    invoke-direct {v10, v9}, Ljoi;-><init>(Landroid/widget/TextView;)V
    ...
    :cond_5
    sget-object v8, Ljoe;->a:Ljava/lang/String;

    const-string v10, "hideDotOnChip without animation"

    invoke-static {v8, v10}, Lpjn;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0, v5}, Ljoe;->a(Lkac;Z)V

    invoke-virtual {v1, v5}, Ljoe;->setVisibility(I)V

    invoke-virtual {v1, v3, v5}, Ljoe;->a(ZZ)V

    iput v2, v1, Ljoe;->m:I

    :goto_5
    iget-object v0, v1, Ljoe;->e:Landroid/widget/TextView;

    if-eqz v0, :cond_9

    iget-object v2, v1, Ljoe;->j:Landroid/graphics/drawable/Drawable;
...
.method protected final onMeasure(II)V
    ...
    iget-object v1, p0, Ljoe;->p:Ljava/util/HashMap;
    ...
    :goto_0
    invoke-virtual {p0}, Ljoe;->getChildCount()I

    move-result v6

    if-ge v3, v6, :cond_0

    invoke-virtual {p0, v3}, Ljoe;->getChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v2}, Ljoe;->getChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v5}, Ljoe;->getChildAt(I)Landroid/view/View;
    ...
    iget-object v2, p0, Ljoe;->p:Ljava/util/HashMap;
    ...
    invoke-virtual {p0}, Ljoe;->getPaddingTop()I

    move-result v2

    iget v3, v1, Ljon;->d:I

    invoke-virtual {p0}, Ljoe;->getPaddingBottom()I

    move-result v4

    invoke-virtual {p0, v0, v2, v3, v4}, Ljoe;->setPadding(IIII)V
    ...
    invoke-static {v0, p1}, Ljoe;->resolveSize(II)I

    move-result p1

    iget v0, v1, Ljon;->b:I

    invoke-static {v0, p2}, Ljoe;->resolveSize(II)I

    move-result p2

    invoke-virtual {p0, p1, p2}, Ljoe;->setMeasuredDimension(II)V
