...
.method public constructor <init>(Landroid/content/Context;Lfld;Lfnf;Lfnp;Lflx;Lfmj;Lfra;Ldox;)V
    .locals 3
    ...
    iput-boolean v0, p0, Lfly;->d:Z

    new-instance v1, Ljava/util/concurrent/Semaphore;

    invoke-direct {v1, v0}, Ljava/util/concurrent/Semaphore;-><init>(I)V

    iput-object v1, p0, Lfly;->m:Ljava/util/concurrent/Semaphore;
    ...
    iput-object v1, p0, Lfly;->n:Ljava/util/Vector;

    iput v0, p0, Lfly;->o:I

    const/4 v1, 0x0

    iput-object v1, p0, Lfly;->p:Ljava/io/FileWriter;

    iput-boolean v0, p0, Lfly;->t:Z

    const/4 v2, 0x1

    iput-boolean v2, p0, Lfly;->u:Z

    iput-boolean v0, p0, Lfly;->v:Z

    iput-boolean v0, p0, Lfly;->x:Z

    iput-boolean v0, p0, Lfly;->y:Z

    iput-object v1, p0, Lfly;->z:Lfoc;

    iput-object v1, p0, Lfly;->A:Lfoc;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lfly;->F:Ljava/util/List;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lfly;->G:Ljava/util/List;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lfly;->H:Ljava/util/List;

    new-instance v1, Lfmn;

    invoke-direct {v1}, Lfmn;-><init>()V

    iput-object v1, p0, Lfly;->I:Lfmn;

    iput-boolean v0, p0, Lfly;->J:Z

    new-instance v1, Lfmc;

    invoke-direct {v1, p0}, Lfmc;-><init>(Lfly;)V

    iput-object v1, p0, Lfly;->L:Lady;

    new-instance v1, Lfmd;

    invoke-direct {v1}, Lfmd;-><init>()V

    iput-object v1, p0, Lfly;->M:Ladx;

    new-instance v1, Lfme;

    invoke-direct {v1, p0}, Lfme;-><init>(Lfly;)V

    iput-object v1, p0, Lfly;->N:Laek;

    new-instance v1, Lfmf;

    invoke-direct {v1, p0}, Lfmf;-><init>(Lfly;)V

    iput-object v1, p0, Lfly;->O:Ladx;

    iput-object p8, p0, Lfly;->r:Ldox;

    iput-object p1, p0, Lfly;->q:Landroid/content/Context;

    iput-object p3, p0, Lfly;->h:Lfnf;

    iput-object p4, p0, Lfly;->Q:Lfnp;

    iput-object p5, p0, Lfly;->D:Lflx;

    iput-object p7, p0, Lfly;->s:Lfra;
    ...
    iput-object p1, p0, Lfly;->K:Landroid/os/Handler;

    :try_start_0
    new-instance p1, Ljava/io/FileWriter;

    iget-object p4, p0, Lfly;->Q:Lfnp;

    iget-object p4, p4, Lfnp;->i:Ljava/lang/String;

    invoke-direct {p1, p4}, Ljava/io/FileWriter;-><init>(Ljava/lang/String;)V

    iput-object p1, p0, Lfly;->p:Ljava/io/FileWriter;
    :try_end_0
    ...
    :goto_0
    invoke-static {p1, p4}, Lpjn;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lfly;->C:Landroid/os/HandlerThread;

    iget-object p1, p0, Lfly;->C:Landroid/os/HandlerThread;

    invoke-virtual {p1}, Landroid/os/HandlerThread;->start()V

    new-instance p1, Landroid/os/Handler;

    iget-object p4, p0, Lfly;->C:Landroid/os/HandlerThread;
    ...
    iput-object p1, p0, Lfly;->B:Landroid/os/Handler;

    iput-object p2, p0, Lfly;->c:Lfld;

    iget-object p1, p0, Lfly;->c:Lfld;
    ...
    :cond_1
    iput-object p6, p0, Lfly;->b:Lfmj;

    iget-object p1, p0, Lfly;->b:Lfmj;

    iput-object p0, p1, Lfmj;->H:Lfly;

    iget-object p1, p0, Lfly;->r:Ldox;
    ...
    iput-object p3, p1, Lfmj;->G:Lfnf;

    new-instance p2, Lfmw;

    invoke-direct {p2}, Lfmw;-><init>()V

    iput-object p2, p1, Lfmj;->A:Lfmw;

    iget-object p1, p0, Lfly;->h:Lfnf;

    new-instance p2, Lflz;

    invoke-direct {p2, p0}, Lflz;-><init>(Lfly;)V

    iput-object p2, p1, Lfnf;->p:Lfoc;

    iget-object p1, p0, Lfly;->I:Lfmn;

    invoke-static {}, Lflu;->b()Z

    move-result p2

    iput-boolean p2, p1, Lfmn;->c:Z

    iget-object p1, p0, Lfly;->q:Landroid/content/Context;
    ...
    invoke-static {p1, p2, v0}, Llhq;->a(Landroid/content/ContentResolver;Ljava/lang/String;Z)Z

    move-result p1

    iput-boolean p1, p0, Lfly;->y:Z
...
.method public final a(I)V
    ...
    :goto_0
    iget-object v0, p0, Lfly;->b:Lfmj;

    iget-object v1, v0, Lfmj;->d:Lfmu;

    if-eqz v1, :cond_5

    invoke-virtual {v1}, Lfmu;->a()V

    :cond_5
    iget-object v0, v0, Lfmj;->e:Lcom/google/android/apps/camera/legacy/lightcycle/ui/PhotoSphereMessageOverlay;
    ...
    iget-object v3, v0, Lfmj;->d:Lfmu;

    if-eqz v3, :cond_6

    invoke-virtual {v3, p1}, Lfmu;->a([F)V

    :cond_6
    iget-boolean p1, v0, Lfmj;->p:Z
    ...
    iget-object p1, v0, Lfmj;->e:Lcom/google/android/apps/camera/legacy/lightcycle/ui/PhotoSphereMessageOverlay;
    ...
    iput-boolean v2, v0, Lfmj;->w:Z

    :cond_8
    nop

    iput-boolean v1, p0, Lfly;->x:Z
...
.method public final b()V
    ...
    iget-object v1, p0, Lfly;->b:Lfmj;

    iget-object v1, v1, Lfmj;->b:Lfmo;
    ...
    iput-object v2, v1, Lfmo;->a:Ljava/nio/FloatBuffer;
    ...
    iput-object v2, v1, Lfmo;->b:Ljava/nio/FloatBuffer;
    ...
    iput-object v2, v1, Lfmo;->c:Ljava/nio/ShortBuffer;
    ...
    iput-object v2, v1, Lfmo;->i:Ljava/nio/ShortBuffer;
    ...
    iget-object v4, v1, Lfmo;->a:Ljava/nio/FloatBuffer;
    ...
    iget-object v0, v1, Lfmo;->c:Ljava/nio/ShortBuffer;
    ...
    iget-object v7, v1, Lfmo;->i:Ljava/nio/ShortBuffer;
    ...
    iget-object v6, v1, Lfmo;->i:Ljava/nio/ShortBuffer;
    ...
    iget-object v4, v1, Lfmo;->i:Ljava/nio/ShortBuffer;
    ...
    :cond_6
    iget-object v7, v1, Lfmo;->b:Ljava/nio/FloatBuffer;
...
.method public final declared-synchronized c()V
    ...
    iget-object v4, v0, Lfld;->a:Landroid/os/Handler;
    ...
    iput-object v3, v0, Lfld;->c:Lady;

    :cond_2
    iget-object v0, p0, Lfly;->Q:Lfnp;

    iget-object v0, v0, Lfnp;->h:Ljava/lang/String;

    iget-object v1, p0, Lfly;->F:Ljava/util/List;

    invoke-static {v0, v1}, Lfod;->a(Ljava/lang/String;Ljava/util/List;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    :try_start_2
    iget-object v0, p0, Lfly;->p:Ljava/io/FileWriter;
...
.method public final d()F
    ...
    sget-object v4, Lfly;->a:Ljava/lang/String;
    ...
    invoke-static {v4, v1}, Lpjn;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final e()F
    ...
    iget-object v0, p0, Lfly;->q:Landroid/content/Context;
...
.method public final declared-synchronized f()I
    ...
    iget-object v0, p0, Lfly;->F:Ljava/util/List;
    ...
    iget-object v3, p0, Lfly;->Q:Lfnp;

    iget-object v3, v3, Lfnp;->i:Ljava/lang/String;
    ...
    iput-object v0, p0, Lfly;->p:Ljava/io/FileWriter;
    ...
    :try_start_2
    sget-object v2, Lfly;->a:Ljava/lang/String;
