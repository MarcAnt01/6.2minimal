...
# static fields
.field public static final a:Lmxy;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmxz;->d:Ljava/util/logging/Logger;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    sput-object v0, Lmxz;->b:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sput-object v0, Lmxz;->c:Ljava/util/Set;
...
.method static a(Ljava/lang/Object;Ljava/util/concurrent/ConcurrentHashMap;Ljava/lang/String;Lmxy;)Lmyr;
    .locals 4
    ...
    invoke-interface {p3, p2}, Lmxy;->a(Ljava/lang/String;)Ljava/io/InputStream;

    move-result-object p3

    if-eqz p3, :cond_3

    invoke-static {p3}, Lmxz;->a(Ljava/io/InputStream;)Lmys;

    move-result-object p3

    iget-object p3, p3, Lmys;->a:Ljava/util/List;
    ...
    sget-object v0, Lmxz;->d:Ljava/util/logging/Logger;
...
.method private static a(Ljava/io/InputStream;)Lmys;
    .locals 5
    ...
    :try_start_2
    invoke-virtual {v3, v2}, Lmys;->readExternal(Ljava/io/ObjectInput;)V
    :try_end_2
    ...
    sget-object v1, Lmxz;->d:Ljava/util/logging/Logger;
    ...
    sget-object v2, Lmxz;->d:Ljava/util/logging/Logger;
