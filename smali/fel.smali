...
.field private g:Lfez;

.field private h:Lljf;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfel;->c:Ljava/lang/String;
...
.method private final a(Landroid/preference/PreferenceGroup;Ljava/lang/String;)Landroid/preference/PreferenceScreen;
    ...
    invoke-direct {p0, v0, p2}, Lfel;->a(Landroid/preference/PreferenceGroup;Ljava/lang/String;)Landroid/preference/PreferenceScreen;
...
.method private final a(Landroid/preference/PreferenceGroup;)V
    ...
    invoke-direct {p0, v3}, Lfel;->a(Landroid/preference/PreferenceGroup;)V
    ...
    :cond_2
    iget-object v3, p0, Lfel;->g:Lfez;

    iget-object v3, v3, Lfez;->d:Lnre;
    ...
    invoke-direct {p0, v3, v2}, Lfel;->a(Liul;Landroid/preference/ListPreference;)V
    ...
    iget-object v3, v3, Lfez;->b:Ljava/util/List;

    invoke-direct {p0, v3, v2}, Lfel;->a(Ljava/util/List;Landroid/preference/ListPreference;)V
    ...
    iget-object v3, v3, Lfez;->a:Ljava/util/List;
...
.method private final a(Liul;Landroid/preference/ListPreference;)V
    .locals 3
    ...
    iget-object v2, p0, Lfel;->d:[Ljava/lang/String;
    ...
    iget-object p1, p0, Lfel;->d:[Ljava/lang/String;
...
.method private final a(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lfel;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v0

    if-nez v0, :cond_0

    sget-object v0, Lfel;->c:Ljava/lang/String;
...
.method private final a(Ljava/util/List;Landroid/preference/ListPreference;)V
    ...
    invoke-static {v4}, Liue;->b(Llrt;)Llrt;

    move-result-object v5

    iget-object v6, p0, Lfel;->a:Lfeu;

    iget v7, v4, Llrt;->a:I

    iget v8, v4, Llrt;->b:I

    iget-object v6, v6, Lfeu;->b:Ljava/text/NumberFormat;
    ...
    invoke-static {v5}, Liue;->a(Llrt;)I

    move-result v7

    invoke-static {v5}, Liue;->c(Llrt;)I
    ...
    invoke-static {v4}, Llru;->a(Llrt;)Ljava/lang/String;
...
.method static final synthetic a(Landroid/app/Activity;)Z
    ...
    invoke-direct {v2, v3}, Lkqk;-><init>(Landroid/content/Context;)V

    sget-object v3, Lktt;->a:Lkqc;

    invoke-virtual {v2, v3}, Lkqk;->a(Lkqc;)Lkqk;

    move-result-object v2

    invoke-virtual {v2}, Lkqk;->b()Lkqj;

    move-result-object v2

    invoke-direct {v1, v2}, Lkbq;-><init>(Lkqj;)V
    ...
    invoke-direct {v2, v0, p0}, Lbee;-><init>(Lbed;Lnre;)V

    sget-object p0, Lorj;->a:Lorj;

    invoke-static {v1, v2, p0}, Lpwe;->a(Lose;Loru;Ljava/util/concurrent/Executor;)V
...
.method private final a(Landroid/preference/PreferenceGroup;Landroid/preference/Preference;)Z
    ...
    sget-object p1, Lfel;->c:Ljava/lang/String;
    ...
    invoke-direct {p0, v3, p2}, Lfel;->a(Landroid/preference/PreferenceGroup;Landroid/preference/Preference;)Z
...
.method private final b(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lfel;->getActivity()Landroid/app/Activity;
...
.method static final synthetic b(Landroid/app/Activity;)Z
    ...
    invoke-direct {v1, v0}, Lkum;-><init>(Landroid/app/Activity;)V
    ...
    iget-object v0, v1, Lkum;->a:Landroid/app/Activity;

    invoke-static {v0}, Lkpy;->a(Landroid/content/Context;)I
    ...
    iget-object v0, v1, Lkum;->b:Lkqj;

    new-instance v2, Lkun;

    const/4 v4, 0x0

    invoke-direct {v2, v1, p0, v4}, Lkun;-><init>(Lkum;Landroid/content/Intent;Ljava/util/List;)V

    invoke-static {v0, v2}, Lkvp;->a(Lkqj;Lkvt;)V

    goto :goto_0

    :cond_0
    invoke-virtual {v1, v0, p0}, Lkum;->a(ILandroid/content/Intent;)V
...
.method private final c()V
    ...
    iget-object v0, p0, Lfel;->f:Lcom/google/android/apps/camera/legacy/app/settings/ManagedSwitchPreference;

    if-eqz v0, :cond_1

    const-string v0, "pref_video_quality_back_key"

    invoke-virtual {p0, v0}, Lfel;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
...
.method public final a()V
    ...
    iget-object v0, p0, Lfel;->b:Lcom/google/android/apps/camera/legacy/app/settings/ManagedSwitchPreference;
...
.method public final getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    iget-object v1, p0, Lfel;->e:Ljava/lang/String;

    if-eqz v1, :cond_1

    if-eqz v0, :cond_1

    invoke-direct {p0, v0, v1}, Lfel;->a(Landroid/preference/PreferenceGroup;Ljava/lang/String;)Landroid/preference/PreferenceScreen;
...
.method public final onActivityCreated(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lfel;->a:Lfeu;

    iget-object v0, v0, Lfeu;->a:Lfey;

    sget-object v1, Lmfj;->b:Lmfj;

    invoke-virtual {v0, v1}, Lfey;->a(Lmfj;)Ljava/util/List;

    move-result-object v1

    sget-object v2, Lmfj;->a:Lmfj;

    invoke-virtual {v0, v2}, Lfey;->a(Lmfj;)Ljava/util/List;

    move-result-object v2

    sget-object v3, Lmfj;->b:Lmfj;

    invoke-virtual {v0, v3}, Lfey;->b(Lmfj;)Lnre;

    move-result-object v3

    sget-object v4, Lmfj;->a:Lmfj;

    invoke-virtual {v0, v4}, Lfey;->b(Lmfj;)Lnre;

    move-result-object v0

    new-instance v4, Lfez;

    invoke-direct {v4, v1, v2, v3, v0}, Lfez;-><init>(Ljava/util/List;Ljava/util/List;Lnre;Lnre;)V

    iput-object v4, p0, Lfel;->g:Lfez;
    ...
    invoke-direct {p0, v0}, Lfel;->a(Landroid/preference/PreferenceGroup;)V
    ...
    invoke-virtual {p0}, Lfel;->getView()Landroid/view/View;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0}, Ldyi;->a()Ldvx;
    ...
    iput-object p1, p0, Lfel;->h:Lljf;

    invoke-interface {v0}, Ldvx;->a()Lfew;

    move-result-object p1

    invoke-interface {p1}, Lfew;->a()Lfeu;

    move-result-object p1

    iput-object p1, p0, Lfel;->a:Lfeu;

    iget-object p1, p0, Lfel;->a:Lfeu;

    invoke-virtual {p0}, Lfel;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-virtual {p1, v0}, Lfeu;->a(Landroid/content/Context;)V

    iget-object p1, p0, Lfel;->a:Lfeu;

    invoke-virtual {p1}, Lfeu;->a()Ljava/util/List;

    move-result-object p1

    invoke-virtual {p0}, Lfel;->getArguments()Landroid/os/Bundle;
    ...
    iput-object v1, p0, Lfel;->e:Ljava/lang/String;

    :cond_0
    const/high16 v1, 0x7f090000

    invoke-virtual {p0, v1}, Lfel;->addPreferencesFromResource(I)V

    const-string v1, "prefscreen_top"

    invoke-virtual {p0, v1}, Lfel;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v2

    check-cast v2, Landroid/preference/PreferenceScreen;

    iget-object v3, p0, Lfel;->a:Lfeu;

    iget-object v3, v3, Lfeu;->e:Ljava/util/Set;
    ...
    invoke-virtual {p0, v8}, Lfel;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    :cond_2
    invoke-virtual {v4}, Lity;->d()Ljava/util/List;
    ...
    :cond_3
    iget-object v2, p0, Lfel;->a:Lfeu;

    iget-object v2, v2, Lfeu;->h:Ljava/util/List;
    ...
    iget-object v4, p0, Lfel;->h:Lljf;

    invoke-virtual {v4, v3}, Lljf;->a(Llrr;)Llrr;
    ...
    iput-object v2, p0, Lfel;->b:Lcom/google/android/apps/camera/legacy/app/settings/ManagedSwitchPreference;

    iget-object v2, p0, Lfel;->b:Lcom/google/android/apps/camera/legacy/app/settings/ManagedSwitchPreference;

    new-instance v3, Lfem;

    invoke-direct {v3, p0}, Lfem;-><init>(Lfel;)V
    ...
    iget-object v3, v3, Lfeu;->c:Lcge;

    invoke-virtual {v3, v2}, Lcge;->a(Landroid/preference/PreferenceScreen;)V
    ...
    invoke-direct {p0, v2}, Lfel;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v4}, Lfel;->getString(I)Ljava/lang/String;

    move-result-object v4

    new-instance v5, Lfen;

    invoke-direct {v5, p0, v3}, Lfen;-><init>(Lfel;Landroid/content/Intent;)V
    ...
    invoke-direct {v3, p0}, Lfeo;-><init>(Lfel;)V
    ...
    iput-object p1, p0, Lfel;->f:Lcom/google/android/apps/camera/legacy/app/settings/ManagedSwitchPreference;
    ...
    iput-object p1, p0, Lfel;->d:[Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lfeu;->b()Lnza;

    move-result-object p1

    invoke-interface {p1}, Lnza;->m()Ljava/util/Set;
    ...
    invoke-interface {p1, v1}, Lnza;->c(Ljava/lang/Object;)Ljava/util/Collection;
    ...
    sget-object v4, Lfel;->c:Ljava/lang/String;
    ...
    invoke-static {v4, v3}, Lpjn;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p1, p1, Lfeu;->f:Lfro;

    invoke-virtual {p0}, Lfel;->getPreferenceScreen()Landroid/preference/PreferenceScreen;

    move-result-object v0

    invoke-static {p1, v0}, Lcom/google/android/apps/camera/legacy/app/settings/CameraSettingsActivity;->a(Lfro;Landroid/preference/Preference;)V
...
.method public final onResume()V
    ...
    iget-object v2, p0, Lfel;->g:Lfez;

    iget-object v2, v2, Lfez;->a:Ljava/util/List;
    ...
    invoke-direct {p0, v1, v2}, Lfel;->a(Landroid/preference/PreferenceGroup;Landroid/preference/Preference;)Z
    ...
    iget-object v2, v2, Lfez;->b:Ljava/util/List;
    ...
    invoke-direct {p0, v1}, Lfel;->b(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2}, Lfel;->b(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lfel;->b()Z

    move-result v0

    if-nez v0, :cond_2

    invoke-virtual {p0}, Lfel;->a()V
...
.method public final onSharedPreferenceChanged(Landroid/content/SharedPreferences;Ljava/lang/String;)V
    ...
    const-string v0, "pref_aux3rdcamera_key"
