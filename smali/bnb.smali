...
.method private final a(Llof;)Lose;
    ...
    invoke-interface/range {p1 .. p1}, Llof;->e()Lnre;
    ...
    iget-object v11, v0, Lbmv;->k:Lnre;

    move-object v4, v13

    invoke-direct/range {v4 .. v11}, Lbty;-><init>(Lbuf;Lbum;Landroid/view/Surface;Landroid/view/Surface;Lbua;Lbuv;Lnre;)V
    ...
    iget-object v8, v0, Lbmv;->g:Lnre;

    iget-object v9, v0, Lbmv;->e:Ljava/util/concurrent/Executor;

    iget-object v10, v0, Lbmv;->f:Ljen;

    new-instance v12, Lkdb;

    invoke-direct {v12}, Lkdb;-><init>()V
    ...
    invoke-direct/range {v4 .. v19}, Lboy;-><init>(Lbte;Lbtf;Lbuf;Lnre;Ljava/util/concurrent/Executor;Ljen;Llof;Lkdb;Lbty;Lbuu;Lbum;Lbwb;Lbvx;Lbxd;Lbtg;)V
    ...
    invoke-static {v3}, Lner;->b(I)Ljava/lang/String;
...
.method public final bridge synthetic a(Ljava/lang/Object;Ljava/lang/Object;)Lose;
    ...
    invoke-direct {p0, p2}, Lbnb;->a(Llof;)Lose;
