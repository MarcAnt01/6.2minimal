...
.method private final a(Lmis;Lmjb;)Lose;
    .locals 20
    ...
    invoke-interface/range {p2 .. p2}, Lmjb;->f()J

    move-result-wide v2

    sget-object v4, Landroid/hardware/camera2/TotalCaptureResult;->SENSOR_TIMESTAMP:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {v0, v4}, Lmis;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface/range {p2 .. p2}, Lmjb;->e()Ljava/util/List;
    ...
    invoke-virtual {v8, v5}, Lcom/google/android/libraries/camera/exif/ExifInterface;->d(I)Llus;
    ...
    invoke-virtual {v8, v5, v7}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Llus;

    move-result-object v5

    invoke-virtual {v8, v5}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Llus;)Llus;
    ...
    iget-object v5, v5, Lbyf;->d:Ljen;

    invoke-interface {v5, v2, v3}, Ljen;->a(J)Ljava/lang/String;

    move-result-object v5

    iget-object v7, v1, Lbyk;->d:Lbyf;

    iget-object v7, v7, Lbyf;->d:Ljen;

    sget-object v9, Lmjg;->c:Lmjg;

    invoke-interface {v7, v5, v9}, Ljen;->a(Ljava/lang/String;Lmjg;)Ljava/io/File;
    ...
    iget-object v4, v4, Lbyf;->e:Ljdb;

    invoke-static {v8}, Lnre;->b(Ljava/lang/Object;)Lnre;

    move-result-object v7

    invoke-interface {v4, v9, v5, v7}, Ljdb;->a(Ljava/io/File;Ljava/io/InputStream;Lnre;)J

    invoke-static {v8}, Llul;->a(Lcom/google/android/libraries/camera/exif/ExifInterface;)Llul;

    move-result-object v4

    invoke-static {v4}, Llul;->a(Llul;)Llrp;

    move-result-object v4

    new-instance v12, Llrt;

    invoke-direct {v12, v0, v6}, Llrt;-><init>(II)V

    sget-object v0, Lnqh;->a:Lnqh;

    iget-object v5, v1, Lbyk;->d:Lbyf;

    iget-object v5, v5, Lbyf;->g:Lnre;
    ...
    invoke-interface {v0}, Lfra;->e()Lnre;
    ...
    invoke-direct/range {v7 .. v19}, Lbxv;-><init>(Lluj;Ljava/io/File;Lnre;Lmjg;Llrt;ZFIJJ)V
...
.method public final bridge synthetic a(Ljava/lang/Object;Ljava/lang/Object;)Lose;
    ...
    invoke-direct {p0, p1, p2}, Lbyk;->a(Lmis;Lmjb;)Lose;
