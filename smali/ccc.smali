...
# direct methods
.method constructor <init>(Landroid/content/ContentProvider;Landroid/content/Context;Ldak;Lcca;Ldbk;Landroid/content/UriMatcher;Llsl;)V
    .locals 1
    ...
    iput-object p3, p0, Lccc;->c:Ldak;

    iput-object p4, p0, Lccc;->g:Lcca;

    iput-object p5, p0, Lccc;->h:Ldbk;

    iput-object p6, p0, Lccc;->b:Landroid/content/UriMatcher;

    iput-object p7, p0, Lccc;->d:Llsl;
...
.method public final a(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    :try_start_0
    iget-object p2, p0, Lccc;->h:Ldbk;

    invoke-interface {p2, p1}, Ldbk;->a(Landroid/net/Uri;)Landroid/content/ContentProvider$PipeDataWriter;
    ...
    move-result-object p1
    :try_end_0
    .catch Ldbq; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p2}, Ldbq;->getMessage()Ljava/lang/String;
    ...
    invoke-static {v1, p2}, Lpjn;->c(Ljava/lang/String;Ljava/lang/String;)V
