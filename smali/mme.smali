...
.method private static a(Ljava/util/List;Lzt;)Ljava/util/List;
    ...
    invoke-direct {p1, v0, v3, v1}, Lmmg;-><init>([BII)V
    ...
    invoke-static {v1}, Lmme;->a(Lmmg;)Z
...
.method public static a(Lmmh;Z)Ljava/util/List;
    .locals 9
    ...
    :try_start_1
    invoke-interface {p0}, Lmmh;->close()V
    :try_end_1
    ...
    invoke-interface {p0, v6}, Lmmh;->b(I)V
    ...
    invoke-interface {p0, v6, v5}, Lmmh;->a(II)Lmmg;
    ...
    :cond_7
    :try_start_4
    invoke-interface {p0, v5}, Lmmh;->a(I)Lmmg;
...
.method public static a(Ljava/io/InputStream;)Lzt;
    ...
    invoke-direct {v0, p0}, Lmmf;-><init>(Ljava/io/InputStream;)V

    const/4 p0, 0x1

    invoke-static {v0, p0}, Lmme;->a(Lmmh;Z)Ljava/util/List;

    move-result-object p0

    invoke-static {p0}, Lmme;->a(Ljava/util/List;)Lzt;
...
.method public static a(Ljava/lang/String;)Lzt;
    ...
    :try_start_1
    invoke-static {v0}, Lmme;->a(Ljava/io/InputStream;)Lzt;
    ...
    :try_start_2
    invoke-static {v1, v0}, Lmme;->a(Ljava/lang/Throwable;Ljava/io/FileInputStream;)V
    :try_end_2
    ...
    :try_start_4
    invoke-static {p0, v0}, Lmme;->a(Ljava/lang/Throwable;Ljava/io/FileInputStream;)V
...
.method public static a(Ljava/util/List;Ljava/io/OutputStream;Lzt;)Z
    ...
    invoke-static {p0, p2}, Lmme;->a(Ljava/util/List;Lzt;)Ljava/util/List;
...
.method private static a(Lmmg;)Z
    .locals 3
