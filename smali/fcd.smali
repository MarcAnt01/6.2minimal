...
# instance fields
.field private final synthetic a:Lfcc;
...
.method protected final synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, v1, Lfcd;->a:Lfcc;

    iget-object v0, v0, Lfcc;->a:Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;
    ...
    invoke-static {v8, v9}, Lpjn;->b(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-static {v5, v3}, Lpjn;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v12, v0, Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;->k:Lisu;

    iget-object v13, v0, Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;->j:Lisc;

    move-object v4, v3

    move-object v5, v2

    invoke-direct/range {v4 .. v13}, Lcom/google/android/apps/refocus/processing/RenderingTask;-><init>(Landroid/net/Uri;Lcom/google/android/apps/refocus/processing/FocusSettings;Lcom/google/android/apps/refocus/image/RGBZ;Ljava/lang/String;Landroid/location/Location;Lcom/google/android/apps/refocus/processing/FaceDetector;Landroid/content/ContentResolver;Lisu;Lisc;)V

    iget-object v0, v0, Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;->m:Lifw;

    invoke-interface {v0, v3}, Lifw;->a(Lifu;)V
    ...
    iget-object v2, v0, Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;->q:Ljen;

    invoke-interface {v2, v7, v8}, Ljen;->a(J)Ljava/lang/String;

    move-result-object v2

    iget-object v5, v0, Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;->q:Ljen;

    sget-object v9, Lmjg;->c:Lmjg;

    invoke-interface {v5, v2, v9}, Ljen;->a(Ljava/lang/String;Lmjg;)Ljava/io/File;

    move-result-object v5

    iget-object v9, v0, Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;->r:Lpwk;
    ...
    iput-object v11, v9, Lfti;->a:Ljava/lang/String;

    invoke-virtual {v9, v7, v8}, Lfti;->a(J)Lfti;

    move-result-object v9

    invoke-virtual {v9}, Lfti;->a()Lfss;
    ...
    invoke-static {v11, v5}, Lpjn;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v9}, Lfss;->a()Landroid/content/ContentValues;
    ...
    invoke-static {v14}, Loag;->b(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v4, v4, Lmjg;->j:Ljava/lang/String;
    ...
    invoke-direct {v4, v0, v14, v2, v3}, Lfcf;-><init>(Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;Landroid/net/Uri;Loss;Lcom/google/android/apps/refocus/processing/RenderingTask;)V

    invoke-virtual {v3, v4}, Lcom/google/android/apps/refocus/processing/RenderingTask;->addFinishedCallback(Llra;)V

    iget-object v4, v0, Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;->m:Lifw;

    invoke-interface {v4, v3}, Lifw;->a(Lifu;)V
    ...
    invoke-direct {v4, v0}, Lfcb;-><init>(Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;)V

    invoke-virtual {v3, v4}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    :try_start_3
    invoke-virtual {v2}, Loqc;->get()Ljava/lang/Object;
...
.method protected final synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lfcd;->a:Lfcc;

    iget-object p1, p1, Lfcc;->a:Lcom/google/android/apps/camera/legacy/app/refocus/ViewerActivity;
