...
.method public constructor <init>(Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;)V
    ...
    iput-object p1, p0, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    iput-object v0, p0, Lcsl;->g:Lcsk;

    new-instance v0, Lcsn;

    invoke-direct {v0, p0}, Lcsn;-><init>(Lcsl;)V

    iput-object v0, p0, Lcsl;->h:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object v3, p0, Lcsl;->g:Lcsk;

    invoke-direct {v1, p1, v2, v3, v0}, Lcsg;-><init>(Landroid/content/Context;Landroid/os/Handler;Lcsk;Landroid/animation/TimeInterpolator;)V

    iput-object v1, p0, Lcsl;->d:Lcsg;
    ...
    iput-object p1, p0, Lcsl;->a:Landroid/animation/ValueAnimator;

    iget-object p1, p0, Lcsl;->a:Landroid/animation/ValueAnimator;

    iget-object v1, p0, Lcsl;->h:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    invoke-direct {v0, p0}, Lcso;-><init>(Lcsl;)V
...
.method private final b(F)V
    ...
    iget-object v0, p0, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    :cond_0
    iget-object v0, p0, Lcsl;->a:Landroid/animation/ValueAnimator;
    ...
    iget-object v3, p0, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
...
.method public final a(F)V
    ...
    invoke-virtual {p0, v0}, Lcsl;->a(Z)Z
    ...
    iget-object p1, p0, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    invoke-virtual {p1, v0}, Lcsl;->a(Z)Z
...
.method public final a(IIZ)V
    ...
    iput-boolean p3, p0, Lcsl;->e:Z

    iget-object p3, p0, Lcsl;->d:Lcsg;

    iget v0, v0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->l:I

    iget-object v1, p3, Lcsg;->d:Landroid/animation/ValueAnimator;
    ...
    iget-object p2, p3, Lcsg;->d:Landroid/animation/ValueAnimator;
    ...
    iget-object p1, p3, Lcsg;->b:Lcsk;

    invoke-interface {p1, v0}, Lcsk;->a(I)V

    iget-object p1, p3, Lcsg;->d:Landroid/animation/ValueAnimator;
...
.method public final a(Lbhu;)V
    ...
    invoke-direct {v2, v0}, Lcse;-><init>(Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;)V

    invoke-direct {v1, v2}, Lcuo;-><init>(Lbhv;)V
...
.method public final a(Lbhx;)Z
    ...
    iget-object v5, v4, Lcsv;->b:Landroid/view/View;
...
.method public final a(Z)Z
    ...
    :cond_1
    :goto_0
    iget-object p1, p0, Lcsl;->d:Lcsg;

    iget-object v0, p1, Lcsg;->c:Landroid/widget/Scroller;

    invoke-virtual {v0, v1}, Landroid/widget/Scroller;->forceFinished(Z)V

    iget-object p1, p1, Lcsg;->d:Landroid/animation/ValueAnimator;
...
.method final b(Z)F
    ...
    invoke-interface {v2}, Lbhx;->f()Llrt;
...
.method public final b()Z
    ...
    invoke-virtual {p0, v0}, Lcsl;->c(I)Z
...
.method public final b(I)Z
    ...
    iget-object v6, p0, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    invoke-interface {v6}, Lbhx;->h()Lfuw;

    move-result-object v6

    invoke-virtual {v6}, Lfuw;->g()Llrt;
    ...
    iget-object v7, p0, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    iget-object v1, p0, Lcsl;->f:Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;
    ...
    invoke-virtual {p0, p1}, Lcsl;->a(Z)Z

    const/16 v0, 0x320

    invoke-virtual {p0, v4, v0, v3}, Lcsl;->a(IIZ)V
...
.method final c(I)Z
    ...
    invoke-virtual {p0, v1}, Lcsl;->a(Z)Z

    invoke-virtual {p1}, Lcsv;->c()I

    move-result p1

    const/16 v2, 0x320

    invoke-virtual {p0, p1, v2, v0}, Lcsl;->a(IIZ)V
...
.method public final d()V
    ...
    iget-object v4, v0, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->m:[Lcsv;

    invoke-virtual {v0, v2}, Lcom/google/android/apps/camera/filmstrip/local/widget/FilmstripView;->a(Lbhz;)Lcsv;
...
.method public final e()V
    ...
    invoke-direct {p0, v0}, Lcsl;->b(F)V
...
.method public final f()Z
    ...
    iget-object v0, p0, Lcsl;->d:Lcsg;

    iget-object v1, v0, Lcsg;->c:Landroid/widget/Scroller;
    ...
    iget-object v0, v0, Lcsg;->d:Landroid/animation/ValueAnimator;
...
.method public final g()V
    ...
    invoke-direct {p0, v1}, Lcsl;->b(F)V
...
.method public final h()Z
    ...
    iget-object v0, p0, Lcsl;->c:Landroid/animation/AnimatorSet;
...
.method public final i()Z
    ...
    iget-object v0, p0, Lcsl;->b:Landroid/animation/ValueAnimator;
