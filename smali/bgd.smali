...
.method public constructor <init>(Lnir;Lbgk;Lbgm;Lner;Landroid/content/res/Resources;Lllr;Lfro;Lcvm;Lmhg;Lmfc;BB)V
    .locals 0
    ...
    iput-object p11, p0, Lbgd;->q:Lncl;
    ...
    iput-object p6, p0, Lbgd;->e:Lllr;

    iput-object p7, p0, Lbgd;->h:Lfro;

    iput-object p8, p0, Lbgd;->i:Lcvm;

    iput-object p9, p0, Lbgd;->j:Lmhg;
    ...
    iget-object p1, p2, Lbgk;->a:Lllr;

    iput-object p1, p0, Lbgd;->l:Lllr;

    const/4 p1, 0x0

    iput p1, p0, Lbgd;->m:I

    invoke-interface {p9}, Lmhg;->c()Llii;

    move-result-object p1

    iget-object p4, p0, Lbgd;->e:Lllr;

    new-instance p6, Lbgh;

    invoke-direct {p6, p10, p2, p3}, Lbgh;-><init>(Lmfc;Lbgk;Lbgm;)V

    sget-object p2, Lorj;->a:Lorj;

    invoke-interface {p4, p6, p2}, Lllr;->a(Llry;Ljava/util/concurrent/Executor;)Llrr;
    ...
    iget-object p2, p0, Lbgd;->q:Lncl;

    iput-object p2, p1, Lbel;->f:Lncl;
...
.method public final a(Lmff;)V
    ...
    invoke-virtual {v1, p1}, Lbgk;->a(Lmff;)Lbgj;
    ...
    iget-object p1, v0, Lbgm;->b:Lcvm;

    invoke-interface {p1}, Lcvm;->c()Z
...
.method public final a(Liha;)Z
    ...
    invoke-static {v0, v6, v7}, Lner;->a(III)Z
    ...
    invoke-static {v10, v11, v7}, Lner;->a(III)Z
    ...
    invoke-interface {v8}, Lmjc;->getPixelStride()I

    move-result v14

    invoke-interface {v8}, Lmjc;->getRowStride()I
    ...
    invoke-interface {v12}, Lmjc;->getPixelStride()I
    ...
    iget-object v5, v5, Lbgm;->b:Lcvm;

    invoke-interface {v5}, Lcvm;->c()Z
    ...
    iget-object v0, v1, Lbgd;->h:Lfro;

    invoke-interface {v0}, Lfro;->k()V

    iget-object v0, v1, Lbgd;->j:Lmhg;

    invoke-interface {v0}, Lmhg;->a()Llii;
    ...
    invoke-static {v3, v2}, Lota;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method final c()V
    ...
    iget-object v2, v1, Lbgk;->b:Lllr;

    invoke-static {v0}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v3

    invoke-interface {v2, v3}, Lllr;->a(Ljava/lang/Object;)V

    iget-object v1, v1, Lbgk;->a:Lllr;
