...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfqr;->i:Landroid/net/Uri;

    return-void
.end method

.method constructor <init>(Landroid/content/Context;Lfqy;)V
    .locals 3
    ...
    iput-boolean v0, p0, Lfqr;->f:Z

    iput-object p2, p0, Lfqr;->g:Lfqy;
    ...
    invoke-static {p0, v1}, Lktd;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v2, v0, Lkqk;->b:Ljava/util/ArrayList;

    invoke-virtual {v2, p0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-static {p0, v1}, Lktd;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v1, v0, Lkqk;->c:Ljava/util/ArrayList;
    ...
    invoke-direct {p2, v0}, Lkbq;-><init>(Lkqj;)V

    iput-object p2, p0, Lfqr;->b:Lkbq;

    iput-object p1, p0, Lfqr;->d:Landroid/content/Context;
...
.method static a(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lfqr;->b(Landroid/content/Context;)I
...
.method private static b(Landroid/content/Context;)I
    ...
    :try_start_0
    sget-object v1, Lfqr;->i:Landroid/net/Uri;
...
.method private static b(Landroid/location/Location;)Z
    ...
    sget-object p0, Lfqr;->a:Ljava/lang/String;
    ...
    :cond_3
    :goto_0
    sget-object v1, Lfqr;->a:Ljava/lang/String;
    ...
    invoke-static {v1, p0}, Lpjn;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final a()Landroid/location/Location;
    ...
    :cond_1
    iget-object v0, p0, Lfqr;->j:Landroid/location/Location;
    ...
    iput-object v1, p0, Lfqr;->j:Landroid/location/Location;
    ...
    invoke-virtual {v0}, Lkbs;->a()Landroid/location/Location;

    move-result-object v0

    invoke-static {v0}, Lfqr;->b(Landroid/location/Location;)Z

    move-result v2

    if-eqz v2, :cond_3

    iput-object v0, p0, Lfqr;->j:Landroid/location/Location;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v1

    iput-wide v1, p0, Lfqr;->k:J
...
.method public final a(Z)Lose;
    ...
    iput-boolean p1, p0, Lfqr;->e:Z

    invoke-virtual {p0}, Lfqr;->c()V
    ...
    invoke-direct {v1, p0, v0, p1}, Lfqs;-><init>(Lfqr;Loss;Z)V

    const/4 p1, 0x0

    new-array p1, p1, [Ljava/lang/Void;

    invoke-virtual {v1, p1}, Lfqs;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public final a(Landroid/location/Location;)V
    ...
    invoke-static {p1}, Lfqr;->b(Landroid/location/Location;)Z
    ...
    :goto_2
    sget-object v3, Lfqr;->a:Ljava/lang/String;
    ...
    invoke-static {v3, p1}, Lpjn;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final a(Lcom/google/android/gms/common/ConnectionResult;)V
    ...
    iget-object p1, p0, Lfqr;->g:Lfqy;

    invoke-interface {p1}, Lfqy;->a()V
...
.method final b()V
    ...
    :try_start_0
    iget-object v1, p0, Lfqr;->c:Lkbs;

    sget-object v2, Llbe;->b:Llbc;

    iget-object v1, v1, Lkbs;->a:Lkbq;

    iget-object v1, v1, Lkbq;->a:Lkqj;

    invoke-interface {v2, v1, v0, p0}, Llbc;->a(Lkqj;Lcom/google/android/gms/location/LocationRequest;Llbd;)Lkqn;
...
.method final c()V
    ...
    sget-object v1, Llbe;->b:Llbc;

    iget-object v0, v0, Lkbs;->a:Lkbq;

    iget-object v0, v0, Lkbq;->a:Lkqj;

    invoke-interface {v1, v0, p0}, Llbc;->a(Lkqj;Llbd;)Lkqn;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final d()V
    ...
    iget-object v1, v0, Lkbq;->a:Lkqj;

    invoke-virtual {v1, v0}, Lkqj;->b(Lkql;)V

    iget-object v1, v0, Lkbq;->a:Lkqj;

    invoke-virtual {v1, v0}, Lkqj;->b(Lkqm;)V
