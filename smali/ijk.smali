...
.method private constructor <init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)V
    ...
    invoke-direct/range {v0 .. v12}, Lijk;-><init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;FFF)V
...
.method public constructor <init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;FFF)V
    ...
    iput-object p2, p0, Lijk;->a:Landroid/graphics/Rect;

    iput p3, p0, Lijk;->b:I

    iput-object p4, p0, Lijk;->c:Landroid/graphics/PointF;

    iput-object p5, p0, Lijk;->d:Landroid/graphics/PointF;

    iput-object p6, p0, Lijk;->e:Landroid/graphics/PointF;

    iput-object p7, p0, Lijk;->f:Landroid/graphics/PointF;

    iput-object p8, p0, Lijk;->g:Landroid/graphics/PointF;

    iput-object p9, p0, Lijk;->h:Landroid/graphics/PointF;

    iput p1, p0, Lijk;->i:I

    iput p10, p0, Lijk;->j:F

    iput p11, p0, Lijk;->k:F

    iput p12, p0, Lijk;->l:F
...
.method public constructor <init>(Landroid/graphics/Rect;I)V
    ...
    invoke-direct/range {v0 .. v6}, Lijk;-><init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)V

    return-void
.end method

.method public static a(Landroid/hardware/camera2/params/Face;)Lijk;
    .locals 8
