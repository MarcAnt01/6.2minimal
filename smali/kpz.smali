...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lkpz;->c:Z

    sput-boolean v0, Lkpz;->d:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lkpz;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lkpz;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lkpz;->a(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static c(Landroid/content/Context;)I
    ...
    :cond_1
    sget-object v2, Lkpz;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p0}, Lksz;->a(Landroid/content/Context;)I
    ...
    :goto_2
    invoke-static {p0}, Lktf;->a(Landroid/content/Context;)Z
    ...
    sget-object v2, Lktf;->a:Ljava/lang/Boolean;
    ...
    sput-object v2, Lktf;->a:Ljava/lang/Boolean;
    ...
    invoke-static {v9, v2}, Lkqa;->a(Landroid/content/pm/PackageInfo;[Lktj;)Lktj;
    ...
    invoke-static {v8, v2}, Lkqa;->a(Landroid/content/pm/PackageInfo;[Lktj;)Lktj;

    move-result-object v2

    if-eqz v2, :cond_d

    new-array v8, v5, [Lktj;

    aput-object v2, v8, v6

    invoke-static {v9, v8}, Lkqa;->a(Landroid/content/pm/PackageInfo;[Lktj;)Lktj;
...
.method public static d(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v3, v4}, Lkwn;->b(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    new-array p0, v2, [Lktj;

    sget-object v3, Lktm;->a:[Lktj;

    aget-object v3, v3, v2

    aput-object v3, p0, v1

    invoke-static {v0, p0}, Lkqa;->a(Landroid/content/pm/PackageInfo;[Lktj;)Lktj;

    move-result-object p0

    if-eqz p0, :cond_1

    sput-boolean v2, Lkpz;->c:Z

    goto :goto_1

    :goto_0
    sput-boolean v1, Lkpz;->c:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_1
    sput-boolean v2, Lkpz;->d:Z

    :goto_2
    sget-boolean p0, Lkpz;->c:Z
