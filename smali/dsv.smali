...
.method private constructor <init>(ILlrt;)V
    .locals 1
    ...
    iput-wide p1, p0, Ldsv;->b:J

    const/4 p1, 0x0

    iput-boolean p1, p0, Ldsv;->c:Z

    return-void
.end method

.method public constructor <init>(ILlrt;B)V
    .locals 0

    new-instance p3, Lepi;

    invoke-direct {p3}, Lepi;-><init>()V

    invoke-direct {p0, p1, p2}, Ldsv;-><init>(ILlrt;)V
...
.method public final declared-synchronized a(JFF)Z
    ...
    :try_start_0
    iget-boolean v0, p0, Ldsv;->c:Z

    if-nez v0, :cond_0

    iget-wide v1, p0, Ldsv;->b:J
...
.method public final declared-synchronized a(JJ)[F
    ...
    sget-object v0, Ldsv;->a:Ljava/lang/String;
    ...
    sget-object v11, Ldsv;->a:Ljava/lang/String;
    ...
    invoke-static {v11, v6}, Lpjn;->c(Ljava/lang/String;Ljava/lang/String;)V
