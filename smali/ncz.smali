...
.method public constructor <init>(Ljava/util/Locale;)V
    ...
    invoke-direct {v0, p1}, Lncy;-><init>(Ljava/util/Locale;)V
...
.method private final a(Lncq;)Ljava/util/List;
    ...
    iget-object v3, v0, Lncy;->b:Ljava/util/regex/Pattern;
    ...
    invoke-static {v4}, Lnmf;->a(Ljava/lang/String;)Lnmf;

    move-result-object v6

    iget-object v7, v0, Lncy;->c:Ljava/util/Locale;

    invoke-virtual {v4, v7}, Ljava/lang/String;->toLowerCase(Ljava/util/Locale;)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v6, v4}, Lnmf;->c(Ljava/lang/String;)Lnmf;

    move-result-object v4

    invoke-interface {v5, v4}, Lndq;->a(Lnmf;)Lndq;
    ...
    invoke-virtual {p1, v5, v6}, Lncq;->a(II)Ljava/util/List;

    move-result-object v5

    invoke-interface {v4, v5}, Lndq;->a(Ljava/util/List;)Lndq;

    move-result-object v4

    invoke-interface {v4}, Lndq;->a()Lndp;
...
.method protected final synthetic a(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-direct {p0, p1}, Lncz;->a(Lncq;)Ljava/util/List;
...
.method public final h()V
    ...
    sget-object v1, Lncy;->a:Ljava/lang/String;

    invoke-static {v1}, Ljava/util/regex/Pattern;->compile(Ljava/lang/String;)Ljava/util/regex/Pattern;

    move-result-object v1

    iput-object v1, v0, Lncy;->b:Ljava/util/regex/Pattern;
