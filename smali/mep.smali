...
.field private final h:Lnxi;

.field private final i:Lmhy;
...
# direct methods
.method constructor <init>(Lmff;Lmfg;Ljava/util/Set;Lmhy;Llsl;Llsg;)V
    .locals 1
    ...
    iput-object v0, p0, Lmep;->l:Landroid/hardware/camera2/params/StreamConfigurationMap;

    iput-object p1, p0, Lmep;->g:Lmff;

    iput-object p2, p0, Lmep;->f:Lmfg;

    invoke-static {p3}, Lnxi;->a(Ljava/util/Collection;)Lnxi;

    move-result-object p1

    iput-object p1, p0, Lmep;->h:Lnxi;

    iput-object p4, p0, Lmep;->i:Lmhy;

    iput-object p5, p0, Lmep;->j:Llsl;
    ...
    iput-object p1, p0, Lmep;->k:Llsg;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lmep;->e:Ljava/lang/Object;
...
.method private final F()Landroid/hardware/camera2/params/StreamConfigurationMap;
    ...
    iget-object v0, p0, Lmep;->e:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lmep;->l:Landroid/hardware/camera2/params/StreamConfigurationMap;
    :try_end_0
    ...
    :try_start_1
    iget-object v1, p0, Lmep;->j:Llsl;

    iget-object v2, p0, Lmep;->g:Lmff;
    ...
    invoke-virtual {p0, v1}, Lmep;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroid/hardware/camera2/params/StreamConfigurationMap;

    iput-object v1, p0, Lmep;->l:Landroid/hardware/camera2/params/StreamConfigurationMap;
    :try_end_1
    ...
    :goto_0
    invoke-interface {v2, v3, v1}, Llsg;->b(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
...
.method public final C()Z
    ...
    invoke-virtual {p0}, Lmep;->f()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-virtual {p0}, Lmep;->b()Lmfj;
...
.method public final D()Ljava/util/List;
    ...
    invoke-interface {v0, v1}, Lmfg;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
...
.method public final E()I
    ...
    invoke-virtual {p0, v0}, Lmep;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
...
.method public final a(ILlrt;)J
    .locals 1

    invoke-direct {p0}, Lmep;->F()Landroid/hardware/camera2/params/StreamConfigurationMap;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-static {p2}, Llru;->b(Llrt;)Landroid/util/Size;
...
.method public final a(I)Ljava/util/List;
    ...
    invoke-static {p1}, Llru;->a([Landroid/util/Size;)Ljava/util/List;
...
.method public final a()Lmff;
    ...
    iget-object v0, p0, Lmep;->g:Lmff;

    return-object v0
.end method

.method public final a_(Llrt;)Ljava/util/List;
    .locals 1
    ...
    :cond_0
    invoke-static {p1}, Llru;->b(Llrt;)Landroid/util/Size;
...
.method public final c()Ljava/util/List;
    ...
    invoke-static {v0}, Llru;->a([Landroid/util/Size;)Ljava/util/List;
...
.method public final f()Z
    ...
    invoke-virtual {p0, v0, v1}, Lmep;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final h()Lmfi;
    ...
    invoke-static {v4}, Lmfi;->a(I)Lmfi;
...
.method public final i()Ljava/util/List;
    ...
    invoke-static {v0}, Lopy;->c([F)Ljava/util/List;
...
.method public final j()Z
    ...
    invoke-virtual {p0, v0}, Lmep;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
...
.method public final t()Ljava/util/List;
    ...
    sget-object v1, Lmep;->c:[Landroid/util/Size;
...
.method public final w()[B
    ...
    sget-object v0, Lmep;->d:[B

    sget-object v1, Lkoq;->a:Landroid/hardware/camera2/CameraCharacteristics$Key;

    if-eqz v1, :cond_0

    sget-object v0, Lkoq;->a:Landroid/hardware/camera2/CameraCharacteristics$Key;

    sget-object v1, Lmep;->d:[B
...
.method public final x()Z
    ...
    iget-object v0, p0, Lmep;->i:Lmhy;

    iget-boolean v0, v0, Lmhy;->d:Z
    ...
    :try_start_0
    invoke-virtual {p0}, Lmep;->z()Ljava/util/Set;
