...
.method public constructor <init>(Ljava/io/File;)V
    ...
    iput-object p1, p0, Lkkg;->b:Ljava/io/File;
...
# virtual methods
.method public final a(Ljava/lang/String;)Lkkj;
    .locals 14
    ...
    iget-object v3, p0, Lkkg;->b:Ljava/io/File;
    ...
    invoke-static {v3, p1}, Lkkg;->a(Landroid/media/MediaExtractor;Ljava/lang/String;)Landroid/media/MediaFormat;

    move-result-object v4

    if-nez v4, :cond_1

    sget-object v2, Lkkg;->a:Lkla;
    ...
    :goto_0
    invoke-static {v2, p1}, Lkkz;->b(Lkla;Ljava/lang/String;)V
    ...
    invoke-direct {p1, v2, v5}, Lklr;-><init>(Ljava/lang/String;I)V

    invoke-virtual {p1, v4}, Lklr;->a(Landroid/media/MediaFormat;)I
    ...
    invoke-static {v1}, Lklg;->a(Ljava/io/File;)[B
    ...
    invoke-direct {v0, v1, p1}, Lkkj;-><init>(Ljava/lang/String;[B)V
    ...
    :cond_4
    sget-object v5, Lkkg;->a:Lkla;

    const-string v6, "Chunk size is the maximum size, we probably clamped the sample"

    invoke-static {v5, v6}, Lkkz;->b(Lkla;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v2, v13, v11}, Lklr;->a(ILjava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
