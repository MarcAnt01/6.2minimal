...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lima;->b:Ljava/util/NavigableMap;
...
.method private final declared-synchronized a(J)Ljava/util/Map$Entry;
    ...
    :try_start_0
    iget-object v0, p0, Lima;->b:Ljava/util/NavigableMap;
    ...
    invoke-static {v0, p1, p2}, Lima;->a(Ljava/util/Map$Entry;J)Ljava/util/Map$Entry;
...
.method private final declared-synchronized a(JLjava/util/Map$Entry;Ljava/util/Map$Entry;[F)V
    ...
    invoke-direct {p0, p1, p5}, Lima;->a(I[F)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized a(JFFF)V
    ...
    iget-object p3, p0, Lima;->b:Ljava/util/NavigableMap;
    ...
    :goto_0
    iget-object p1, p0, Lima;->b:Ljava/util/NavigableMap;
...
.method public final declared-synchronized a(J[F)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Lima;->a(J)Ljava/util/Map$Entry;

    move-result-object v3

    invoke-direct {p0, p1, p2}, Lima;->b(J)Ljava/util/Map$Entry;
    ...
    invoke-direct/range {v0 .. v5}, Lima;->a(JLjava/util/Map$Entry;Ljava/util/Map$Entry;[F)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {p0, p1, p3}, Lima;->a(I[F)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
