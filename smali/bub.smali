...
.method public constructor <init>(Lbts;Lljx;Llry;Llry;)V
    .locals 0
    ...
    iput-object p2, p0, Lbub;->b:Lljx;

    iput-object p3, p0, Lbub;->c:Llry;

    iput-object p4, p0, Lbub;->d:Llry;
...
.method public final a(Lbuf;Lbum;Lllr;Lawy;Ljava/util/List;Lose;Ljava/lang/Runnable;)Lazp;
    ...
    invoke-interface/range {v7 .. v13}, Lbts;->a(Lbuf;Lbum;Lllr;Landroid/graphics/PointF;Ljava/util/List;Lose;)Lose;
    ...
    invoke-direct {v0, p0, v3, v4}, Lbuc;-><init>(Lbub;Loss;Ljava/lang/Runnable;)V
    ...
    invoke-direct/range {v0 .. v5}, Lbue;-><init>(Lbub;Lose;Loss;Ljava/lang/Runnable;Lawy;)V
