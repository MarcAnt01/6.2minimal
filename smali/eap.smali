...
.method static constructor <clinit>()V
    ...
    sput-object v0, Leap;->n:Ljava/lang/String;
...
.method public constructor <init>(Leay;)V
    ...
    iput-object v0, p0, Leap;->b:Ljava/util/List;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Leap;->k:Ljava/util/Map;

    iput-object p1, p0, Leap;->a:Leay;
...
.method private static a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    :cond_2
    :goto_0
    sget-object p1, Leap;->n:Ljava/lang/String;
...
# virtual methods
.method final a(Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;Lpvh;)Lebb;
    .locals 11

    invoke-static {p1}, Leap;->c(Landroid/view/View;)Landroid/graphics/Rect;

    move-result-object v0

    invoke-static {p2}, Leap;->c(Landroid/view/View;)Landroid/graphics/Rect;

    move-result-object p2

    iget-object v1, p0, Leap;->b:Ljava/util/List;

    iget-object v2, p0, Leap;->l:Landroid/support/v4/view/ViewPager;
    ...
    invoke-static {v0, v2}, Leap;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Rect;

    move-result-object v1

    invoke-static {v1, p2}, Leap;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-direct/range {v4 .. v10}, Lebb;-><init>(Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;FFFLandroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Leap;->g:Lebb;

    if-eqz v0, :cond_3

    iget-object v0, p0, Leap;->d:Landroid/animation/Animator;
    ...
    :cond_0
    iget-object v0, p0, Leap;->f:Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-virtual {p0, v0}, Leap;->a(Landroid/net/Uri;)V

    iput-boolean v1, p0, Leap;->c:Z
    ...
    iget-object v1, p0, Leap;->f:Landroid/support/v7/widget/RecyclerView;

    invoke-virtual {v1, v3}, Landroid/support/v7/widget/RecyclerView;->setAlpha(F)V

    const/4 v1, 0x4

    invoke-virtual {p0, v1}, Leap;->a(I)V

    iget-object v1, p0, Leap;->a:Leay;

    invoke-interface {v1}, Leay;->b()V

    iput-object v0, p0, Leap;->g:Lebb;

    return-void

    :cond_1
    iget-object v2, p0, Leap;->a:Leay;

    iget-object v4, p0, Leap;->b:Ljava/util/List;

    iget-object v5, p0, Leap;->l:Landroid/support/v4/view/ViewPager;
    ...
    invoke-interface {v2, v4, v5}, Leay;->a(Lccj;I)Lebg;
    ...
    iget-object v5, p0, Leap;->k:Ljava/util/Map;
    ...
    iget-object v2, p0, Leap;->g:Lebb;

    goto :goto_0

    :cond_2
    iget-object v2, v2, Lebg;->r:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;

    invoke-virtual {p0, v2, v4}, Leap;->a(Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;Lpvh;)Lebb;

    move-result-object v2

    :goto_0
    iget-object v5, v2, Lebb;->a:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;

    const/4 v6, 0x0

    invoke-virtual {v5, v6}, Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;->setAlpha(F)V

    invoke-virtual {v4}, Lpvh;->a()V

    invoke-static {v4}, Leap;->b(Landroid/view/View;)V
    ...
    invoke-direct {v10, v4, v2}, Lean;-><init>(Lpvh;Lebb;)V
    ...
    iget-object v2, p0, Leap;->f:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v2, p0, Leap;->i:Landroid/view/View;
    ...
    invoke-direct {v1, p0, v5, v4}, Leau;-><init>(Leap;Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;Lpvh;)V
    ...
    iput-object v7, p0, Leap;->d:Landroid/animation/Animator;
...
.method public final a(I)V
    ...
    iget-object v0, p0, Leap;->l:Landroid/support/v4/view/ViewPager;
    ...
    iget-object v0, p0, Leap;->i:Landroid/view/View;
...
.method public final a(Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Leap;->e:Landroid/view/ViewGroup;
    ...
    iget-object v1, p0, Leap;->e:Landroid/view/ViewGroup;
    ...
    iget-object v2, p0, Leap;->e:Landroid/view/ViewGroup;
    ...
    invoke-direct {v5, p0, p1}, Leav;-><init>(Leap;Landroid/net/Uri;)V

    invoke-virtual {v0, v5}, Landroid/widget/ImageButton;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    :goto_0
    iget-boolean v0, p0, Leap;->j:Z
    ...
    invoke-direct {v0, p0, p1}, Leaw;-><init>(Leap;Landroid/net/Uri;)V
    ...
    invoke-direct {v0, p0, p1}, Leax;-><init>(Leap;Landroid/net/Uri;)V
