...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lkoq;->C:Z

    const/4 v1, 0x3

    invoke-static {v1}, Lkoo;->a(I)Z

    move-result v1

    sput-boolean v1, Lkoq;->D:Z
    ...
    :goto_0
    sput-object v4, Lkoq;->a:Landroid/hardware/camera2/CameraCharacteristics$Key;

    sget-boolean v4, Lkoq;->C:Z

    if-eqz v4, :cond_1

    invoke-static {}, Lkoq;->e()Z
    ...
    :goto_1
    sput-object v4, Lkoq;->b:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_2
    sput-object v4, Lkoq;->c:Landroid/hardware/camera2/CaptureRequest$Key;

    sput-object v1, Lkoq;->d:Ljava/lang/Byte;

    sput-object v3, Lkoq;->e:Ljava/lang/Byte;

    invoke-static {v0}, Ljava/lang/Byte;->valueOf(B)Ljava/lang/Byte;

    move-result-object v0

    sput-object v0, Lkoq;->f:Ljava/lang/Byte;

    sget-boolean v0, Lkoq;->C:Z
    ...
    :goto_3
    sput-object v0, Lkoq;->g:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_4
    sput-object v0, Lkoq;->h:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_5
    sput-object v0, Lkoq;->i:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_6
    sput-object v0, Lkoq;->j:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_7
    sput-object v0, Lkoq;->k:Landroid/hardware/camera2/CaptureResult$Key;

    sget-boolean v0, Lkoq;->C:Z

    if-eqz v0, :cond_b

    invoke-static {}, Lkoq;->c()Z
    ...
    :goto_8
    sput-object v0, Lkoq;->l:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_9
    sput-object v0, Lkoq;->m:Landroid/hardware/camera2/CaptureResult$Key;

    sget-boolean v0, Lkoq;->C:Z

    if-eqz v0, :cond_f

    invoke-static {}, Lkoq;->d()Z
    ...
    :goto_a
    sput-object v0, Lkoq;->n:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-static {}, Lkoq;->f()Z
    ...
    :goto_b
    sput-object v0, Lkoq;->o:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_c
    sput-object v0, Lkoq;->p:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-static {v2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    sput-object v0, Lkoq;->q:Ljava/lang/Integer;
    ...
    :goto_d
    sput-object v1, Lkoq;->r:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_e
    sput-object v1, Lkoq;->s:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_f
    sput-object v1, Lkoq;->t:Landroid/hardware/camera2/CaptureRequest$Key;

    sget-boolean v1, Lkoq;->C:Z

    if-eqz v1, :cond_15

    invoke-static {}, Lkoq;->g()Z
    ...
    :goto_10
    sput-object v1, Lkoq;->u:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-static {}, Lkoq;->h()Z

    sget-boolean v1, Lkoq;->C:Z

    if-eqz v1, :cond_18

    invoke-static {}, Lkoq;->a()Z
    ...
    :goto_11
    sput-object v1, Lkoq;->v:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_12
    sput-object v1, Lkoq;->w:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_13
    sput-object v1, Lkoq;->x:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_14
    sput-object v1, Lkoq;->y:Landroid/hardware/camera2/CameraCharacteristics$Key;

    sget-boolean v1, Lkoq;->C:Z

    if-eqz v1, :cond_27

    invoke-static {}, Lkoq;->i()Z
    ...
    :goto_15
    sput-object v1, Lkoq;->z:Landroid/hardware/camera2/CaptureRequest$Key;

    sput-object v0, Lkoq;->A:Ljava/lang/Integer;
    ...
    :goto_16
    sput-object v5, Lkoq;->B:Landroid/hardware/camera2/CaptureResult$Key;
