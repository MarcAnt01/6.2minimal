...
# instance fields
.field public final characteristics:Lmer;

.field public final deviceProperties:Lmhz;
...
.method public constructor <init>(Lmer;)V
    ...
    iput-object p1, p0, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->characteristics:Lmer;

    sget-object v0, Landroid/hardware/camera2/CameraCharacteristics;->SENSOR_INFO_SENSITIVITY_RANGE:Landroid/hardware/camera2/CameraCharacteristics$Key;

    invoke-interface {p1, v0}, Lmer;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->deviceProperties:Lmhz;

    iget-object v0, p0, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->deviceProperties:Lmhz;
...
.method public static convertToColorSpaceTransform([F)Landroid/hardware/camera2/params/ColorSpaceTransform;
    ...
    invoke-static {v0, v3, v2}, Loag;->a(ZLjava/lang/String;I)V
...
.method public static convertToGcamStaticMetadata(Lmer;)Lcom/google/googlex/gcam/StaticMetadata;
    .locals 10

    invoke-static {p0}, Lcom/FixBSG;->getInputModel(Lmer;)V

    new-instance v0, Lcom/google/googlex/gcam/StaticMetadata;

    invoke-direct {v0}, Lcom/google/googlex/gcam/StaticMetadata;-><init>()V

    sget-object v1, Lcom/FixBSG;->sGetMake:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/google/googlex/gcam/StaticMetadata;->setMake(Ljava/lang/String;)V

    sget-object v1, Lcom/FixBSG;->sGetDevice:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/google/googlex/gcam/StaticMetadata;->setDevice(Ljava/lang/String;)V

    sget-object v1, Lcom/FixBSG;->sGetModel:Ljava/lang/String;
    ...
    invoke-interface {p0}, Lmer;->C()Z

    move-result v1

    invoke-virtual {v0, v1}, Lcom/google/googlex/gcam/StaticMetadata;->setHas_flash(Z)V

    invoke-interface {p0}, Lmer;->b()Lmfj;

    move-result-object v1

    invoke-static {v1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->convertToLensFacing(Lmfj;)I
    ...
    invoke-interface {p0, v1}, Lmer;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p0, v2}, Lmer;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p0, v2}, Lmer;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p0, v3}, Lmer;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p0, v4}, Lmer;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getQcColorCalibration(Lmer;)Lcom/google/googlex/gcam/QcColorCalibration;
    ...
    invoke-static {p0}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getGcamRawFormat(Lmer;)Lmfx;

    move-result-object v1

    iget-object v2, v1, Lmfx;->b:Llrt;

    iget v3, v2, Llrt;->a:I

    invoke-virtual {v0, v3}, Lcom/google/googlex/gcam/StaticMetadata;->setPixel_array_width(I)V

    iget-object v2, v1, Lmfx;->b:Llrt;

    iget v4, v2, Llrt;->b:I

    invoke-virtual {v0, v4}, Lcom/google/googlex/gcam/StaticMetadata;->setPixel_array_height(I)V
    ...
    invoke-static {p0}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getReadoutTimeNs(Lmer;)J
...
.method private static convertToLensFacing(Lmfj;)I
    .locals 1

    invoke-virtual {p0}, Lmfj;->ordinal()I
...
.method private getAnalogAndDigitalGain(Lmip;)[F
    .locals 3
...
.method private static getAwbGains(Lmip;[I)[F
    .locals 4
    ...
    invoke-interface {p0, v2}, Lmip;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
...
.method private static getAwbRgb2Rgb(Lmip;)[F
    .locals 1

    sget-object v0, Landroid/hardware/camera2/CaptureResult;->COLOR_CORRECTION_TRANSFORM:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {p0, v0}, Lmip;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
...
.method private static getExposureTimeMs(Lmip;)F
    .locals 2
...
.method public static getGcamRawFormat(Lmer;)Lmfx;
    .locals 6

    const/16 v0, 0x25

    invoke-interface {p0, v0}, Lmer;->a(I)Ljava/util/List;

    move-result-object v1

    const/16 v2, 0x20

    invoke-interface {p0, v2}, Lmer;->a(I)Ljava/util/List;

    move-result-object v3

    const/16 v4, 0x23

    invoke-interface {p0, v4}, Lmer;->a(I)Ljava/util/List;
    ...
    invoke-static {v1}, Llru;->a(Ljava/util/List;)Llrt;

    move-result-object v1

    invoke-direct {p0, v0, v1}, Lmfx;-><init>(ILlrt;)V
    ...
    invoke-direct {p0, v2, v0}, Lmfx;-><init>(ILlrt;)V
    ...
    invoke-direct {v0, v4, p0}, Lmfx;-><init>(ILlrt;)V
...
.method public static getGcamSensorId(Lmer;)I
    .locals 8
    ...
    invoke-interface {p0}, Lmer;->D()Ljava/util/List;

    move-result-object v1

    invoke-interface {p0}, Lmer;->y()Z
...
.method private static getOisMetadata(Lmip;)Ljava/util/Optional;
    .locals 0

    invoke-static {p0}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->oisMetadataFromCamera2(Lmip;)Ljava/util/Optional;
...
.method private static getQcColorCalibration(Lmer;)Lcom/google/googlex/gcam/QcColorCalibration;
    .locals 8
...
.method public static getReadoutTimeNs(Lmer;)J
    .locals 2
    ...
    iget-object v0, v0, Lmfx;->b:Llrt;

    invoke-interface {p0, v1, v0}, Lmer;->a(ILlrt;)J
...
.method private static oisMetadataFromCamera2(Lmip;)Ljava/util/Optional;
    .locals 8
...
.method private static oisMetadataFromExperimental(Lmip;)Ljava/util/Optional;
    .locals 5

    sget-object v0, Lkoq;->h:Landroid/hardware/camera2/CaptureResult$Key;

    if-eqz v0, :cond_5

    sget-object v0, Lkoq;->i:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v1, Lkoq;->i:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v2, Lkoq;->l:Landroid/hardware/camera2/CaptureResult$Key;

    if-eqz v2, :cond_2

    sget-object v2, Lkoq;->m:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v3, Lkoq;->m:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {p0, v3}, Lmip;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    :cond_2
    sget-object v2, Lkoq;->j:Landroid/hardware/camera2/CaptureResult$Key;

    if-eqz v2, :cond_3

    sget-object v2, Lkoq;->k:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v3, Lkoq;->k:Landroid/hardware/camera2/CaptureResult$Key;
...
.method public static updateFaceInfo(Lmer;Lcom/google/googlex/gcam/hdrplus/MetadataConverter$ExtendedFaces;Lcom/google/googlex/gcam/FaceInfoVector;)V
    .locals 18
    ...
    invoke-interface {v1, v0}, Lmer;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
...
.method public convertToGcamFrameMetadata(Lmip;)Lcom/google/googlex/gcam/FrameMetadata;
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0, v0}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->convertToGcamFrameMetadata(Lmip;[Landroid/hardware/camera2/params/Face;Lcom/google/googlex/gcam/GyroSampleVector;)Lcom/google/googlex/gcam/FrameMetadata;
...
.method public convertToGcamFrameMetadata(Lmip;[Landroid/hardware/camera2/params/Face;Lcom/google/googlex/gcam/GyroSampleVector;)Lcom/google/googlex/gcam/FrameMetadata;
    .locals 9
    ...
    iget-object v1, p0, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->characteristics:Lmer;

    invoke-static {v1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getGcamSensorId(Lmer;)I

    move-result v1

    invoke-virtual {v0, v1}, Lcom/google/googlex/gcam/FrameMetadata;->setSensor_id(I)V

    invoke-static {p1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getExposureTimeMs(Lmip;)F

    move-result v1

    invoke-virtual {v0, v1}, Lcom/google/googlex/gcam/FrameMetadata;->setActual_exposure_time_ms(F)V

    invoke-direct {p0, p1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getAnalogAndDigitalGain(Lmip;)[F
    ...
    invoke-virtual {v0, v3}, Lcom/google/googlex/gcam/FrameMetadata;->setActual_analog_gain(F)V

    const/4 v3, 0x1

    aget v1, v1, v3

    invoke-virtual {v0, v1}, Lcom/google/googlex/gcam/FrameMetadata;->setApplied_digital_gain(F)V
    ...
    invoke-virtual {v0, v1}, Lcom/google/googlex/gcam/FrameMetadata;->setPost_raw_digital_gain(F)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getAwbInfoCaptured(Lmip;)Lcom/google/googlex/gcam/AwbInfo;
    ...
    invoke-direct {v1, p1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter$ExtendedFaces;-><init>(Lmip;)V
    ...
    :goto_3
    iget-object p2, p0, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->characteristics:Lmer;

    invoke-virtual {v0}, Lcom/google/googlex/gcam/FrameMetadata;->getFaces()Lcom/google/googlex/gcam/FaceInfoVector;

    move-result-object v6

    invoke-static {p2, v1, v6}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->updateFaceInfo(Lmer;Lcom/google/googlex/gcam/hdrplus/MetadataConverter$ExtendedFaces;Lcom/google/googlex/gcam/FaceInfoVector;)V
    ...
    iget-object p2, p0, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->deviceProperties:Lmhz;

    invoke-virtual {p2}, Lmhz;->d()Z
    ...
    invoke-interface {p1, p2}, Lmip;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p2, v5}, Lmer;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    :cond_f
    invoke-static {v5}, LZephrTech/DynUtil;->getPseudoBL([F)[F
    ...
    invoke-interface {v1, v2}, Lmer;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    :cond_17
    invoke-static {p1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getOisMetadata(Lmip;)Ljava/util/Optional;
    ...
    sget-object p2, Lkoq;->n:Landroid/hardware/camera2/CaptureResult$Key;
...
.method public convertToSpatialGainMap(Lmip;)Lcom/google/googlex/gcam/SpatialGainMap;
    .locals 10
    ...
    iget-object v4, p0, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->characteristics:Lmer;
    ...
    invoke-interface {v4, v5}, Lmer;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-static {}, Lcom/device;->isOnePlus5()Z
...
.method public getAwbInfoCaptured(Lmip;)Lcom/google/googlex/gcam/AwbInfo;
    .locals 2
    ...
    invoke-static {p1, v1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getAwbGains(Lmip;[I)[F

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/google/googlex/gcam/AwbInfo;->setGains([F)V

    invoke-static {p1}, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->getAwbRgb2Rgb(Lmip;)[F
...
.method public getExposureCompensationStops(I)F
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/googlex/gcam/hdrplus/MetadataConverter;->characteristics:Lmer;

    sget-object v1, Landroid/hardware/camera2/CameraCharacteristics;->CONTROL_AE_COMPENSATION_STEP:Landroid/hardware/camera2/CameraCharacteristics$Key;

    invoke-interface {v0, v1}, Lmer;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-static {v3, v6}, Lpjn;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public getTotalExposureTime(Lmip;)F
    .locals 2
...
.method public updateAeShotParams(Lcom/google/googlex/gcam/AeShotParams;Landroid/graphics/Rect;[Landroid/hardware/camera2/params/MeteringRectangle;Llrt;)V
    .locals 0

    invoke-static {p4}, Llqy;->a(Llrt;)Llqy;

    move-result-object p4

    invoke-virtual {p4, p2}, Llqy;->a(Landroid/graphics/Rect;)Landroid/graphics/Rect;
...
.method public updateFromFrameRequest(Lcom/google/googlex/gcam/FrameRequest;Llvm;)V
    .locals 10
    ...
    invoke-interface {p2, v3, v5}, Llvm;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Llvm;
    ...
    invoke-interface {p2, v3, v7}, Llvm;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Llvm;
    ...
    invoke-interface {p2, v0, v3}, Llvm;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Llvm;
    ...
    invoke-interface {p2, v3, v0}, Llvm;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Llvm;
    ...
    invoke-interface {p2, v1, v0}, Llvm;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Llvm;

    sget-object v0, Landroid/hardware/camera2/CaptureRequest;->CONTROL_AWB_MODE:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-interface {p2, v0, v7}, Llvm;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Llvm;
    ...
    invoke-interface {p2, v0, v1}, Llvm;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Llvm;
    ...
    invoke-interface {p2, v0, p1}, Llvm;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Llvm;
    ...
    invoke-interface {p2, p1, v5}, Llvm;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Llvm;
    ...
    invoke-interface {p2, p1, v0}, Llvm;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Llvm;

    sget-object p1, Landroid/hardware/camera2/CaptureRequest;->EDGE_MODE:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-interface {p2, p1, v7}, Llvm;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Llvm;
